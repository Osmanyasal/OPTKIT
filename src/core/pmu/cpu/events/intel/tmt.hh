...
namespace optkit::intel::tmt{
	enum tmt : uint64_t {
		...
		MEM_LOAD_UOPS_RETIRED__MASK__INTEL_TMT_MEM_LOAD_UOPS_RETIRED__L1_MISS = 0x800ull, // Counts the number of load uops retired that miss in the level 1 data cache
		MEM_LOAD_UOPS_RETIRED__MASK__INTEL_TMT_MEM_LOAD_UOPS_RETIRED__L3_HIT = 0x400ull, // Counts the number of load uops retired that miss in the level 3 cache
		MEM_LOAD_UOPS_RETIRED__MASK__INTEL_TMT_MEM_LOAD_UOPS_RETIRED__L2_HIT = 0x200ull, // Counts the number of load uops retired that hit in the level 2 cache
		MEM_LOAD_UOPS_RETIRED__MASK__INTEL_TMT_MEM_LOAD_UOPS_RETIRED__L1_HIT = 0x100ull, // Counts the number of load uops retired that hit the level 1 data cache
		...
		CYCLES_DIV_BUSY__MASK__INTEL_TMT_CYCLES_DIV_BUSY__ANY = 0x0ull, // Counts cycles the floating point divider or integer divider or both are busy.  Does not imply a stall waiting for either divider.
		BR_MISP_RETIRED = 0x00c5, // Counts the number of mispredicted branch instructions retired.
		BR_MISP_RETIRED__MASK__INTEL_TMT_BR_MISP_RETIRED__ALL_BRANCHES = 0x0ull, // Counts the number of mispredicted branch instructions retired.
		BR_INST_RETIRED = 0x00c4, // Counts the number of branch instructions retired for all branch types.
		BR_INST_RETIRED__MASK__INTEL_TMT_BR_INST_RETIRED__ALL_BRANCHES = 0x0ull, // Counts the number of branch instructions retired for all branch types.
		MACHINE_CLEARS = 0x00c3, // Counts all machine clears due to
		MACHINE_CLEARS__MASK__INTEL_TMT_MACHINE_CLEARS__ANY = 0x0ull, // Counts all machine clears due to
		ITLB_MISSES = 0x0085, // Page walk completed due to an instruction fetch in a 4K page.
		ITLB_MISSES__MASK__INTEL_TMT_ITLB_MISSES__WALK_COMPLETED_2M_4M = 0x400ull, // Page walk completed due to an instruction fetch in a 2M or 4M page.
		ITLB_MISSES__MASK__INTEL_TMT_ITLB_MISSES__WALK_COMPLETED_4K = 0x200ull, // Page walk completed due to an instruction fetch in a 4K page.
		ITLB = 0x0081, // Counts the number of times there was an ITLB miss and a new translation was filled into the ITLB.
		ITLB__MASK__INTEL_TMT_ITLB__FILLS = 0x400ull, // Counts the number of times there was an ITLB miss and a new translation was filled into the ITLB.
		...
		ICACHE__MASK__INTEL_TMT_ICACHE__ACCESSES = 0x300ull, // Counts requests to the Instruction Cache (ICache) for one or more bytes cache Line.
		ICACHE__MASK__INTEL_TMT_ICACHE__MISSES = 0x200ull, // Counts requests to the Instruction Cache (ICache) for one or more bytes in a cache line and they do not hit in the ICache (miss).
		DTLB_STORE_MISSES = 0x0049, // Page walk completed due to a demand data store to a 4K page.
		DTLB_STORE_MISSES__MASK__INTEL_TMT_DTLB_STORE_MISSES__WALK_COMPLETED_2M_4M = 0x400ull, // Page walk completed due to a demand data store to a 2M or 4M page.
		DTLB_STORE_MISSES__MASK__INTEL_TMT_DTLB_STORE_MISSES__WALK_COMPLETED_4K = 0x200ull, // Page walk completed due to a demand data store to a 4K page.
		...
		DTLB_LOAD_MISSES__MASK__INTEL_TMT_DTLB_LOAD_MISSES__WALK_COMPLETED_2M_4M = 0x400ull, // Page walk completed due to a demand load to a 2M or 4M page.
		DTLB_LOAD_MISSES__MASK__INTEL_TMT_DTLB_LOAD_MISSES__WALK_COMPLETED_4K = 0x200ull, // Page walk completed due to a demand load to a 4K page.
		CPU_CLK_UNHALTED = 0x003c, // Counts the number of unhalted core clock cycles. (Fixed event)
		CPU_CLK_UNHALTED__MASK__INTEL_TMT_CPU_CLK_UNHALTED__REF = 0x100ull, // Counts the number of unhalted reference clock cycles at TSC frequency.
		CPU_CLK_UNHALTED__MASK__INTEL_TMT_CPU_CLK_UNHALTED__CORE_P = 0x0ull, // Counts the number of unhalted core clock cycles.
		CPU_CLK_UNHALTED__MASK__INTEL_TMT_CPU_CLK_UNHALTED__CORE = 0x0ull, // Counts the number of unhalted core clock cycles.
		CPU_CLK_UNHALTED__MASK__INTEL_TMT_CPU_CLK_UNHALTED__REF_TSC = 0x300ull, // Counts the number of unhalted reference clock cycles at TSC frequency. (Fixed event)
