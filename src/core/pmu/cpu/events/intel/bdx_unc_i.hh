...
namespace optkit::intel::bdx_unc_i{
	enum bdx_unc_i : uint64_t {
		...
		UNC_I_CACHE_TOTAL_OCCUPANCY__MASK__BDX_UNC_I_CACHE_TOTAL_OCCUPANCY__ANY = 0x100ull, // Total Write Cache Occupancy -- Any Source
		UNC_I_CACHE_TOTAL_OCCUPANCY__MASK__BDX_UNC_I_CACHE_TOTAL_OCCUPANCY__SOURCE = 0x200ull, // Total Write Cache Occupancy -- Select Source
		...
		UNC_I_COHERENT_OPS__MASK__BDX_UNC_I_COHERENT_OPS__CLFLUSH = 0x8000ull, // Coherent Ops -- CLFlush
		UNC_I_COHERENT_OPS__MASK__BDX_UNC_I_COHERENT_OPS__CRD = 0x200ull, // Coherent Ops -- CRd
		UNC_I_COHERENT_OPS__MASK__BDX_UNC_I_COHERENT_OPS__DRD = 0x400ull, // Coherent Ops -- DRd
		UNC_I_COHERENT_OPS__MASK__BDX_UNC_I_COHERENT_OPS__PCIDCAHINT = 0x2000ull, // Coherent Ops -- PCIDCAHin5t
		UNC_I_COHERENT_OPS__MASK__BDX_UNC_I_COHERENT_OPS__PCIRDCUR = 0x100ull, // Coherent Ops -- PCIRdCur
		UNC_I_COHERENT_OPS__MASK__BDX_UNC_I_COHERENT_OPS__PCITOM = 0x1000ull, // Coherent Ops -- PCIItoM
		UNC_I_COHERENT_OPS__MASK__BDX_UNC_I_COHERENT_OPS__RFO = 0x800ull, // Coherent Ops -- RFO
		UNC_I_COHERENT_OPS__MASK__BDX_UNC_I_COHERENT_OPS__WBMTOI = 0x4000ull, // Coherent Ops -- WbMtoI
		UNC_I_MISC0 = 0x14, // TBD
		UNC_I_MISC0__MASK__BDX_UNC_I_MISC0__2ND_ATOMIC_INSERT = 0x1000ull, // Misc Events - Set 0 -- Cache Inserts of Atomic Transactions as Secondary
		UNC_I_MISC0__MASK__BDX_UNC_I_MISC0__2ND_RD_INSERT = 0x400ull, // Misc Events - Set 0 -- Cache Inserts of Read Transactions as Secondary
		UNC_I_MISC0__MASK__BDX_UNC_I_MISC0__2ND_WR_INSERT = 0x800ull, // Misc Events - Set 0 -- Cache Inserts of Write Transactions as Secondary
		UNC_I_MISC0__MASK__BDX_UNC_I_MISC0__FAST_REJ = 0x200ull, // Misc Events - Set 0 -- Fastpath Rejects
		UNC_I_MISC0__MASK__BDX_UNC_I_MISC0__FAST_REQ = 0x100ull, // Misc Events - Set 0 -- Fastpath Requests
		UNC_I_MISC0__MASK__BDX_UNC_I_MISC0__FAST_XFER = 0x2000ull, // Misc Events - Set 0 -- Fastpath Transfers From Primary to Secondary
		UNC_I_MISC0__MASK__BDX_UNC_I_MISC0__PF_ACK_HINT = 0x4000ull, // Misc Events - Set 0 -- Prefetch Ack Hints From Primary to Secondary
		UNC_I_MISC0__MASK__BDX_UNC_I_MISC0__PF_TIMEOUT = 0x8000ull, // Misc Events - Set 0 -- Prefetch TimeOut
		UNC_I_MISC1 = 0x15, // TBD
		UNC_I_MISC1__MASK__BDX_UNC_I_MISC1__DATA_THROTTLE = 0x8000ull, // Misc Events - Set 1 -- Data Throttled
		UNC_I_MISC1__MASK__BDX_UNC_I_MISC1__LOST_FWD = 0x1000ull, // Misc Events - Set 1 --
		UNC_I_MISC1__MASK__BDX_UNC_I_MISC1__SEC_RCVD_INVLD = 0x2000ull, // Misc Events - Set 1 -- Received Invalid
		UNC_I_MISC1__MASK__BDX_UNC_I_MISC1__SEC_RCVD_VLD = 0x4000ull, // Misc Events - Set 1 -- Received Valid
		UNC_I_MISC1__MASK__BDX_UNC_I_MISC1__SLOW_I = 0x100ull, // Misc Events - Set 1 -- Slow Transfer of I Line
		UNC_I_MISC1__MASK__BDX_UNC_I_MISC1__SLOW_S = 0x200ull, // Misc Events - Set 1 -- Slow Transfer of S Line
		UNC_I_MISC1__MASK__BDX_UNC_I_MISC1__SLOW_E = 0x400ull, // Misc Events - Set 1 -- Slow Transfer of E Line
		UNC_I_MISC1__MASK__BDX_UNC_I_MISC1__SLOW_M = 0x800ull, // Misc Events - Set 1 -- Slow Transfer of M Line
		...
		UNC_I_SNOOP_RESP__MASK__BDX_UNC_I_SNOOP_RESP__HIT_ES = 0x400ull, // Snoop Responses -- Hit E or S
		UNC_I_SNOOP_RESP__MASK__BDX_UNC_I_SNOOP_RESP__HIT_I = 0x200ull, // Snoop Responses -- Hit I
		UNC_I_SNOOP_RESP__MASK__BDX_UNC_I_SNOOP_RESP__HIT_M = 0x800ull, // Snoop Responses -- Hit M
		UNC_I_SNOOP_RESP__MASK__BDX_UNC_I_SNOOP_RESP__MISS = 0x100ull, // Snoop Responses -- Miss
		UNC_I_SNOOP_RESP__MASK__BDX_UNC_I_SNOOP_RESP__SNPCODE = 0x1000ull, // Snoop Responses -- SnpCode
		UNC_I_SNOOP_RESP__MASK__BDX_UNC_I_SNOOP_RESP__SNPDATA = 0x2000ull, // Snoop Responses -- SnpData
		UNC_I_SNOOP_RESP__MASK__BDX_UNC_I_SNOOP_RESP__SNPINV = 0x4000ull, // Snoop Responses -- SnpInv
		...
		UNC_I_TRANSACTIONS__MASK__BDX_UNC_I_TRANSACTIONS__ATOMIC = 0x1000ull, // Inbound Transaction Count -- Atomic
		UNC_I_TRANSACTIONS__MASK__BDX_UNC_I_TRANSACTIONS__ORDERINGQ = 0x4000ull, // Inbound Transaction Count -- Select Source via IRP orderingQ register
		UNC_I_TRANSACTIONS__MASK__BDX_UNC_I_TRANSACTIONS__OTHER = 0x2000ull, // Inbound Transaction Count -- Other
		UNC_I_TRANSACTIONS__MASK__BDX_UNC_I_TRANSACTIONS__RD_PREF = 0x400ull, // Inbound Transaction Count -- Read Prefetches
		UNC_I_TRANSACTIONS__MASK__BDX_UNC_I_TRANSACTIONS__READS = 0x100ull, // Inbound Transaction Count -- Reads
		UNC_I_TRANSACTIONS__MASK__BDX_UNC_I_TRANSACTIONS__WRITES = 0x200ull, // Inbound Transaction Count -- Writes
		UNC_I_TRANSACTIONS__MASK__BDX_UNC_I_TRANSACTIONS__WR_PREF = 0x800ull, // Inbound Transaction Count -- Write Prefetches
