...
namespace optkit::intel::bdx_unc_p{
	enum bdx_unc_p : uint64_t {
		...
		UNC_P_POWER_STATE_OCCUPANCY__MASK__BDX_UNC_P_POWER_STATE_OCCUPANCY__CORES_C0 = 0x4000ull, // Number of cores in C-State -- C0 and C1
		UNC_P_POWER_STATE_OCCUPANCY__MASK__BDX_UNC_P_POWER_STATE_OCCUPANCY__CORES_C3 = 0x8000ull, // Number of cores in C-State -- C3
		UNC_P_POWER_STATE_OCCUPANCY__MASK__BDX_UNC_P_POWER_STATE_OCCUPANCY__CORES_C6 = 0xc000ull, // Number of cores in C-State -- C6 and C7
