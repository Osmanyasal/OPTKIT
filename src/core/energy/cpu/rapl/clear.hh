...
#undef OPTKIT_CPU_ENERGY_SAMPLING
#undef OPTKIT_CPU_ENERGY_REPEAT_SAMPLING
#undef OPTKIT_CPU_ENERGY_REPEAT_READ_AND_STORE_SAMPLING
#undef OPTKIT_CPU_ENERGY_WITH_METRICS_SAMPLING
#undef OPTKIT_CPU_ENERGY_REPEAT_WITH_METRICS_SAMPLING
#undef OPTKIT_CPU_ENERGY_REPEAT_READ_AND_STORE_WITH_METRICS_SAMPLING
