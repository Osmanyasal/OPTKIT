...
namespace optkit::intel::icl{
	enum icl : uint64_t {
		...
		SQ_MISC__MASK__INTEL_ICL_SQ_MISC__SQ_FULL = 0x400ull, // Cycles the thread is active and superQ cannot take any more entries.
		SQ_MISC__MASK__INTEL_ICL_SQ_MISC__BUS_LOCK = 0x1000ull, // Counts bus locks
		L2_LINES_OUT = 0x00f2, // L2 lines evicted.
		L2_LINES_OUT__MASK__INTEL_ICL_L2_LINES_OUT__USELESS_HWPF = 0x400ull, // Cache lines that have been L2 hardware prefetched but not used by demand accesses
		L2_LINES_OUT__MASK__INTEL_ICL_L2_LINES_OUT__NON_SILENT = 0x200ull, // Modified cache lines that are evicted by L2 cache when triggered by an L2 cache fill.
		L2_LINES_OUT__MASK__INTEL_ICL_L2_LINES_OUT__SILENT = 0x100ull, // Non-modified cache lines that are silently dropped by L2 cache when triggered by an L2 cache fill.
		...
		BACLEARS__MASK__INTEL_ICL_BACLEARS__ANY = 0x100ull, // Counts the total number when the front end is resteered
		MEM_LOAD_L3_HIT_RETIRED = 0x00d2, // L3 hit load uops retired.
		MEM_LOAD_L3_HIT_RETIRED__MASK__INTEL_ICL_MEM_LOAD_L3_HIT_RETIRED__XSNP_NONE = 0x800ull, // Retired load instructions whose data sources were hits in L3 without snoops required
		MEM_LOAD_L3_HIT_RETIRED__MASK__INTEL_ICL_MEM_LOAD_L3_HIT_RETIRED__XSNP_HITM = 0x400ull, // Retired load instructions whose data sources were HitM responses from shared L3
		MEM_LOAD_L3_HIT_RETIRED__MASK__INTEL_ICL_MEM_LOAD_L3_HIT_RETIRED__XSNP_HIT = 0x200ull, // Retired load instructions whose data sources were L3 and cross-core snoop hits in on-pkg core cache
		MEM_LOAD_L3_HIT_RETIRED__MASK__INTEL_ICL_MEM_LOAD_L3_HIT_RETIRED__XSNP_MISS = 0x100ull, // Retired load instructions whose data sources were L3 hit and cross-core snoop missed in on-pkg core cache.
		...
		MEM_LOAD_RETIRED__MASK__INTEL_ICL_MEM_LOAD_RETIRED__L1_MISS = 0x800ull, // Retired load instructions missed L1 cache as data sources
		MEM_LOAD_RETIRED__MASK__INTEL_ICL_MEM_LOAD_RETIRED__L3_HIT = 0x400ull, // Retired load instructions with L3 cache hits as data sources
		MEM_LOAD_RETIRED__MASK__INTEL_ICL_MEM_LOAD_RETIRED__L2_HIT = 0x200ull, // Retired load instructions with L2 cache hits as data sources
		MEM_LOAD_RETIRED__MASK__INTEL_ICL_MEM_LOAD_RETIRED__L1_HIT = 0x100ull, // Retired load instructions with L1 cache hits as data sources
		...
		MEM_LOAD_L3_MISS_RETIRED__MASK__INTEL_ICL_MEM_LOAD_L3_MISS_RETIRED__REMOTE_FWD = 0x800ull, // Retired load instructions whose data sources was forwarded from a remote cache
		MEM_LOAD_L3_MISS_RETIRED__MASK__INTEL_ICL_MEM_LOAD_L3_MISS_RETIRED__REMOTE_HITM = 0x400ull, // Retired load instructions whose data sources was remote HITM
		MEM_LOAD_L3_MISS_RETIRED__MASK__INTEL_ICL_MEM_LOAD_L3_MISS_RETIRED__REMOTE_DRAM = 0x200ull, // Retired load instructions which data sources missed L3 but serviced from remote dram
		MEM_LOAD_L3_MISS_RETIRED__MASK__INTEL_ICL_MEM_LOAD_L3_MISS_RETIRED__LOCAL_DRAM = 0x100ull, // Retired load instructions which data sources missed L3 but serviced from local dram
		MEM_TRANS_RETIRED = 0x00cd, // Memory transactions retired
		MEM_TRANS_RETIRED__MASK__INTEL_ICL_MEM_TRANS_RETIRED__LOAD_LATENCY = 0x100ull, // Memory load instructions retired above programmed clocks
		...
		RTM_RETIRED__MASK__INTEL_ICL_RTM_RETIRED__ABORTED_MEM = 0x800ull, // Number of times an RTM execution aborted due to various memory events (e.g. read/write capacity and conflicts)
		RTM_RETIRED__MASK__INTEL_ICL_RTM_RETIRED__ABORTED = 0x400ull, // Number of times an RTM execution aborted.
		RTM_RETIRED__MASK__INTEL_ICL_RTM_RETIRED__COMMIT = 0x200ull, // Number of times an RTM execution successfully committed
		RTM_RETIRED__MASK__INTEL_ICL_RTM_RETIRED__START = 0x100ull, // Number of times an RTM execution started.
		...
		HLE_RETIRED__MASK__INTEL_ICL_HLE_RETIRED__ABORTED_MEM = 0x800ull, // Number of times an HLE execution aborted due to various memory events (e.g.
		HLE_RETIRED__MASK__INTEL_ICL_HLE_RETIRED__ABORTED = 0x400ull, // Number of times an HLE execution aborted due to any reasons (multiple categories may count as one).
		HLE_RETIRED__MASK__INTEL_ICL_HLE_RETIRED__COMMIT = 0x200ull, // Number of times an HLE execution successfully committed
		HLE_RETIRED__MASK__INTEL_ICL_HLE_RETIRED__START = 0x100ull, // Number of times an HLE execution started.
		...
		FP_ARITH_INST_RETIRED__MASK__INTEL_ICL_FP_ARITH_INST_RETIRED__128B_PACKED_SINGLE = 0x800ull, // Number of SSE/AVX computational 128-bit packed single precision floating-point instructions retired; some instructions will count twice as noted below.  Each count represents 4 computation operations
		FP_ARITH_INST_RETIRED__MASK__INTEL_ICL_FP_ARITH_INST_RETIRED__128B_PACKED_DOUBLE = 0x400ull, // Counts number of SSE/AVX computational 128-bit packed double precision floating-point instructions retired; some instructions will count twice as noted below.  Each count represents 2 computation operations
		...
		FP_ARITH_INST_RETIRED__MASK__INTEL_ICL_FP_ARITH_INST_RETIRED__SCALAR = 0x300ull, // Number of SSE/AVX computational scalar floating-point instructions retired; some instructions will count twice as noted below.  Applies to SSE* and AVX* scalar
		...
		FP_ARITH__MASK__INTEL_ICL_FP_ARITH_INST_RETIRED__128B_PACKED_SINGLE = 0x800ull, // Number of SSE/AVX computational 128-bit packed single precision floating-point instructions retired; some instructions will count twice as noted below.  Each count represents 4 computation operations
		FP_ARITH__MASK__INTEL_ICL_FP_ARITH_INST_RETIRED__128B_PACKED_DOUBLE = 0x400ull, // Counts number of SSE/AVX computational 128-bit packed double precision floating-point instructions retired; some instructions will count twice as noted below.  Each count represents 2 computation operations
		FP_ARITH__MASK__INTEL_ICL_FP_ARITH_INST_RETIRED__SCALAR_SINGLE = 0x200ull, // Counts number of SSE/AVX computational scalar single precision floating-point instructions retired; some instructions will count twice as noted below.  Each count represents 1 computational operation. Applies to SSE* and AVX* scalar single precision floating-point instructions: ADD SUB MUL DIV MIN MAX SQRT RSQRT RCP FM(N)ADD/SUB.  FM(N)ADD/SUB instructions count twice as they perform 2 calculations per element. The DAZ and FTZ flags in the MXCSR register need to be set when using this event.
		FP_ARITH__MASK__INTEL_ICL_FP_ARITH_INST_RETIRED__SCALAR_DOUBLE = 0x100ull, // Counts number of SSE/AVX computational scalar double precision floating-point instructions retired; some instructions will count twice as noted below.  Each count represents 1 computational operation. Applies to SSE* and AVX* scalar double precision floating-point instructions: ADD SUB MUL DIV MIN MAX SQRT FM(N)ADD/SUB.  FM(N)ADD/SUB instructions count twice as they perform 2 calculations per element. The DAZ and FTZ flags in the MXCSR register need to be set when using this event.
		FP_ARITH__MASK__INTEL_ICL_FP_ARITH_INST_RETIRED__SCALAR = 0x300ull, // Number of SSE/AVX computational scalar floating-point instructions retired; some instructions will count twice as noted below.  Applies to SSE* and AVX* scalar
		...
		FRONTEND_RETIRED__MASK__INTEL_ICL_FRONTEND_RETIRED__ANY_DSB_MISS = 0x100ull, // Retired Instructions experiencing a DSB miss.
		...
		BR_MISP_RETIRED__MASK__INTEL_ICL_BR_MISP_RETIRED__INDIRECT_CALL = 0x200ull, // Mispredicted indirect CALL instructions retired.
		BR_MISP_RETIRED__MASK__INTEL_ICL_BR_MISP_RETIRED__COND_TAKEN = 0x100ull, // number of branch instructions retired that were mispredicted and taken.
		BR_MISP_RETIRED__MASK__INTEL_ICL_BR_MISP_RETIRED__ALL_BRANCHES = 0x0ull, // All mispredicted branch instructions retired.
		...
		BR_INST_RETIRED__MASK__INTEL_ICL_BR_INST_RETIRED__NEAR_RETURN = 0x800ull, // Return instructions retired.
		BR_INST_RETIRED__MASK__INTEL_ICL_BR_INST_RETIRED__NEAR_CALL = 0x200ull, // Direct and indirect near call instructions retired.
		BR_INST_RETIRED__MASK__INTEL_ICL_BR_INST_RETIRED__COND_TAKEN = 0x100ull, // Taken conditional branch instructions retired.
		BR_INST_RETIRED__MASK__INTEL_ICL_BR_INST_RETIRED__ALL_BRANCHES = 0x0ull, // All branch instructions retired.
		MACHINE_CLEARS = 0x00c3, // Machine clear asserted.
		MACHINE_CLEARS__MASK__INTEL_ICL_MACHINE_CLEARS__SMC = 0x400ull, // Self-modifying code (SMC) detected.
		MACHINE_CLEARS__MASK__INTEL_ICL_MACHINE_CLEARS__MEMORY_ORDERING = 0x200ull, // Number of machine clears due to memory ordering conflicts.
		...
		UOPS_RETIRED__MASK__INTEL_ICL_UOPS_RETIRED__SLOTS = 0x200ull, // Retirement slots used.
		...
		ASSISTS__MASK__INTEL_ICL_ASSISTS__ANY = 0x700ull, // Number of occurrences where a microcode assist is invoked by hardware.
		ASSISTS__MASK__INTEL_ICL_ASSISTS__FP = 0x200ull, // Counts all microcode FP assists.
		TLB_FLUSH = 0x00bd, // Data TLB flushes.
		TLB_FLUSH__MASK__INTEL_ICL_TLB_FLUSH__STLB_ANY = 0x2000ull, // STLB flush attempts
		TLB_FLUSH__MASK__INTEL_ICL_TLB_FLUSH__DTLB_THREAD = 0x100ull, // DTLB flush attempts of the thread-specific entries
		...
		UOPS_EXECUTED__MASK__INTEL_ICL_UOPS_EXECUTED__CORE = 0x200ull, // Number of uops executed on the core.
		...
		UOPS_EXECUTED__MASK__INTEL_ICL_UOPS_EXECUTED__THREAD = 0x100ull, // Counts the number of uops to be executed per-thread each cycle.
		...
		OFFCORE_REQUESTS__MASK__INTEL_ICL_OFFCORE_REQUESTS__ALL_DATA_RD = 0x800ull, // Demand and prefetch data reads
		OFFCORE_REQUESTS__MASK__INTEL_ICL_OFFCORE_REQUESTS__DEMAND_RFO = 0x400ull, // Demand RFO requests including regular RFOs
		OFFCORE_REQUESTS__MASK__INTEL_ICL_OFFCORE_REQUESTS__DEMAND_DATA_RD = 0x100ull, // Demand Data Read requests sent to uncore
		OFFCORE_REQUESTS__MASK__INTEL_ICL_OFFCORE_REQUESTS__DEMAND_CODE_RD = 0x200ull, // Counts cacheable and non-cacheable code reads to the core.
		...
		DSB2MITE_SWITCHES__MASK__INTEL_ICL_DSB2MITE_SWITCHES__PENALTY_CYCLES = 0x200ull, // DSB-to-MITE switch true penalty cycles.
		...
		LSD__MASK__INTEL_ICL_LSD__UOPS = 0x100ull, // Number of Uops delivered by the LSD.
		...
		EXE_ACTIVITY__MASK__INTEL_ICL_EXE_ACTIVITY__3_PORTS_UTIL = 0x800ull, // Cycles total of 3 uops are executed on all ports and Reservation Station was not empty.
		EXE_ACTIVITY__MASK__INTEL_ICL_EXE_ACTIVITY__2_PORTS_UTIL = 0x400ull, // Cycles total of 2 uops are executed on all ports and Reservation Station was not empty.
		EXE_ACTIVITY__MASK__INTEL_ICL_EXE_ACTIVITY__1_PORTS_UTIL = 0x200ull, // Cycles total of 1 uop is executed on all ports and Reservation Station was not empty.
		...
		RESOURCE_STALLS__MASK__INTEL_ICL_RESOURCE_STALLS__SB = 0x800ull, // Cycles stalled due to no store buffers available. (not including draining form sync).
		RESOURCE_STALLS__MASK__INTEL_ICL_RESOURCE_STALLS__SCOREBOARD = 0x200ull, // Counts cycles where the pipeline is stalled due to serializing operations.
		...
		UOPS_DISPATCHED__MASK__INTEL_ICL_UOPS_DISPATCHED__PORT_2_3 = 0x400ull, // Number of uops executed on port 2 and 3
		UOPS_DISPATCHED__MASK__INTEL_ICL_UOPS_DISPATCHED__PORT_1 = 0x200ull, // Number of uops executed on port 1
		UOPS_DISPATCHED__MASK__INTEL_ICL_UOPS_DISPATCHED__PORT_0 = 0x100ull, // Number of uops executed on port 0
		...
		UOPS_DISPATCHED_PORT__MASK__INTEL_ICL_UOPS_DISPATCHED__PORT_2_3 = 0x400ull, // Number of uops executed on port 2 and 3
		UOPS_DISPATCHED_PORT__MASK__INTEL_ICL_UOPS_DISPATCHED__PORT_1 = 0x200ull, // Number of uops executed on port 1
		UOPS_DISPATCHED_PORT__MASK__INTEL_ICL_UOPS_DISPATCHED__PORT_0 = 0x100ull, // Number of uops executed on port 0
		...
		IDQ_UOPS_NOT_DELIVERED__MASK__INTEL_ICL_IDQ_UOPS_NOT_DELIVERED__CORE = 0x100ull, // Uops not delivered by IDQ when backend of the machine is not stalled
		ILD_STALL = 0x0087, // ILD (Instruction Length Decoder) stalls.
		ILD_STALL__MASK__INTEL_ICL_ILD_STALL__LCP = 0x100ull, // Stalls caused by changing prefix length of the instruction.
		...
		ITLB_MISSES__MASK__INTEL_ICL_ITLB_MISSES__WALK_COMPLETED = 0xe00ull, // Code miss in all TLB levels causes a page walk that completes. (All page sizes)
		ITLB_MISSES__MASK__INTEL_ICL_ITLB_MISSES__WALK_COMPLETED_2M_4M = 0x400ull, // Code miss in all TLB levels causes a page walk that completes. (2M/4M)
		ITLB_MISSES__MASK__INTEL_ICL_ITLB_MISSES__WALK_COMPLETED_4K = 0x200ull, // Code miss in all TLB levels causes a page walk that completes. (4K)
		ICACHE_64B = 0x0083, // Instruction Cache.
		ICACHE_64B__MASK__INTEL_ICL_ICACHE_64B__IFTAG_STALL = 0x400ull, // Cycles where a code fetch is stalled due to L1 instruction cache tag miss.
		ICACHE_64B__MASK__INTEL_ICL_ICACHE_64B__IFTAG_MISS = 0x200ull, // Instruction fetch tag lookups that miss in the instruction cache (L1I). Counts at 64-byte cache-line granularity.
		ICACHE_64B__MASK__INTEL_ICL_ICACHE_64B__IFTAG_HIT = 0x100ull, // Instruction fetch tag lookups that hit in the instruction cache (L1I). Counts at 64-byte cache-line granularity.
		ICACHE_16B = 0x0080, // Instruction Cache.
		ICACHE_16B__MASK__INTEL_ICL_ICACHE_16B__IFDATA_STALL = 0x400ull, // Cycles where a code fetch is stalled due to L1 instruction cache miss.
		...
		IDQ__MASK__INTEL_ICL_IDQ__DSB_UOPS = 0x800ull, // Uops delivered to Instruction Decode Queue (IDQ) from the Decode Stream Buffer (DSB) path
		...
		IDQ__MASK__INTEL_ICL_IDQ__MITE_UOPS = 0x400ull, // Uops delivered to Instruction Decode Queue (IDQ) from MITE path
		OFFCORE_REQUESTS_OUTSTANDING = 0x0060, // Outstanding offcore requests.
		OFFCORE_REQUESTS_OUTSTANDING__MASK__INTEL_ICL_OFFCORE_REQUESTS_OUTSTANDING__DEMAND_DATA_RD = 0x100ull, // For every cycle
		OFFCORE_REQUESTS_OUTSTANDING__MASK__INTEL_ICL_OFFCORE_REQUESTS_OUTSTANDING__DEMAND_CODE_RD = 0x200ull, // For every cycle
		...
		OFFCORE_REQUESTS_OUTSTANDING__MASK__INTEL_ICL_OFFCORE_REQUESTS_OUTSTANDING__ALL_DATA_RD = 0x800ull, // For every cycle
		...
		RS_EVENTS__MASK__INTEL_ICL_RS_EVENTS__EMPTY_CYCLES = 0x100ull, // Cycles when Reservation Station (RS) is empty for the thread
		TX_EXEC = 0x005d, // Transactional execution.
		TX_EXEC__MASK__INTEL_ICL_TX_EXEC__MISC3 = 0x400ull, // Number of times an instruction execution caused the transactional nest count supported to be exceeded
		TX_EXEC__MASK__INTEL_ICL_TX_EXEC__MISC2 = 0x200ull, // Counts the number of times a class of instructions that may cause a transactional abort was executed inside a transactional region
		...
		TX_MEM__MASK__INTEL_ICL_TX_MEM__ABORT_HLE_ELISION_BUFFER_NOT_EMPTY = 0x800ull, // Number of times an HLE transactional execution aborted due to NoAllocatedElisionBuffer being non-zero.
		TX_MEM__MASK__INTEL_ICL_TX_MEM__ABORT_HLE_STORE_TO_ELIDED_LOCK = 0x400ull, // Number of times a HLE transactional region aborted due to a non XRELEASE prefixed instruction writing to an elided lock in the elision buffer
		TX_MEM__MASK__INTEL_ICL_TX_MEM__ABORT_CAPACITY_WRITE = 0x200ull, // Speculatively counts the number of TSX aborts due to a data capacity limitation for transactional writes.
		TX_MEM__MASK__INTEL_ICL_TX_MEM__ABORT_CONFLICT = 0x100ull, // Number of times a transactional abort was signaled due to a data conflict on a transactionally accessed address
		L1D = 0x0051, // L1D cache.
		L1D__MASK__INTEL_ICL_L1D__REPLACEMENT = 0x100ull, // Counts the number of cache lines replaced in L1 data cache.
		LOAD_HIT_PREFETCH = 0x004c, // Load dispatches.
		LOAD_HIT_PREFETCH__MASK__INTEL_ICL_LOAD_HIT_PREFETCH__SWPF = 0x100ull, // Counts the number of demand load dispatches that hit L1D fill buffer (FB) allocated for software prefetch.
		LOAD_HIT_PRE = 0x004c, // Load dispatches.
		LOAD_HIT_PRE__MASK__INTEL_ICL_LOAD_HIT_PREFETCH__SWPF = 0x100ull, // Counts the number of demand load dispatches that hit L1D fill buffer (FB) allocated for software prefetch.
		...
		DTLB_STORE_MISSES__MASK__INTEL_ICL_DTLB_STORE_MISSES__WALK_COMPLETED = 0xe00ull, // Store misses in all TLB levels causes a page walk that completes. (All page sizes)
		DTLB_STORE_MISSES__MASK__INTEL_ICL_DTLB_STORE_MISSES__WALK_COMPLETED_2M_4M = 0x400ull, // Page walks completed due to a demand data store to a 2M/4M page.
		DTLB_STORE_MISSES__MASK__INTEL_ICL_DTLB_STORE_MISSES__WALK_COMPLETED_4K = 0x200ull, // Page walks completed due to a demand data store to a 4K page.
		L1D_PEND_MISS = 0x0048, // L1D pending misses.
		L1D_PEND_MISS__MASK__INTEL_ICL_L1D_PEND_MISS__L2_STALL = 0x400ull, // Number of cycles a demand request has waited due to L1D due to lack of L2 resources.
		...
		L1D_PEND_MISS__MASK__INTEL_ICL_L1D_PEND_MISS__FB_FULL = 0x200ull, // Number of cycles a demand request has waited due to L1D Fill Buffer (FB) unavailability.
		...
		L1D_PEND_MISS__MASK__INTEL_ICL_L1D_PEND_MISS__PENDING = 0x100ull, // Number of L1D misses that are outstanding
		SW_PREFETCH_ACCESS = 0x0032, // Software prefetches.
		SW_PREFETCH_ACCESS__MASK__INTEL_ICL_SW_PREFETCH_ACCESS__PREFETCHW = 0x800ull, // Number of PREFETCHW instructions executed.
		SW_PREFETCH_ACCESS__MASK__INTEL_ICL_SW_PREFETCH_ACCESS__T1_T2 = 0x400ull, // Number of PREFETCHT1 or PREFETCHT2 instructions executed.
		SW_PREFETCH_ACCESS__MASK__INTEL_ICL_SW_PREFETCH_ACCESS__T0 = 0x200ull, // Number of PREFETCHT0 instructions executed.
		SW_PREFETCH_ACCESS__MASK__INTEL_ICL_SW_PREFETCH_ACCESS__NTA = 0x100ull, // Number of PREFETCHNTA instructions executed.
		SW_PREFETCH = 0x0032, // Software prefetches.
		SW_PREFETCH__MASK__INTEL_ICL_SW_PREFETCH_ACCESS__PREFETCHW = 0x800ull, // Number of PREFETCHW instructions executed.
		SW_PREFETCH__MASK__INTEL_ICL_SW_PREFETCH_ACCESS__T1_T2 = 0x400ull, // Number of PREFETCHT1 or PREFETCHT2 instructions executed.
		SW_PREFETCH__MASK__INTEL_ICL_SW_PREFETCH_ACCESS__T0 = 0x200ull, // Number of PREFETCHT0 instructions executed.
		SW_PREFETCH__MASK__INTEL_ICL_SW_PREFETCH_ACCESS__NTA = 0x100ull, // Number of PREFETCHNTA instructions executed.
		...
		CORE_POWER__MASK__INTEL_ICL_CORE_POWER__LVL0_TURBO_LICENSE = 0x700ull, // Core cycles where the core was running in a manner where Turbo may be clipped to the Non-AVX turbo schedule.
		...
		UOPS_ISSUED__MASK__INTEL_ICL_UOPS_ISSUED__VECTOR_WIDTH_MISMATCH = 0x200ull, // Uops inserted at issue-stage in order to preserve upper bits of vector registers.
		UOPS_ISSUED__MASK__INTEL_ICL_UOPS_ISSUED__ANY = 0x100ull, // Uops that RAT issues to RS
		...
		INT_MISC__MASK__INTEL_ICL_INT_MISC__RECOVERY_CYCLES = 0x100ull, // Core cycles the allocator was stalled due to recovery from earlier clear event for this thread
		...
		DTLB_LOAD_MISSES__MASK__INTEL_ICL_DTLB_LOAD_MISSES__WALK_COMPLETED = 0xe00ull, // Load miss in all TLB levels causes a page walk that completes (All page sizes).
		DTLB_LOAD_MISSES__MASK__INTEL_ICL_DTLB_LOAD_MISSES__WALK_COMPLETED_2M_4M = 0x400ull, // Page walks completed due to a demand data load to a 2M/4M page.
		DTLB_LOAD_MISSES__MASK__INTEL_ICL_DTLB_LOAD_MISSES__WALK_COMPLETED_4K = 0x200ull, // Page walks completed due to a demand data load to a 4K page.
		LD_BLOCKS_PARTIAL = 0x0007, // Partial load blocks.
		LD_BLOCKS_PARTIAL__MASK__INTEL_ICL_LD_BLOCKS_PARTIAL__ADDRESS_ALIAS = 0x100ull, // False dependencies in MOB due to partial compare on address.
		LD_BLOCKS = 0x0003, // Blocking loads.
		LD_BLOCKS__MASK__INTEL_ICL_LD_BLOCKS__NO_SR = 0x800ull, // The number of times that split load operations are temporarily blocked because all resources for handling the split accesses are in use.
		LD_BLOCKS__MASK__INTEL_ICL_LD_BLOCKS__STORE_FORWARD = 0x200ull, // Loads blocked due to overlapping with a preceding store that cannot be forwarded.
		TOPDOWN = 0x0000, // TMA slots available for an unhalted logical processor.
		TOPDOWN__MASK__INTEL_ICL_TOPDOWN__BR_MISPREDICT_SLOTS = 0x800ull, // TMA slots wasted due to incorrect speculation by branch mispredictions
		TOPDOWN__MASK__INTEL_ICL_TOPDOWN__BACKEND_BOUND_SLOTS = 0x200ull, // TMA slots where no uops were being issued due to lack of back-end resources.
		TOPDOWN__MASK__INTEL_ICL_TOPDOWN__SLOTS_P = 0x1a400ull, // TMA slots available for an unhalted logical processor. General counter - architectural event
		TOPDOWN__MASK__INTEL_ICL_TOPDOWN__SLOTS = 0x400ull, // TMA slots available for an unhalted logical processor. Fixed counter - architectural event
		...
		TOPDOWN_M__MASK__INTEL_ICL_TOPDOWN_M__BACKEND_BOUND = 0x8300ull, // TMA slots where no uops were being issued due to lack of back-end resources
		TOPDOWN_M__MASK__INTEL_ICL_TOPDOWN_M__BAD_SPEC = 0x8100ull, // TMA slots wasted due to incorrect speculations.
		TOPDOWN_M__MASK__INTEL_ICL_TOPDOWN_M__FRONTEND_BOUND = 0x8200ull, // TMA slots where no uops were being issued due to lack of front-end resources.
		TOPDOWN_M__MASK__INTEL_ICL_TOPDOWN_M__RETIRING = 0x8000ull, // TMA slots where instructions are retiring
		TOPDOWN_M__MASK__INTEL_ICL_TOPDOWN_M__SLOTS = 0x400ull, // TMA slots available for an unhalted logical processor. Fixed counter - architectural event
		CPU_CLK_UNHALTED = 0x003c, // Count core clock cycles whenever the clock signal on the specific core is running (not halted).
		CPU_CLK_UNHALTED__MASK__INTEL_ICL_CPU_CLK_UNHALTED__DISTRIBUTED = 0x2ec00ull, // Cycle counts are evenly distributed between active threads in the Core.
		CPU_CLK_UNHALTED__MASK__INTEL_ICL_CPU_CLK_UNHALTED__REF_DISTRIBUTED = 0x800ull, // Core crystal clock cycles. Cycle counts are evenly distributed between active threads in the Core.
		CPU_CLK_UNHALTED__MASK__INTEL_ICL_CPU_CLK_UNHALTED__ONE_THREAD_ACTIVE = 0x200ull, // Core crystal clock cycles when this thread is unhalted and the other thread is halted.
		CPU_CLK_UNHALTED__MASK__INTEL_ICL_CPU_CLK_UNHALTED__REF_XCLK = 0x100ull, // Core crystal clock cycles when the thread is unhalted.
		CPU_CLK_UNHALTED__MASK__INTEL_ICL_CPU_CLK_UNHALTED__THREAD_P = 0x0ull, // Thread cycles when thread is not in halt state
		CPU_CLK_UNHALTED__MASK__INTEL_ICL_CPU_CLK_UNHALTED__REF_TSC = 0x300ull, // Reference cycles when the core is not in halt state.
		...
		INST_RETIRED__MASK__INTEL_ICL_INST_RETIRED__ANY_P = 0x0ull, // Number of instructions retired. General Counter - architectural event
		INST_RETIRED__MASK__INTEL_ICL_INST_RETIRED__PREC_DIST = 0x100ull, // Precise instruction retired event with a reduced effect of PEBS shadow in IP distribution (Fixed counter 0 only. c
		INST_RETIRED__MASK__INTEL_ICL_INST_RETIRED__ANY = 0x100ull, // Number of instructions retired. Fixed Counter - architectural event (c
		INST_RETIRED__MASK__INTEL_ICL_INST_RETIRED__NOP = 0x200ull, // Number of retired NOP instructions.
		UOPS_DECODED = 0x56, // Number of instructions decoded
		UOPS_DECODED__MASK__INTEL_ICL_UOPS_DECODED__DEC0 = 0x100ull, // Number of uops decoded out of instructions exclusively fetched by decoder 0
		MEM_LOAD_MISC_RETIRED = 0xc4, // Miscellaneous loads retired
		MEM_LOAD_MISC_RETIRED__MASK__INTEL_ICL_MEM_LOAD_MISC_RETIRED__UC = 0x400ull, // Retired instructions with at least 1 uncacheable load or Bus Lock.
		INST_DECODED = 0x55, // Instructions decoders
		INST_DECODED__MASK__INTEL_ICL_INST_DECODED__DECODERS = 0x100ull, // Number of decoders utilized in a cycle when the MITE (legacy decode pipeline) fetches instructions.
