...
#define OPTKIT_CPU_EVENTS(block_name, metric_builder) \
    optkit::core::pmu::cpu::perf::BlockProfiler EXPAND_AND_CONCAT(var, __LINE__) { {block_name}, metric_builder }
...
#define OPTKIT_CPU_GROUP_EVENTS(block_name, metric_builder) \
    optkit::core::pmu::cpu::perf::BlockGroupProfiler EXPAND_AND_CONCAT(var, __LINE__) { {block_name, true}, metric_builder }
