...
namespace optkit::intel::skx_unc_u{
	enum skx_unc_u : uint64_t {
		...
		UNC_U_EVENT_MSG__MASK__SKX_UNC_U_EVENT_MSG__DOORBELL_RCVD = 0x800ull, // Message Received --
		UNC_U_EVENT_MSG__MASK__SKX_UNC_U_EVENT_MSG__INT_PRIO = 0x1000ull, // Message Received --
		UNC_U_EVENT_MSG__MASK__SKX_UNC_U_EVENT_MSG__IPI_RCVD = 0x400ull, // Message Received -- IPI
		UNC_U_EVENT_MSG__MASK__SKX_UNC_U_EVENT_MSG__MSI_RCVD = 0x200ull, // Message Received -- MSI
		UNC_U_EVENT_MSG__MASK__SKX_UNC_U_EVENT_MSG__VLW_RCVD = 0x100ull, // Message Received -- VLW
		UNC_U_LOCK_CYCLES = 0x44, // Number of times an IDI Lock/SplitLock sequence was started
		UNC_U_PHOLD_CYCLES = 0x45, // PHOLD cycles.
		UNC_U_PHOLD_CYCLES__MASK__SKX_UNC_U_PHOLD_CYCLES__ASSERT_TO_ACK = 0x100ull, // Cycles PHOLD Assert to Ack -- Assert to ACK
		UNC_U_RACU_DRNG = 0x4c, // TBD
		UNC_U_RACU_DRNG__MASK__SKX_UNC_U_RACU_DRNG__PFTCH_BUF_EMPTY = 0x400ull, // TBD
		UNC_U_RACU_DRNG__MASK__SKX_UNC_U_RACU_DRNG__RDRAND = 0x100ull, // TBD
		UNC_U_RACU_DRNG__MASK__SKX_UNC_U_RACU_DRNG__RDSEED = 0x200ull, // TBD
