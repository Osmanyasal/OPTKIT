...
write_version(){
    echo "// This file is auto-generated by generate_environment_config.sh" > "$SRC_CONFIG_FILE"
    echo "// Do not edit this file directly" >> "$SRC_CONFIG_FILE"
    echo "#define OPTKIT_VERSION \"0.6.3\"" >> "$SRC_CONFIG_FILE"
}
main() {
    write_version
    write_headers
