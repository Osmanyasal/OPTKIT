...
namespace optkit::intel::spr_unc_imc{
	enum spr_unc_imc : uint64_t {
		...
		UNC_M_PCLS__MASK__SPR_UNC_M_PCLS__RD = 0x500ull, // TBD (experimental)
		UNC_M_PCLS__MASK__SPR_UNC_M_PCLS__TOTAL = 0xf00ull, // TBD (experimental)
		UNC_M_PCLS__MASK__SPR_UNC_M_PCLS__WR = 0xa00ull, // TBD (experimental)
		...
		UNC_M_PMM_RPQ_OCCUPANCY__MASK__SPR_UNC_M_PMM_RPQ_OCCUPANCY__ALL_SCH0 = 0x100ull, // PMM Read Pending Queue occupancy
		UNC_M_PMM_RPQ_OCCUPANCY__MASK__SPR_UNC_M_PMM_RPQ_OCCUPANCY__ALL_SCH1 = 0x200ull, // PMM Read Pending Queue occupancy
		...
		UNC_M_PMM_RPQ_OCCUPANCY__MASK__SPR_UNC_M_PMM_RPQ_OCCUPANCY__NO_GNT_SCH0 = 0x400ull, // PMM Read Pending Queue Occupancy (experimental)
		UNC_M_PMM_RPQ_OCCUPANCY__MASK__SPR_UNC_M_PMM_RPQ_OCCUPANCY__NO_GNT_SCH1 = 0x800ull, // PMM Read Pending Queue Occupancy (experimental)
		...
		UNC_M_PMM_WPQ_OCCUPANCY__MASK__SPR_UNC_M_PMM_WPQ_OCCUPANCY__ALL = 0x300ull, // PMM Write Pending Queue Occupancy
		UNC_M_PMM_WPQ_OCCUPANCY__MASK__SPR_UNC_M_PMM_WPQ_OCCUPANCY__ALL_SCH0 = 0x100ull, // PMM Write Pending Queue Occupancy
		UNC_M_PMM_WPQ_OCCUPANCY__MASK__SPR_UNC_M_PMM_WPQ_OCCUPANCY__ALL_SCH1 = 0x200ull, // PMM Write Pending Queue Occupancy
		UNC_M_PMM_WPQ_OCCUPANCY__MASK__SPR_UNC_M_PMM_WPQ_OCCUPANCY__CAS = 0xc00ull, // PMM (for IXP) Write Pending Queue Occupancy (experimental)
		...
		UNC_M_POWER_CKE_CYCLES__MASK__SPR_UNC_M_POWER_CKE_CYCLES__LOW_0 = 0x100ull, // DIMM ID (experimental)
		UNC_M_POWER_CKE_CYCLES__MASK__SPR_UNC_M_POWER_CKE_CYCLES__LOW_1 = 0x200ull, // DIMM ID (experimental)
		UNC_M_POWER_CKE_CYCLES__MASK__SPR_UNC_M_POWER_CKE_CYCLES__LOW_2 = 0x400ull, // DIMM ID (experimental)
		UNC_M_POWER_CKE_CYCLES__MASK__SPR_UNC_M_POWER_CKE_CYCLES__LOW_3 = 0x800ull, // DIMM ID (experimental)
		UNC_M_POWER_CRIT_THROTTLE_CYCLES = 0x0086, // Throttled Cycles
		UNC_M_POWER_CRIT_THROTTLE_CYCLES__MASK__SPR_UNC_M_POWER_CRIT_THROTTLE_CYCLES__SLOT0 = 0x100ull, // Throttle Cycles for Rank 0 (experimental)
		UNC_M_POWER_CRIT_THROTTLE_CYCLES__MASK__SPR_UNC_M_POWER_CRIT_THROTTLE_CYCLES__SLOT1 = 0x200ull, // Throttle Cycles for Rank 0 (experimental)
		...
		UNC_M_PRE_COUNT__MASK__SPR_UNC_M_PRE_COUNT__PGT_PCH0 = 0x800ull, // Precharges from Page Table (experimental)
		...
		UNC_M_PRE_COUNT__MASK__SPR_UNC_M_PRE_COUNT__RD_PCH0 = 0x100ull, // Precharge due to read (experimental)
		...
		UNC_M_PRE_COUNT__MASK__SPR_UNC_M_PRE_COUNT__UFILL_PCH0 = 0x400ull, // DRAM Precharge commands. (experimental)
		...
		UNC_M_PRE_COUNT__MASK__SPR_UNC_M_PRE_COUNT__WR_PCH0 = 0x200ull, // Precharge due to write (experimental)
		...
		UNC_M_RDB_INSERTS__MASK__SPR_UNC_M_RDB_INSERTS__PCH0 = 0x100ull, // Pseudo-channel 0
		UNC_M_RDB_INSERTS__MASK__SPR_UNC_M_RDB_INSERTS__PCH1 = 0x200ull, // Pseudo-channel 1
		...
		UNC_M_RDB_NE__MASK__SPR_UNC_M_RDB_NE__PCH0 = 0x100ull, // Pseudo-channel 0 (experimental)
		UNC_M_RDB_NE__MASK__SPR_UNC_M_RDB_NE__PCH1 = 0x200ull, // Pseudo-channel 1 (experimental)
		UNC_M_RDB_NE__MASK__SPR_UNC_M_RDB_NE__ANY = 0x300ull, // Read Data Buffer Not Empty any channel (experimental)
		...
		UNC_M_RPQ_INSERTS__MASK__SPR_UNC_M_RPQ_INSERTS__PCH0 = 0x100ull, // Pseudo-channel 0
		UNC_M_RPQ_INSERTS__MASK__SPR_UNC_M_RPQ_INSERTS__PCH1 = 0x200ull, // Pseudo-channel 1
		...
		UNC_M_SB_ACCESSES__MASK__SPR_UNC_M_SB_ACCESSES__ACCEPTS = 0x500ull, // Scoreboard accepts (experimental)
		...
		UNC_M_SB_ACCESSES__MASK__SPR_UNC_M_SB_ACCESSES__RD_ACCEPTS = 0x100ull, // Read Accepts (experimental)
		UNC_M_SB_ACCESSES__MASK__SPR_UNC_M_SB_ACCESSES__RD_REJECTS = 0x200ull, // Read Rejects (experimental)
		UNC_M_SB_ACCESSES__MASK__SPR_UNC_M_SB_ACCESSES__REJECTS = 0xa00ull, // Scoreboard rejects (experimental)
		UNC_M_SB_ACCESSES__MASK__SPR_UNC_M_SB_ACCESSES__WR_ACCEPTS = 0x400ull, // NM read completions (experimental)
		UNC_M_SB_ACCESSES__MASK__SPR_UNC_M_SB_ACCESSES__WR_REJECTS = 0x800ull, // NM write completions (experimental)
		UNC_M_SB_CANARY = 0x00d9, // TBD
		UNC_M_SB_CANARY__MASK__SPR_UNC_M_SB_CANARY__ALLOC = 0x100ull, // Alloc (experimental)
		UNC_M_SB_CANARY__MASK__SPR_UNC_M_SB_CANARY__DEALLOC = 0x200ull, // Dealloc (experimental)
		...
		UNC_M_SB_CANARY__MASK__SPR_UNC_M_SB_CANARY__NM_RD_STARVED = 0x800ull, // Valid (experimental)
		UNC_M_SB_CANARY__MASK__SPR_UNC_M_SB_CANARY__NM_WR_STARVED = 0x1000ull, // Near Mem Read Starved (experimental)
		UNC_M_SB_CANARY__MASK__SPR_UNC_M_SB_CANARY__VLD = 0x400ull, // Reject (experimental)
		...
		UNC_M_SB_INSERTS__MASK__SPR_UNC_M_SB_INSERTS__PMM_RDS = 0x400ull, // Persistent Mem reads (experimental)
		UNC_M_SB_INSERTS__MASK__SPR_UNC_M_SB_INSERTS__PMM_WRS = 0x800ull, // Persistent Mem writes (experimental)
		UNC_M_SB_INSERTS__MASK__SPR_UNC_M_SB_INSERTS__RDS = 0x100ull, // Reads (experimental)
		UNC_M_SB_INSERTS__MASK__SPR_UNC_M_SB_INSERTS__WRS = 0x200ull, // Writes (experimental)
		...
		UNC_M_SB_OCCUPANCY__MASK__SPR_UNC_M_SB_OCCUPANCY__PMM_RDS = 0x400ull, // Persistent Mem reads (experimental)
		UNC_M_SB_OCCUPANCY__MASK__SPR_UNC_M_SB_OCCUPANCY__PMM_WRS = 0x800ull, // Persistent Mem writes (experimental)
		UNC_M_SB_OCCUPANCY__MASK__SPR_UNC_M_SB_OCCUPANCY__RDS = 0x100ull, // Reads (experimental)
		UNC_M_SB_PREF_INSERTS = 0x00da, // Scoreboard Prefetch Inserts
		UNC_M_SB_PREF_INSERTS__MASK__SPR_UNC_M_SB_PREF_INSERTS__ALL = 0x100ull, // All (experimental)
		UNC_M_SB_PREF_INSERTS__MASK__SPR_UNC_M_SB_PREF_INSERTS__DDR = 0x200ull, // DDR4 (experimental)
		UNC_M_SB_PREF_INSERTS__MASK__SPR_UNC_M_SB_PREF_INSERTS__PMM = 0x400ull, // PMM (experimental)
		UNC_M_SB_PREF_OCCUPANCY = 0x00db, // Scoreboard Prefetch Occupancy
		UNC_M_SB_PREF_OCCUPANCY__MASK__SPR_UNC_M_SB_PREF_OCCUPANCY__ALL = 0x100ull, // All (experimental)
		UNC_M_SB_PREF_OCCUPANCY__MASK__SPR_UNC_M_SB_PREF_OCCUPANCY__DDR = 0x200ull, // DDR4 (experimental)
		UNC_M_SB_PREF_OCCUPANCY__MASK__SPR_UNC_M_SB_PREF_OCCUPANCY__PMM = 0x400ull, // Persistent Mem (experimental)
		UNC_M_SB_REJECT = 0x00d4, // Number of Scoreboard Requests Rejected
		UNC_M_SB_REJECT__MASK__SPR_UNC_M_SB_REJECT__CANARY = 0x800ull, // Number of Scoreboard Requests Rejected (experimental)
		UNC_M_SB_REJECT__MASK__SPR_UNC_M_SB_REJECT__DDR_EARLY_CMP = 0x2000ull, // Number of Scoreboard Requests Rejected (experimental)
		UNC_M_SB_REJECT__MASK__SPR_UNC_M_SB_REJECT__FM_ADDR_CNFLT = 0x200ull, // FM requests rejected due to full address conflict (experimental)
		UNC_M_SB_REJECT__MASK__SPR_UNC_M_SB_REJECT__NM_SET_CNFLT = 0x100ull, // NM requests rejected due to set conflict (experimental)
		UNC_M_SB_REJECT__MASK__SPR_UNC_M_SB_REJECT__PATROL_SET_CNFLT = 0x400ull, // Patrol requests rejected due to set conflict (experimental)
		UNC_M_SB_STRV_ALLOC = 0x00d7, // TBD
		UNC_M_SB_STRV_ALLOC__MASK__SPR_UNC_M_SB_STRV_DEALLOC__FM_RD = 0x200ull, // Far Mem Read - Set (experimental)
		UNC_M_SB_STRV_ALLOC__MASK__SPR_UNC_M_SB_STRV_DEALLOC__FM_TGR = 0x1000ull, // Near Mem Read - Clear (experimental)
		UNC_M_SB_STRV_ALLOC__MASK__SPR_UNC_M_SB_STRV_DEALLOC__FM_WR = 0x800ull, // Far Mem Write - Set (experimental)
		UNC_M_SB_STRV_ALLOC__MASK__SPR_UNC_M_SB_STRV_DEALLOC__NM_RD = 0x100ull, // Near Mem Read - Set (experimental)
		UNC_M_SB_STRV_ALLOC__MASK__SPR_UNC_M_SB_STRV_DEALLOC__NM_WR = 0x400ull, // Near Mem Write - Set (experimental)
		UNC_M_SB_STRV_DEALLOC = 0x00de, // TBD
		UNC_M_SB_STRV_DEALLOC__MASK__SPR_UNC_M_SB_STRV_DEALLOC__FM_RD = 0x200ull, // Far Mem Read - Set (experimental)
		UNC_M_SB_STRV_DEALLOC__MASK__SPR_UNC_M_SB_STRV_DEALLOC__FM_TGR = 0x1000ull, // Near Mem Read - Clear (experimental)
		UNC_M_SB_STRV_DEALLOC__MASK__SPR_UNC_M_SB_STRV_DEALLOC__FM_WR = 0x800ull, // Far Mem Write - Set (experimental)
		UNC_M_SB_STRV_DEALLOC__MASK__SPR_UNC_M_SB_STRV_DEALLOC__NM_RD = 0x100ull, // Near Mem Read - Set (experimental)
		UNC_M_SB_STRV_DEALLOC__MASK__SPR_UNC_M_SB_STRV_DEALLOC__NM_WR = 0x400ull, // Near Mem Write - Set (experimental)
		UNC_M_SB_STRV_OCC = 0x00d8, // TBD
		UNC_M_SB_STRV_OCC__MASK__SPR_UNC_M_SB_STRV_OCC__FM_RD = 0x200ull, // Far Mem Read (experimental)
		UNC_M_SB_STRV_OCC__MASK__SPR_UNC_M_SB_STRV_OCC__FM_TGR = 0x1000ull, // Near Mem Read - Clear (experimental)
		UNC_M_SB_STRV_OCC__MASK__SPR_UNC_M_SB_STRV_OCC__FM_WR = 0x800ull, // Far Mem Write (experimental)
		UNC_M_SB_STRV_OCC__MASK__SPR_UNC_M_SB_STRV_OCC__NM_RD = 0x100ull, // Near Mem Read (experimental)
		UNC_M_SB_STRV_OCC__MASK__SPR_UNC_M_SB_STRV_OCC__NM_WR = 0x400ull, // Near Mem Write (experimental)
		UNC_M_SB_TAGGED = 0x00dd, // TBD
		UNC_M_SB_TAGGED__MASK__SPR_UNC_M_SB_TAGGED__DDR4_CMP = 0x800ull, // TBD (experimental)
		UNC_M_SB_TAGGED__MASK__SPR_UNC_M_SB_TAGGED__NEW = 0x100ull, // TBD (experimental)
		...
		UNC_M_SB_TAGGED__MASK__SPR_UNC_M_SB_TAGGED__RD_HIT = 0x200ull, // TBD (experimental)
		UNC_M_SB_TAGGED__MASK__SPR_UNC_M_SB_TAGGED__RD_MISS = 0x400ull, // TBD (experimental)
		UNC_M_TAGCHK = 0x00d3, // 2LM Tag check
		UNC_M_TAGCHK__MASK__SPR_UNC_M_TAGCHK__HIT = 0x100ull, // 2LM Tag check hit in near memory cache (DDR4)
		UNC_M_TAGCHK__MASK__SPR_UNC_M_TAGCHK__MISS_CLEAN = 0x200ull, // 2LM Tag check miss
		UNC_M_TAGCHK__MASK__SPR_UNC_M_TAGCHK__MISS_DIRTY = 0x400ull, // 2LM Tag check miss
		UNC_M_TAGCHK__MASK__SPR_UNC_M_TAGCHK__NM_RD_HIT = 0x800ull, // 2LM Tag check hit due to memory read
		...
		UNC_M_WPQ_INSERTS__MASK__SPR_UNC_M_WPQ_INSERTS__PCH0 = 0x100ull, // Pseudo-channel 0
		UNC_M_WPQ_INSERTS__MASK__SPR_UNC_M_WPQ_INSERTS__PCH1 = 0x200ull, // Pseudo-channel 1
