...
namespace optkit::intel::icx_unc_iio{
	enum icx_unc_iio : uint64_t {
		...
		UNC_IIO_BANDWIDTH_IN__MASK__ICX_UNC_IIO_BANDWIDTH_IN__PART0_FREERUN = 0x0ull, // TBD (experimental)
		UNC_IIO_BANDWIDTH_IN__MASK__ICX_UNC_IIO_BANDWIDTH_IN__PART1_FREERUN = 0x0ull, // TBD (experimental)
		UNC_IIO_BANDWIDTH_IN__MASK__ICX_UNC_IIO_BANDWIDTH_IN__PART2_FREERUN = 0x0ull, // TBD (experimental)
		UNC_IIO_BANDWIDTH_IN__MASK__ICX_UNC_IIO_BANDWIDTH_IN__PART3_FREERUN = 0x0ull, // TBD (experimental)
		UNC_IIO_BANDWIDTH_IN__MASK__ICX_UNC_IIO_BANDWIDTH_IN__PART4_FREERUN = 0x0ull, // TBD (experimental)
		UNC_IIO_BANDWIDTH_IN__MASK__ICX_UNC_IIO_BANDWIDTH_IN__PART5_FREERUN = 0x0ull, // TBD (experimental)
		UNC_IIO_BANDWIDTH_IN__MASK__ICX_UNC_IIO_BANDWIDTH_IN__PART6_FREERUN = 0x0ull, // TBD (experimental)
		UNC_IIO_BANDWIDTH_IN__MASK__ICX_UNC_IIO_BANDWIDTH_IN__PART7_FREERUN = 0x0ull, // TBD (experimental)
		...
		UNC_IIO_BANDWIDTH_OUT__MASK__ICX_UNC_IIO_BANDWIDTH_OUT__PART0_FREERUN = 0x0ull, // TBD (experimental)
		UNC_IIO_BANDWIDTH_OUT__MASK__ICX_UNC_IIO_BANDWIDTH_OUT__PART1_FREERUN = 0x0ull, // TBD (experimental)
		UNC_IIO_BANDWIDTH_OUT__MASK__ICX_UNC_IIO_BANDWIDTH_OUT__PART2_FREERUN = 0x0ull, // TBD (experimental)
		UNC_IIO_BANDWIDTH_OUT__MASK__ICX_UNC_IIO_BANDWIDTH_OUT__PART3_FREERUN = 0x0ull, // TBD (experimental)
		UNC_IIO_BANDWIDTH_OUT__MASK__ICX_UNC_IIO_BANDWIDTH_OUT__PART4_FREERUN = 0x0ull, // TBD (experimental)
		UNC_IIO_BANDWIDTH_OUT__MASK__ICX_UNC_IIO_BANDWIDTH_OUT__PART5_FREERUN = 0x0ull, // TBD (experimental)
		UNC_IIO_BANDWIDTH_OUT__MASK__ICX_UNC_IIO_BANDWIDTH_OUT__PART6_FREERUN = 0x0ull, // TBD (experimental)
		UNC_IIO_BANDWIDTH_OUT__MASK__ICX_UNC_IIO_BANDWIDTH_OUT__PART7_FREERUN = 0x0ull, // TBD (experimental)
		...
		UNC_IIO_IOMMU0__MASK__ICX_UNC_IIO_IOMMU0__2M_HITS = 0x800ull, // IOTLB Hits to a 2M Page (experimental)
		UNC_IIO_IOMMU0__MASK__ICX_UNC_IIO_IOMMU0__4K_HITS = 0x400ull, // IOTLB Hits to a 4K Page (experimental)
		UNC_IIO_IOMMU0__MASK__ICX_UNC_IIO_IOMMU0__ALL_LOOKUPS = 0x200ull, // IOTLB lookups all (experimental)
		...
		UNC_IIO_IOMMU0__MASK__ICX_UNC_IIO_IOMMU0__FIRST_LOOKUPS = 0x100ull, // IOTLB lookups first (experimental)
		...
		UNC_IIO_IOMMU1__MASK__ICX_UNC_IIO_IOMMU1__PWC_1G_HITS = 0x800ull, // PWC Hit to a 1G page (experimental)
		UNC_IIO_IOMMU1__MASK__ICX_UNC_IIO_IOMMU1__PWC_2M_HITS = 0x400ull, // PWC Hit to a 2M page (experimental)
		UNC_IIO_IOMMU1__MASK__ICX_UNC_IIO_IOMMU1__PWC_4K_HITS = 0x200ull, // PWC Hit to a 4K page (experimental)
		...
		UNC_IIO_IOMMU1__MASK__ICX_UNC_IIO_IOMMU1__PWT_CACHE_LOOKUPS = 0x100ull, // PageWalk cache lookup (experimental)
		...
		UNC_IIO_IOMMU3__MASK__ICX_UNC_IIO_IOMMU3__NUM_CTXT_CACHE_INVAL_GBL = 0x800ull, // Context cache global invalidation cycles (experimental)
		UNC_IIO_IOMMU3__MASK__ICX_UNC_IIO_IOMMU3__NUM_INVAL_DOMAIN = 0x200ull, // Domain-selective IOTLB invalidation cycles (experimental)
		UNC_IIO_IOMMU3__MASK__ICX_UNC_IIO_IOMMU3__NUM_INVAL_GBL = 0x100ull, // Global IOTLB invalidation cycles (experimental)
		UNC_IIO_IOMMU3__MASK__ICX_UNC_IIO_IOMMU3__NUM_INVAL_PAGE = 0x400ull, // Page-selective IOTLB invalidation cycles (experimental)
		UNC_IIO_MASK_MATCH_AND = 0x0002, // AND Mask/match for debug bus
		UNC_IIO_MASK_MATCH_AND__MASK__ICX_UNC_IIO_MASK_MATCH_OR__BUS0 = 0x100ull, // Non-PCIE bus (experimental)
		UNC_IIO_MASK_MATCH_AND__MASK__ICX_UNC_IIO_MASK_MATCH_OR__BUS0_BUS1 = 0x800ull, // Non-PCIE bus and PCIE bus (experimental)
		UNC_IIO_MASK_MATCH_AND__MASK__ICX_UNC_IIO_MASK_MATCH_OR__BUS0_NOT_BUS1 = 0x400ull, // Non-PCIE bus and !(PCIE bus) (experimental)
		UNC_IIO_MASK_MATCH_AND__MASK__ICX_UNC_IIO_MASK_MATCH_OR__BUS1 = 0x200ull, // PCIE bus (experimental)
		...
		UNC_IIO_MASK_MATCH_OR__MASK__ICX_UNC_IIO_MASK_MATCH_OR__BUS0 = 0x100ull, // Non-PCIE bus (experimental)
		UNC_IIO_MASK_MATCH_OR__MASK__ICX_UNC_IIO_MASK_MATCH_OR__BUS0_BUS1 = 0x800ull, // Non-PCIE bus and PCIE bus (experimental)
		UNC_IIO_MASK_MATCH_OR__MASK__ICX_UNC_IIO_MASK_MATCH_OR__BUS0_NOT_BUS1 = 0x400ull, // Non-PCIE bus and !(PCIE bus) (experimental)
		UNC_IIO_MASK_MATCH_OR__MASK__ICX_UNC_IIO_MASK_MATCH_OR__BUS1 = 0x200ull, // PCIE bus (experimental)
