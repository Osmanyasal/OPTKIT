...
namespace optkit::core::metrics
{
    ...
    /**
     * @brief Implemented for set of events of most Intel architectures. To customize for your specific architecture, check the /src/core/pmu/cpu/perf/events/core/events/intel/ directory and override any method as needed.
    ...
    public:
        TMAnalysis(const char *block_name, const char *event_name, bool verbose = true, const core::pmu::cpu::perf::PerfProfilerConfig &config = core::pmu::cpu::perf::PerfProfilerConfig{false, true, false, 0, -1});
