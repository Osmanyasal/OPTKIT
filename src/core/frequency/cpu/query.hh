...
namespace optkit::frequency::cpu
{
    ...
    public:
        ...
        static bool set_scaling_governor(const std::string &governor, int32_t socket = 0);
        static bool set_scaling_governor_percore(const std::string &governor, int32_t core = 0);
