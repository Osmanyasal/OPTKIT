...
namespace optkit::intel::glm{
	enum glm : uint64_t {
		...
		ICACHE__MASK__GLM_ICACHE__HIT = 0x100ull, // References per ICache line that are available in the ICache (hit). This event counts differently than Intel processors based on Silvermont microarchitecture
		ICACHE__MASK__GLM_ICACHE__MISSES = 0x200ull, // References per ICache line that are not available in the ICache (miss). This event counts differently than Intel processors based on Silvermont microarchitecture
		ICACHE__MASK__GLM_ICACHE__ACCESSES = 0x300ull, // References per ICache line. This event counts differently than Intel processors based on Silvermont microarchitecture
		L2_REJECT_XQ = 0x30, // Requests rejected by the XQ
		L2_REJECT_XQ__MASK__GLM_L2_REJECT_XQ__ALL = 0x0ull, // Requests rejected by the XQ
		HW_INTERRUPTS = 0xcb, // Hardware interrupts received
		HW_INTERRUPTS__MASK__GLM_HW_INTERRUPTS__RECEIVED = 0x100ull, // Hardware interrupts received
		HW_INTERRUPTS__MASK__GLM_HW_INTERRUPTS__PENDING_AND_MASKED = 0x400ull, // Cycles pending interrupts are masked
		BR_MISP_RETIRED = 0xc5, // Retired mispredicted branch instructions (Precise Event)
		BR_MISP_RETIRED__MASK__GLM_BR_MISP_RETIRED__ALL_BRANCHES = 0x0ull, // Retired mispredicted branch instructions (Precise Event)
		BR_MISP_RETIRED__MASK__GLM_BR_MISP_RETIRED__JCC = 0x7e00ull, // Retired mispredicted conditional branch instructions (Precise Event)
		BR_MISP_RETIRED__MASK__GLM_BR_MISP_RETIRED__TAKEN_JCC = 0xfe00ull, // Retired mispredicted conditional branch instructions that were taken (Precise Event)
		BR_MISP_RETIRED__MASK__GLM_BR_MISP_RETIRED__IND_CALL = 0xfb00ull, // Retired mispredicted near indirect call instructions (Precise Event)
		BR_MISP_RETIRED__MASK__GLM_BR_MISP_RETIRED__RETURN = 0xf700ull, // Retired mispredicted near return instructions (Precise Event)
		BR_MISP_RETIRED__MASK__GLM_BR_MISP_RETIRED__NON_RETURN_IND = 0xeb00ull, // Retired mispredicted instructions of near indirect Jmp or near indirect call (Precise Event)
		DECODE_RESTRICTION = 0xe9, // Decode restrictions due to predicting wrong instruction length
		DECODE_RESTRICTION__MASK__GLM_DECODE_RESTRICTION__PREDECODE_WRONG = 0x100ull, // Decode restrictions due to predicting wrong instruction length
		MISALIGN_MEM_REF = 0x13, // Load uops that split a page (Precise Event)
		MISALIGN_MEM_REF__MASK__GLM_MISALIGN_MEM_REF__LOAD_PAGE_SPLIT = 0x200ull, // Load uops that split a page (Precise Event)
		MISALIGN_MEM_REF__MASK__GLM_MISALIGN_MEM_REF__STORE_PAGE_SPLIT = 0x400ull, // Store uops that split a page (Precise Event)
		INST_RETIRED = 0xc0, // Instructions retired (Precise Event)
		INST_RETIRED__MASK__GLM_INST_RETIRED__ANY_P = 0x0ull, // Counts the number of instructions that retire execution. For instructions that consist of multiple uops
		...
		ISSUE_SLOTS_NOT_CONSUMED__MASK__GLM_ISSUE_SLOTS_NOT_CONSUMED__RESOURCE_FULL = 0x100ull, // Unfilled issue slots per cycle because of a full resource in the backend
		ISSUE_SLOTS_NOT_CONSUMED__MASK__GLM_ISSUE_SLOTS_NOT_CONSUMED__RECOVERY = 0x200ull, // Unfilled issue slots per cycle to recover
		ISSUE_SLOTS_NOT_CONSUMED__MASK__GLM_ISSUE_SLOTS_NOT_CONSUMED__ANY = 0x0ull, // Unfilled issue slots per cycle
		ITLB = 0x81, // ITLB misses
		ITLB__MASK__GLM_ITLB__MISS = 0x400ull, // ITLB misses
		LONGEST_LAT_CACHE = 0x2e, // L2 cache requests
		LONGEST_LAT_CACHE__MASK__GLM_LONGEST_LAT_CACHE__REFERENCE = 0x4f00ull, // L2 cache requests
		LONGEST_LAT_CACHE__MASK__GLM_LONGEST_LAT_CACHE__MISS = 0x4100ull, // L2 cache request misses
		MEM_LOAD_UOPS_RETIRED = 0xd1, // Load uops retired that hit L1 data cache (Precise Event)
		MEM_LOAD_UOPS_RETIRED__MASK__GLM_MEM_LOAD_UOPS_RETIRED__L1_HIT = 0x100ull, // Load uops retired that hit L1 data cache (Precise Event)
		MEM_LOAD_UOPS_RETIRED__MASK__GLM_MEM_LOAD_UOPS_RETIRED__L1_MISS = 0x800ull, // Load uops retired that missed L1 data cache (Precise Event)
		MEM_LOAD_UOPS_RETIRED__MASK__GLM_MEM_LOAD_UOPS_RETIRED__L2_HIT = 0x200ull, // Load uops retired that hit L2 (Precise Event)
		MEM_LOAD_UOPS_RETIRED__MASK__GLM_MEM_LOAD_UOPS_RETIRED__L2_MISS = 0x1000ull, // Load uops retired that missed L2 (Precise Event)
		MEM_LOAD_UOPS_RETIRED__MASK__GLM_MEM_LOAD_UOPS_RETIRED__HITM = 0x2000ull, // Memory uop retired where cross core or cross module HITM occurred (Precise Event)
		MEM_LOAD_UOPS_RETIRED__MASK__GLM_MEM_LOAD_UOPS_RETIRED__WCB_HIT = 0x4000ull, // Loads retired that hit WCB (Precise Event)
		MEM_LOAD_UOPS_RETIRED__MASK__GLM_MEM_LOAD_UOPS_RETIRED__DRAM_HIT = 0x8000ull, // Loads retired that came from DRAM (Precise Event)
		LD_BLOCKS = 0x03, // Loads blocked (Precise Event)
		LD_BLOCKS__MASK__GLM_LD_BLOCKS__ALL_BLOCK = 0x1000ull, // Loads blocked (Precise Event)
		LD_BLOCKS__MASK__GLM_LD_BLOCKS__UTLB_MISS = 0x800ull, // Loads blocked because address in not in the UTLB (Precise Event)
		LD_BLOCKS__MASK__GLM_LD_BLOCKS__STORE_FORWARD = 0x200ull, // Loads blocked due to store forward restriction (Precise Event)
		LD_BLOCKS__MASK__GLM_LD_BLOCKS__DATA_UNKNOWN = 0x100ull, // Loads blocked due to store data not ready (Precise Event)
		LD_BLOCKS__MASK__GLM_LD_BLOCKS__4K_ALIAS = 0x400ull, // Loads blocked because address has 4k partial address false dependence (Precise Event)
		DL1 = 0x51, // L1 Cache evictions for dirty data
		DL1__MASK__GLM_DL1__DIRTY_EVICTION = 0x100ull, // L1 Cache evictions for dirty data
		CYCLES_DIV_BUSY = 0xcd, // Cycles a divider is busy
		CYCLES_DIV_BUSY__MASK__GLM_CYCLES_DIV_BUSY__ALL = 0x0ull, // Cycles a divider is busy
		CYCLES_DIV_BUSY__MASK__GLM_CYCLES_DIV_BUSY__IDIV = 0x100ull, // Cycles the integer divide unit is busy
		CYCLES_DIV_BUSY__MASK__GLM_CYCLES_DIV_BUSY__FPDIV = 0x200ull, // Cycles the FP divide unit is busy
		MS_DECODED = 0xe7, // MS decode starts
		MS_DECODED__MASK__GLM_MS_DECODED__MS_ENTRY = 0x100ull, // MS decode starts
		UOPS_RETIRED = 0xc2, // Uops retired (Precise Event)
		UOPS_RETIRED__MASK__GLM_UOPS_RETIRED__ANY = 0x0ull, // Uops retired (Precise Event)
		UOPS_RETIRED__MASK__GLM_UOPS_RETIRED__MS = 0x100ull, // MS uops retired (Precise Event)
		...
		MACHINE_CLEARS__MASK__GLM_MACHINE_CLEARS__SMC = 0x100ull, // Self-Modifying Code detected
		MACHINE_CLEARS__MASK__GLM_MACHINE_CLEARS__MEMORY_ORDERING = 0x200ull, // Machine cleas due to memory ordering issue
		MACHINE_CLEARS__MASK__GLM_MACHINE_CLEARS__FP_ASSIST = 0x400ull, // Machine clears due to FP assists
		MACHINE_CLEARS__MASK__GLM_MACHINE_CLEARS__DISAMBIGUATION = 0x800ull, // Machine clears due to memory disambiguation
		MACHINE_CLEARS__MASK__GLM_MACHINE_CLEARS__ALL = 0x0ull, // All machine clears
		BR_INST_RETIRED = 0xc4, // Retired branch instructions (Precise Event)
		BR_INST_RETIRED__MASK__GLM_BR_INST_RETIRED__ALL_BRANCHES = 0x0ull, // Retired branch instructions (Precise Event)
		BR_INST_RETIRED__MASK__GLM_BR_INST_RETIRED__ALL_TAKEN_BRANCHES = 0x8000ull, // Retired branch instructions (Precise Event)
		BR_INST_RETIRED__MASK__GLM_BR_INST_RETIRED__JCC = 0x7e00ull, // Retired conditional branch instructions (Precise Event)
		BR_INST_RETIRED__MASK__GLM_BR_INST_RETIRED__TAKEN_JCC = 0xfe00ull, // Retired conditional branch instructions that were taken (Precise Event)
		BR_INST_RETIRED__MASK__GLM_BR_INST_RETIRED__CALL = 0xf900ull, // Retired near call instructions (Precise Event)
		BR_INST_RETIRED__MASK__GLM_BR_INST_RETIRED__REL_CALL = 0xfd00ull, // Retired near relative call instructions (Precise Event)
		BR_INST_RETIRED__MASK__GLM_BR_INST_RETIRED__IND_CALL = 0xfb00ull, // Retired near indirect call instructions (Precise Event)
		BR_INST_RETIRED__MASK__GLM_BR_INST_RETIRED__RETURN = 0xf700ull, // Retired near return instructions (Precise Event)
		BR_INST_RETIRED__MASK__GLM_BR_INST_RETIRED__NON_RETURN_IND = 0xeb00ull, // Retired instructions of near indirect Jmp or call (Precise Event)
		BR_INST_RETIRED__MASK__GLM_BR_INST_RETIRED__FAR_BRANCH = 0xbf00ull, // Retired far branch instructions (Precise Event)
		...
		FETCH_STALL__MASK__GLM_FETCH_STALL__ICACHE_FILL_PENDING_CYCLES = 0x200ull, // Cycles where code-fetch is stalled and an ICache miss is outstanding.  This is not the same as an ICache Miss
		UOPS_NOT_DELIVERED = 0x9c, // Uops requested but not-delivered to the back-end per cycle
		UOPS_NOT_DELIVERED__MASK__GLM_UOPS_NOT_DELIVERED__ANY = 0x0ull, // Uops requested but not-delivered to the back-end per cycle
		...
		MEM_UOPS_RETIRED__MASK__GLM_MEM_UOPS_RETIRED__ALL_LOADS = 0x8100ull, // Load uops retired (Precise Event)
		MEM_UOPS_RETIRED__MASK__GLM_MEM_UOPS_RETIRED__ALL_STORES = 0x8200ull, // Store uops retired (Precise Event)
		MEM_UOPS_RETIRED__MASK__GLM_MEM_UOPS_RETIRED__ALL = 0x8300ull, // Memory uops retired (Precise Event)
		MEM_UOPS_RETIRED__MASK__GLM_MEM_UOPS_RETIRED__DTLB_MISS_LOADS = 0x1100ull, // Load uops retired that missed the DTLB (Precise Event)
		MEM_UOPS_RETIRED__MASK__GLM_MEM_UOPS_RETIRED__DTLB_MISS_STORES = 0x1200ull, // Store uops retired that missed the DTLB (Precise Event)
		MEM_UOPS_RETIRED__MASK__GLM_MEM_UOPS_RETIRED__DTLB_MISS = 0x1300ull, // Memory uops retired that missed the DTLB (Precise Event)
		MEM_UOPS_RETIRED__MASK__GLM_MEM_UOPS_RETIRED__LOCK_LOADS = 0x2100ull, // Locked load uops retired (Precise Event)
		MEM_UOPS_RETIRED__MASK__GLM_MEM_UOPS_RETIRED__SPLIT_LOADS = 0x4100ull, // Load uops retired that split a cache-line (Precise Event)
		MEM_UOPS_RETIRED__MASK__GLM_MEM_UOPS_RETIRED__SPLIT_STORES = 0x4200ull, // Stores uops retired that split a cache-line (Precise Event)
		MEM_UOPS_RETIRED__MASK__GLM_MEM_UOPS_RETIRED__SPLIT = 0x4300ull, // Memory uops retired that split a cache-line (Precise Event)
		UOPS_ISSUED = 0x0e, // Uops issued to the back end per cycle
		UOPS_ISSUED__MASK__GLM_UOPS_ISSUED__ANY = 0x0ull, // Uops issued to the back end per cycle
		...
		CORE_REJECT_L2Q__MASK__GLM_CORE_REJECT_L2Q__ALL = 0x0ull, // Requests rejected by the L2Q
		PAGE_WALKS = 0x05, // Duration of D-side page-walks in cycles
		PAGE_WALKS__MASK__GLM_PAGE_WALKS__D_SIDE_CYCLES = 0x100ull, // Duration of D-side page-walks in cycles
		PAGE_WALKS__MASK__GLM_PAGE_WALKS__I_SIDE_CYCLES = 0x200ull, // Duration of I-side pagewalks in cycles
		PAGE_WALKS__MASK__GLM_PAGE_WALKS__CYCLES = 0x300ull, // Duration of page-walks in cycles
		BACLEARS = 0xe6, // BACLEARs asserted for any branch type
		BACLEARS__MASK__GLM_BACLEARS__ALL = 0x100ull, // BACLEARs asserted for any branch type
		BACLEARS__MASK__GLM_BACLEARS__RETURN = 0x800ull, // BACLEARs asserted for return branch
		BACLEARS__MASK__GLM_BACLEARS__COND = 0x1000ull, // BACLEARs asserted for conditional branch
		CPU_CLK_UNHALTED = 0x00, // Core cycles when core is not halted  (Fixed event)
		CPU_CLK_UNHALTED__MASK__GLM_CPU_CLK_UNHALTED__CORE = 0x200ull, // Core cycles when core is not halted  (Fixed event)
		CPU_CLK_UNHALTED__MASK__GLM_CPU_CLK_UNHALTED__REF_TSC = 0x300ull, // Reference cycles when core is not halted  (Fixed event)
		CPU_CLK_UNHALTED__MASK__GLM_CPU_CLK_UNHALTED__CORE_P = 0x0ull, // Core cycles when core is not halted
		CPU_CLK_UNHALTED__MASK__GLM_CPU_CLK_UNHALTED__REF = 0x100ull, // Reference cycles when core is not halted
