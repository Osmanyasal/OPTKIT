    ...
    public:
        ...
        static const std::vector<std::string> &get_all_metrics()
        {
            static const std::vector<std::string> names = {
                ...
                "ip_mem_store",
                "ip_mispredict",
                // removed: ip_flop (not implemented)
                "ip_avx_any_flop",
                // removed: ip_arith* and scalarp_arith_vector (not implemented)
                // removed: ip_swpf (not implemented)
                ...
                // removed: frontend_bound_latency (not implemented)
                // removed: frontend_bound_bw (not implemented)
                // removed: bad_speculation_mispredicts (not implemented)
                // removed: bad_speculation_pipeline_restarts (not implemented)
                // removed: backend_bound_memory (not implemented)
                // removed: backend_bound_cpu (not implemented)
                // removed: retiring_fastpath (not implemented)
                // removed: retiring_microcode (not implemented)
                ...
                // "all_cache_hit_ratio",
                // "all_stlb_mpki",
                // removed: all_latency_and_parallelism (depends on missing metrics)
                // removed: all_dram_bandwidth (depends on missing metrics)
                // "all_ip_metrics",
                // "all_branch_metrics",
                // "all_metrics"
            };
