...
namespace optkit::intel::skx_unc_iio{
	enum skx_unc_iio : uint64_t {
		...
		UNC_IO_MASK_MATCH_AND__MASK__SKX_UNC_IO_MASK_MATCH_AND__BUS0 = 0x100ull, // AND Mask/match for debug bus -- Non-PCIE bus
		UNC_IO_MASK_MATCH_AND__MASK__SKX_UNC_IO_MASK_MATCH_AND__BUS0_BUS1 = 0x800ull, // AND Mask/match for debug bus -- Non-PCIE bus and PCIE bus
		UNC_IO_MASK_MATCH_AND__MASK__SKX_UNC_IO_MASK_MATCH_AND__BUS0_NOT_BUS1 = 0x400ull, // AND Mask/match for debug bus -- Non-PCIE bus and !(PCIE bus)
		UNC_IO_MASK_MATCH_AND__MASK__SKX_UNC_IO_MASK_MATCH_AND__BUS1 = 0x200ull, // AND Mask/match for debug bus -- PCIE bus
		UNC_IO_MASK_MATCH_AND__MASK__SKX_UNC_IO_MASK_MATCH_AND__NOT_BUS0_BUS1 = 0x1000ull, // AND Mask/match for debug bus -- !(Non-PCIE bus) and PCIE bus
		UNC_IO_MASK_MATCH_AND__MASK__SKX_UNC_IO_MASK_MATCH_AND__NOT_BUS0_NOT_BUS1 = 0x2000ull, // AND Mask/match for debug bus --
		UNC_IO_MASK_MATCH_OR = 0x3, // Asserted if any bits specified by mask match
		UNC_IO_MASK_MATCH_OR__MASK__SKX_UNC_IO_MASK_MATCH_OR__BUS0 = 0x100ull, // OR Mask/match for debug bus -- Non-PCIE bus
		UNC_IO_MASK_MATCH_OR__MASK__SKX_UNC_IO_MASK_MATCH_OR__BUS0_BUS1 = 0x800ull, // OR Mask/match for debug bus -- Non-PCIE bus and PCIE bus
		UNC_IO_MASK_MATCH_OR__MASK__SKX_UNC_IO_MASK_MATCH_OR__BUS0_NOT_BUS1 = 0x400ull, // OR Mask/match for debug bus -- Non-PCIE bus and !(PCIE bus)
		UNC_IO_MASK_MATCH_OR__MASK__SKX_UNC_IO_MASK_MATCH_OR__BUS1 = 0x200ull, // OR Mask/match for debug bus -- PCIE bus
		UNC_IO_MASK_MATCH_OR__MASK__SKX_UNC_IO_MASK_MATCH_OR__NOT_BUS0_BUS1 = 0x1000ull, // OR Mask/match for debug bus -- !(Non-PCIE bus) and PCIE bus
		UNC_IO_MASK_MATCH_OR__MASK__SKX_UNC_IO_MASK_MATCH_OR__NOT_BUS0_NOT_BUS1 = 0x2000ull, // OR Mask/match for debug bus -- !(Non-PCIE bus) and !(PCIE bus)
		...
		UNC_IO_VTD_ACCESS__MASK__SKX_UNC_IO_VTD_ACCESS__CTXT_MISS = 0x200ull, // VTd Access -- context cache miss
		UNC_IO_VTD_ACCESS__MASK__SKX_UNC_IO_VTD_ACCESS__L1_MISS = 0x400ull, // VTd Access -- L1 miss
		UNC_IO_VTD_ACCESS__MASK__SKX_UNC_IO_VTD_ACCESS__L2_MISS = 0x800ull, // VTd Access -- L2 miss
		UNC_IO_VTD_ACCESS__MASK__SKX_UNC_IO_VTD_ACCESS__L3_MISS = 0x1000ull, // VTd Access -- L3 miss
		UNC_IO_VTD_ACCESS__MASK__SKX_UNC_IO_VTD_ACCESS__L4_PAGE_HIT = 0x100ull, // VTd Access -- Vtd hit
		UNC_IO_VTD_ACCESS__MASK__SKX_UNC_IO_VTD_ACCESS__TLB1_MISS = 0x8000ull, // VTd Access -- TLB miss
		UNC_IO_VTD_ACCESS__MASK__SKX_UNC_IO_VTD_ACCESS__TLB_FULL = 0x4000ull, // VTd Access -- TLB is full
		UNC_IO_VTD_ACCESS__MASK__SKX_UNC_IO_VTD_ACCESS__TLB_MISS = 0x2000ull, // VTd Access -- TLB miss
