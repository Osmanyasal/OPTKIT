...
// NON SAMPLING MACROS
#define OPTKIT_RAPL_ENERGY(block_name) \
...
#define OPTKIT_RAPL_ENERGY_REPEAT(block_name, count)                                                                                                                                                                             \
    optkit::energy::rapl::Profiler EXPAND_AND_CONCAT(var, __LINE__){{block_name, "cpu_energy", true, false, optkit::Query::create_folder, !optkit::Query::create_folder}, optkit::metrics::energy::cpu_metrics::all_metrics()}; \
    for (int32_t i = 0; i < count; i++)

#define OPTKIT_RAPL_ENERGY_REPEAT_READ_AND_STORE(block_name, count)                                                                                                                                                              \
    optkit::energy::rapl::Profiler EXPAND_AND_CONCAT(var, __LINE__){{block_name, "cpu_energy", true, false, optkit::Query::create_folder, !optkit::Query::create_folder}, optkit::metrics::energy::cpu_metrics::all_metrics()}; \
    for (int32_t i = 0; i < count; i++, EXPAND_AND_CONCAT(var, __LINE__).read_and_store())

// Macros with metric_builder parameter
#define OPTKIT_RAPL_ENERGY_WITH_METRICS(block_name, metric_builder) \
...
#define OPTKIT_RAPL_ENERGY_REPEAT_WITH_METRICS(block_name, count, metric_builder)                                                                                                           \
    optkit::energy::rapl::Profiler EXPAND_AND_CONCAT(var, __LINE__){{block_name, "cpu_energy", true, false, optkit::Query::create_folder, !optkit::Query::create_folder}, metric_builder}; \
    for (int32_t i = 0; i < count; i++)

#define OPTKIT_RAPL_ENERGY_REPEAT_READ_AND_STORE_WITH_METRICS(block_name, count, metric_builder)                                                                                            \
    optkit::energy::rapl::Profiler EXPAND_AND_CONCAT(var, __LINE__){{block_name, "cpu_energy", true, false, optkit::Query::create_folder, !optkit::Query::create_folder}, metric_builder}; \
    for (int32_t i = 0; i < count; i++, EXPAND_AND_CONCAT(var, __LINE__).read_and_store())

// SAMPLING MACROS
#define OPTKIT_RAPL_ENERGY_SAMPLING(block_name) \
...
#define OPTKIT_RAPL_ENERGY_REPEAT_SAMPLING(block_name, count)                                                                                                                                                                   \
    optkit::energy::rapl::Profiler EXPAND_AND_CONCAT(var, __LINE__){{block_name, "cpu_energy", true, true, optkit::Query::create_folder, !optkit::Query::create_folder}, optkit::metrics::energy::cpu_metrics::all_metrics()}; \
    for (int32_t i = 0; i < count; i++)

#define OPTKIT_RAPL_ENERGY_REPEAT_READ_AND_STORE_SAMPLING(block_name, count)                                                                                                                                                    \
    optkit::energy::rapl::Profiler EXPAND_AND_CONCAT(var, __LINE__){{block_name, "cpu_energy", true, true, optkit::Query::create_folder, !optkit::Query::create_folder}, optkit::metrics::energy::cpu_metrics::all_metrics()}; \
    for (int32_t i = 0; i < count; i++, EXPAND_AND_CONCAT(var, __LINE__).read_and_store())

// Macros with metric_builder parameter
#define OPTKIT_RAPL_ENERGY_WITH_METRICS_SAMPLING(block_name, metric_builder) \
...
#define OPTKIT_RAPL_ENERGY_REPEAT_WITH_METRICS_SAMPLING(block_name, count, metric_builder)                                                                                                 \
    optkit::energy::rapl::Profiler EXPAND_AND_CONCAT(var, __LINE__){{block_name, "cpu_energy", true, true, optkit::Query::create_folder, !optkit::Query::create_folder}, metric_builder}; \
    for (int32_t i = 0; i < count; i++)

#define OPTKIT_RAPL_ENERGY_REPEAT_READ_AND_STORE_WITH_METRICS_SAMPLING(block_name, count, metric_builder)                                                                                  \
    optkit::energy::rapl::Profiler EXPAND_AND_CONCAT(var, __LINE__){{block_name, "cpu_energy", true, true, optkit::Query::create_folder, !optkit::Query::create_folder}, metric_builder}; \
    for (int32_t i = 0; i < count; i++, EXPAND_AND_CONCAT(var, __LINE__).read_and_store())
