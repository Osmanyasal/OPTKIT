...
#undef OPTKIT_PDU_ENERGY
#undef OPTKIT_PDU_ENERGY_REPEAT
#undef OPTKIT_PDU_ENERGY_REPEAT_READ_AND_STORE
#undef OPTKIT_PDU_ENERGY_WITH_METRICS
#undef OPTKIT_PDU_ENERGY_REPEAT_WITH_METRICS
#undef OPTKIT_PDU_ENERGY_REPEAT_READ_AND_STORE_WITH_METRICS
#undef OPTKIT_PDU_ENERGY_SAMPLING
#undef OPTKIT_PDU_ENERGY_REPEAT_SAMPLING
#undef OPTKIT_PDU_ENERGY_REPEAT_READ_AND_STORE_SAMPLING
#undef OPTKIT_PDU_ENERGY_WITH_METRICS_SAMPLING
#undef OPTKIT_PDU_ENERGY_REPEAT_WITH_METRICS_SAMPLING
#undef OPTKIT_PDU_ENERGY_REPEAT_READ_AND_STORE_WITH_METRICS_SAMPLING
