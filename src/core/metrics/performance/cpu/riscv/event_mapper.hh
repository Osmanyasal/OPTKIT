...
namespace optkit::metrics::performance::cpu::riscv
{
    ...
    public:
        ...
        static std::vector<uint64_t> get(performance::cpu::riscv::NativeEvents event)
        {
    ...
    private:
        ...
        static const std::unordered_map<performance::cpu::CoreEvents, std::vector<uint64_t>> core_event_map;
        static const std::unordered_map<performance::cpu::riscv::NativeEvents, std::vector<uint64_t>> native_event_map;
    };
}
