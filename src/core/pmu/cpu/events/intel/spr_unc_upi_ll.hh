...
namespace optkit::intel::spr_unc_upi_ll{
	enum spr_unc_upi_ll : uint64_t {
		...
		UNC_UPI_DIRECT_ATTEMPTS__MASK__SPR_UNC_UPI_DIRECT_ATTEMPTS__D2C = 0x100ull, // D2C (experimental)
		UNC_UPI_DIRECT_ATTEMPTS__MASK__SPR_UNC_UPI_DIRECT_ATTEMPTS__D2K = 0x200ull, // D2K (experimental)
		UNC_UPI_FLOWQ_NO_VNA_CRD = 0x0018, // TBD
		UNC_UPI_FLOWQ_NO_VNA_CRD__MASK__SPR_UNC_UPI_FLOWQ_NO_VNA_CRD__AD_VNA_EQ0 = 0x100ull, // TBD (experimental)
		UNC_UPI_FLOWQ_NO_VNA_CRD__MASK__SPR_UNC_UPI_FLOWQ_NO_VNA_CRD__AD_VNA_EQ1 = 0x200ull, // TBD (experimental)
		UNC_UPI_FLOWQ_NO_VNA_CRD__MASK__SPR_UNC_UPI_FLOWQ_NO_VNA_CRD__AD_VNA_EQ2 = 0x400ull, // TBD (experimental)
		...
		UNC_UPI_FLOWQ_NO_VNA_CRD__MASK__SPR_UNC_UPI_FLOWQ_NO_VNA_CRD__BL_VNA_EQ0 = 0x800ull, // TBD (experimental)
		UNC_UPI_L1_POWER_CYCLES = 0x0021, // Cycles in L1
		UNC_UPI_M3_BYP_BLOCKED = 0x0014, // TBD
		UNC_UPI_M3_BYP_BLOCKED__MASK__SPR_UNC_UPI_M3_BYP_BLOCKED__BGF_CRD = 0x800ull, // TBD (experimental)
		UNC_UPI_M3_BYP_BLOCKED__MASK__SPR_UNC_UPI_M3_BYP_BLOCKED__FLOWQ_AD_VNA_LE2 = 0x100ull, // TBD (experimental)
		UNC_UPI_M3_BYP_BLOCKED__MASK__SPR_UNC_UPI_M3_BYP_BLOCKED__FLOWQ_AK_VNA_LE3 = 0x400ull, // TBD (experimental)
		UNC_UPI_M3_BYP_BLOCKED__MASK__SPR_UNC_UPI_M3_BYP_BLOCKED__FLOWQ_BL_VNA_EQ0 = 0x200ull, // TBD (experimental)
		...
		UNC_UPI_M3_RXQ_BLOCKED__MASK__SPR_UNC_UPI_M3_RXQ_BLOCKED__FLOWQ_AD_VNA_BTW_2_THRESH = 0x200ull, // TBD (experimental)
		UNC_UPI_M3_RXQ_BLOCKED__MASK__SPR_UNC_UPI_M3_RXQ_BLOCKED__FLOWQ_AD_VNA_LE2 = 0x100ull, // TBD (experimental)
		UNC_UPI_M3_RXQ_BLOCKED__MASK__SPR_UNC_UPI_M3_RXQ_BLOCKED__FLOWQ_AK_VNA_LE3 = 0x1000ull, // TBD (experimental)
		UNC_UPI_M3_RXQ_BLOCKED__MASK__SPR_UNC_UPI_M3_RXQ_BLOCKED__FLOWQ_BL_VNA_BTW_0_THRESH = 0x800ull, // TBD (experimental)
		UNC_UPI_M3_RXQ_BLOCKED__MASK__SPR_UNC_UPI_M3_RXQ_BLOCKED__FLOWQ_BL_VNA_EQ0 = 0x400ull, // TBD (experimental)
		...
		UNC_UPI_REQ_SLOT2_FROM_M3__MASK__SPR_UNC_UPI_REQ_SLOT2_FROM_M3__ACK = 0x800ull, // TBD (experimental)
		UNC_UPI_REQ_SLOT2_FROM_M3__MASK__SPR_UNC_UPI_REQ_SLOT2_FROM_M3__VN0 = 0x200ull, // TBD (experimental)
		UNC_UPI_REQ_SLOT2_FROM_M3__MASK__SPR_UNC_UPI_REQ_SLOT2_FROM_M3__VN1 = 0x400ull, // TBD (experimental)
		UNC_UPI_REQ_SLOT2_FROM_M3__MASK__SPR_UNC_UPI_REQ_SLOT2_FROM_M3__VNA = 0x100ull, // TBD (experimental)
		...
		UNC_UPI_RxL_ANY_FLITS__MASK__SPR_UNC_UPI_TXL_ANY_FLITS__DATA = 0x800ull, // TBD (experimental)
		...
		UNC_UPI_RxL_ANY_FLITS__MASK__SPR_UNC_UPI_TXL_ANY_FLITS__SLOT0 = 0x100ull, // TBD (experimental)
		UNC_UPI_RxL_ANY_FLITS__MASK__SPR_UNC_UPI_TXL_ANY_FLITS__SLOT1 = 0x200ull, // TBD (experimental)
		UNC_UPI_RxL_ANY_FLITS__MASK__SPR_UNC_UPI_TXL_ANY_FLITS__SLOT2 = 0x400ull, // TBD (experimental)
		UNC_UPI_RxL_BYPASSED = 0x0031, // RxQ Flit Buffer Bypassed
		UNC_UPI_RxL_BYPASSED__MASK__SPR_UNC_UPI_RXL_INSERTS__SLOT0 = 0x100ull, // Slot 0 (experimental)
		UNC_UPI_RxL_BYPASSED__MASK__SPR_UNC_UPI_RXL_INSERTS__SLOT1 = 0x200ull, // Slot 1 (experimental)
		UNC_UPI_RxL_BYPASSED__MASK__SPR_UNC_UPI_RXL_INSERTS__SLOT2 = 0x400ull, // Slot 2 (experimental)
		...
		UNC_UPI_RxL_FLITS__MASK__SPR_UNC_UPI_RXL_FLITS__ALL_DATA = 0xf00ull, // All Data
		UNC_UPI_RxL_FLITS__MASK__SPR_UNC_UPI_RXL_FLITS__ALL_NULL = 0x2700ull, // Null FLITs received from any slot
		UNC_UPI_RxL_FLITS__MASK__SPR_UNC_UPI_RXL_FLITS__DATA = 0x800ull, // Data (experimental)
		...
		UNC_UPI_RxL_FLITS__MASK__SPR_UNC_UPI_RXL_FLITS__SLOT0 = 0x100ull, // Slot 0 (experimental)
		UNC_UPI_RxL_FLITS__MASK__SPR_UNC_UPI_RXL_FLITS__SLOT1 = 0x200ull, // Slot 1 (experimental)
		UNC_UPI_RxL_FLITS__MASK__SPR_UNC_UPI_RXL_FLITS__SLOT2 = 0x400ull, // Slot 2 (experimental)
		UNC_UPI_RxL_INSERTS = 0x0030, // Receive Flit Buffer Allocations
		UNC_UPI_RxL_INSERTS__MASK__SPR_UNC_UPI_RXL_INSERTS__SLOT0 = 0x100ull, // Slot 0 (experimental)
		UNC_UPI_RxL_INSERTS__MASK__SPR_UNC_UPI_RXL_INSERTS__SLOT1 = 0x200ull, // Slot 1 (experimental)
		UNC_UPI_RxL_INSERTS__MASK__SPR_UNC_UPI_RXL_INSERTS__SLOT2 = 0x400ull, // Slot 2 (experimental)
		UNC_UPI_RxL_OCCUPANCY = 0x0032, // RxQ Occupancy
		UNC_UPI_RxL_OCCUPANCY__MASK__SPR_UNC_UPI_RXL_OCCUPANCY__SLOT0 = 0x100ull, // Slot 0 (experimental)
		UNC_UPI_RxL_OCCUPANCY__MASK__SPR_UNC_UPI_RXL_OCCUPANCY__SLOT1 = 0x200ull, // Slot 1 (experimental)
		UNC_UPI_RxL_OCCUPANCY__MASK__SPR_UNC_UPI_RXL_OCCUPANCY__SLOT2 = 0x400ull, // Slot 2 (experimental)
		UNC_UPI_RxL_SLOT_BYPASS = 0x0033, // TBD
		UNC_UPI_RxL_SLOT_BYPASS__MASK__SPR_UNC_UPI_RXL_SLOT_BYPASS__S0_RXQ1 = 0x100ull, // TBD (experimental)
		UNC_UPI_RxL_SLOT_BYPASS__MASK__SPR_UNC_UPI_RXL_SLOT_BYPASS__S0_RXQ2 = 0x200ull, // TBD (experimental)
		UNC_UPI_RxL_SLOT_BYPASS__MASK__SPR_UNC_UPI_RXL_SLOT_BYPASS__S1_RXQ0 = 0x400ull, // TBD (experimental)
		UNC_UPI_RxL_SLOT_BYPASS__MASK__SPR_UNC_UPI_RXL_SLOT_BYPASS__S1_RXQ2 = 0x800ull, // TBD (experimental)
		...
		UNC_UPI_TxL0P_CLK_ACTIVE__MASK__SPR_UNC_UPI_TXL0P_CLK_ACTIVE__CFG_CTL = 0x100ull, // TBD (experimental)
		...
		UNC_UPI_TxL0P_CLK_ACTIVE__MASK__SPR_UNC_UPI_TXL0P_CLK_ACTIVE__RXQ = 0x200ull, // TBD (experimental)
		UNC_UPI_TxL0P_CLK_ACTIVE__MASK__SPR_UNC_UPI_TXL0P_CLK_ACTIVE__RXQ_BYPASS = 0x400ull, // TBD (experimental)
		UNC_UPI_TxL0P_CLK_ACTIVE__MASK__SPR_UNC_UPI_TXL0P_CLK_ACTIVE__RXQ_CRED = 0x800ull, // TBD (experimental)
		...
		UNC_UPI_TxL_ANY_FLITS__MASK__SPR_UNC_UPI_TXL_ANY_FLITS__DATA = 0x800ull, // TBD (experimental)
		...
		UNC_UPI_TxL_ANY_FLITS__MASK__SPR_UNC_UPI_TXL_ANY_FLITS__SLOT0 = 0x100ull, // TBD (experimental)
		UNC_UPI_TxL_ANY_FLITS__MASK__SPR_UNC_UPI_TXL_ANY_FLITS__SLOT1 = 0x200ull, // TBD (experimental)
		UNC_UPI_TxL_ANY_FLITS__MASK__SPR_UNC_UPI_TXL_ANY_FLITS__SLOT2 = 0x400ull, // TBD (experimental)
		UNC_UPI_TxL_BYPASSED = 0x0041, // Transmitted Flit Buffer Bypassed (experimental)
		UNC_UPI_TxL_FLITS = 0x0002, // Flits transmitted
		UNC_UPI_TxL_FLITS__MASK__SPR_UNC_UPI_TXL_FLITS__ALL_DATA = 0xf00ull, // All Data
		...
		UNC_UPI_TxL_FLITS__MASK__SPR_UNC_UPI_TXL_FLITS__DATA = 0x800ull, // Data (experimental)
		...
		UNC_UPI_TxL_FLITS__MASK__SPR_UNC_UPI_TXL_FLITS__SLOT0 = 0x100ull, // Slot 0 (experimental)
		UNC_UPI_TxL_FLITS__MASK__SPR_UNC_UPI_TXL_FLITS__SLOT1 = 0x200ull, // Slot 1 (experimental)
		UNC_UPI_TxL_FLITS__MASK__SPR_UNC_UPI_TXL_FLITS__SLOT2 = 0x400ull, // Slot 2 (experimental)
