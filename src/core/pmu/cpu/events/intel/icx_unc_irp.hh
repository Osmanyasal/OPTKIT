...
namespace optkit::intel::icx_unc_irp{
	enum icx_unc_irp : uint64_t {
		...
		UNC_I_CACHE_TOTAL_OCCUPANCY__MASK__ICX_UNC_I_CACHE_TOTAL_OCCUPANCY__ANY = 0x100ull, // Any Source (experimental)
		UNC_I_CACHE_TOTAL_OCCUPANCY__MASK__ICX_UNC_I_CACHE_TOTAL_OCCUPANCY__IV_Q = 0x200ull, // Snoops (experimental)
		UNC_I_CACHE_TOTAL_OCCUPANCY__MASK__ICX_UNC_I_CACHE_TOTAL_OCCUPANCY__MEM = 0x400ull, // TBD
		...
		UNC_I_COHERENT_OPS__MASK__ICX_UNC_I_COHERENT_OPS__RFO = 0x800ull, // TBD (experimental)
		...
		UNC_I_IRP_ALL__MASK__ICX_UNC_I_IRP_ALL__EVICTS = 0x400ull, // All Inserts Outbound (BL
		UNC_I_IRP_ALL__MASK__ICX_UNC_I_IRP_ALL__INBOUND_INSERTS = 0x100ull, // All Inserts Inbound (p2p + faf + cset)
		UNC_I_IRP_ALL__MASK__ICX_UNC_I_IRP_ALL__OUTBOUND_INSERTS = 0x200ull, // All Inserts Outbound (BL
		...
		UNC_I_MISC0__MASK__ICX_UNC_I_MISC0__2ND_RD_INSERT = 0x400ull, // Cache Inserts of Read Transactions as Secondary (experimental)
		UNC_I_MISC0__MASK__ICX_UNC_I_MISC0__2ND_WR_INSERT = 0x800ull, // Cache Inserts of Write Transactions as Secondary (experimental)
		UNC_I_MISC0__MASK__ICX_UNC_I_MISC0__FAST_REJ = 0x200ull, // Fastpath Rejects (experimental)
		UNC_I_MISC0__MASK__ICX_UNC_I_MISC0__FAST_REQ = 0x100ull, // Fastpath Requests (experimental)
		...
		UNC_I_MISC1__MASK__ICX_UNC_I_MISC1__SLOW_E = 0x400ull, // Slow Transfer of E Line (experimental)
		UNC_I_MISC1__MASK__ICX_UNC_I_MISC1__SLOW_I = 0x100ull, // Slow Transfer of I Line (experimental)
		UNC_I_MISC1__MASK__ICX_UNC_I_MISC1__SLOW_M = 0x800ull, // Slow Transfer of M Line (experimental)
		UNC_I_MISC1__MASK__ICX_UNC_I_MISC1__SLOW_S = 0x200ull, // Slow Transfer of S Line (experimental)
		...
		UNC_I_P2P_TRANSACTIONS__MASK__ICX_UNC_I_P2P_TRANSACTIONS__CMPL = 0x800ull, // P2P completions (experimental)
		...
		UNC_I_P2P_TRANSACTIONS__MASK__ICX_UNC_I_P2P_TRANSACTIONS__MSG = 0x400ull, // P2P Message (experimental)
		UNC_I_P2P_TRANSACTIONS__MASK__ICX_UNC_I_P2P_TRANSACTIONS__RD = 0x100ull, // P2P reads (experimental)
		...
		UNC_I_P2P_TRANSACTIONS__MASK__ICX_UNC_I_P2P_TRANSACTIONS__WR = 0x200ull, // P2P Writes (experimental)
		...
		UNC_I_SNOOP_RESP__MASK__ICX_UNC_I_SNOOP_RESP__HIT_ES = 0x400ull, // Hit E or S (experimental)
		UNC_I_SNOOP_RESP__MASK__ICX_UNC_I_SNOOP_RESP__HIT_I = 0x200ull, // Hit I (experimental)
		UNC_I_SNOOP_RESP__MASK__ICX_UNC_I_SNOOP_RESP__HIT_M = 0x800ull, // Hit M (experimental)
		UNC_I_SNOOP_RESP__MASK__ICX_UNC_I_SNOOP_RESP__MISS = 0x100ull, // Miss (experimental)
		...
		UNC_I_TRANSACTIONS__MASK__ICX_UNC_I_TRANSACTIONS__WRITES = 0x200ull, // Writes (experimental)
		UNC_I_TRANSACTIONS__MASK__ICX_UNC_I_TRANSACTIONS__WR_PREF = 0x800ull, // TBD
