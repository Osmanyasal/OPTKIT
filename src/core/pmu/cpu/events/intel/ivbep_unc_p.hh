...
namespace optkit::intel::ivbep_unc_p{
	enum ivbep_unc_p : uint64_t {
		...
		UNC_P_POWER_STATE_OCCUPANCY__MASK__IVBEP_UNC_P_POWER_STATE_OCCUPANCY__CORES_C0 = 0x4000ull, // Counts number of cores in C0
		UNC_P_POWER_STATE_OCCUPANCY__MASK__IVBEP_UNC_P_POWER_STATE_OCCUPANCY__CORES_C3 = 0x8000ull, // Counts number of cores in C3
		UNC_P_POWER_STATE_OCCUPANCY__MASK__IVBEP_UNC_P_POWER_STATE_OCCUPANCY__CORES_C6 = 0xc000ull, // Counts number of cores in C6
