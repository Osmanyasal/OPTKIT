...
namespace optkit::intel::p6{
	enum p6 : uint64_t {
		...
		L2_IFETCH__MASK__P6_L2_IFETCH__I = 0x100ull, // Invalid state
		L2_IFETCH__MASK__P6_L2_IFETCH__S = 0x200ull, // Shared state
		L2_IFETCH__MASK__P6_L2_IFETCH__E = 0x400ull, // Exclusive state
		L2_IFETCH__MASK__P6_L2_IFETCH__M = 0x800ull, // Modified state
		L2_ST = 0x2a, // Number of L2 data stores. This event indicates that a normal
		L2_ST__MASK__P6_L2_IFETCH__I = 0x100ull, // Invalid state
		L2_ST__MASK__P6_L2_IFETCH__S = 0x200ull, // Shared state
		L2_ST__MASK__P6_L2_IFETCH__E = 0x400ull, // Exclusive state
		L2_ST__MASK__P6_L2_IFETCH__M = 0x800ull, // Modified state
		L2_M_LINES_INM = 0x25, // Number of modified lines allocated in the L2
		L2_RQSTS = 0x2e, // Total number of L2 requests
		L2_RQSTS__MASK__P6_L2_IFETCH__I = 0x100ull, // Invalid state
		L2_RQSTS__MASK__P6_L2_IFETCH__S = 0x200ull, // Shared state
		L2_RQSTS__MASK__P6_L2_IFETCH__E = 0x400ull, // Exclusive state
		L2_RQSTS__MASK__P6_L2_IFETCH__M = 0x800ull, // Modified state
		...
		BUS_DRDY_CLOCKS__MASK__P6_BUS_DRDY_CLOCKS__SELF = 0x0ull, // Clocks when processor is driving bus
		BUS_DRDY_CLOCKS__MASK__P6_BUS_DRDY_CLOCKS__ANY = 0x2000ull, // Clocks when any agent is driving bus
		BUS_LOCK_CLOCKS = 0x63, // Number of clocks during which LOCK# is asserted on the external system bus
		BUS_LOCK_CLOCKS__MASK__P6_BUS_DRDY_CLOCKS__SELF = 0x0ull, // Clocks when processor is driving bus
		BUS_LOCK_CLOCKS__MASK__P6_BUS_DRDY_CLOCKS__ANY = 0x2000ull, // Clocks when any agent is driving bus
		...
		BUS_TRANS_BRD__MASK__P6_BUS_DRDY_CLOCKS__SELF = 0x0ull, // Clocks when processor is driving bus
		BUS_TRANS_BRD__MASK__P6_BUS_DRDY_CLOCKS__ANY = 0x2000ull, // Clocks when any agent is driving bus
		BUS_TRANS_RFO = 0x66, // Number of completed read for ownership transactions
		BUS_TRANS_RFO__MASK__P6_BUS_DRDY_CLOCKS__SELF = 0x0ull, // Clocks when processor is driving bus
		BUS_TRANS_RFO__MASK__P6_BUS_DRDY_CLOCKS__ANY = 0x2000ull, // Clocks when any agent is driving bus
		BUS_TRANS_WB = 0x67, // Number of completed write back transactions
		BUS_TRANS_WB__MASK__P6_BUS_DRDY_CLOCKS__SELF = 0x0ull, // Clocks when processor is driving bus
		BUS_TRANS_WB__MASK__P6_BUS_DRDY_CLOCKS__ANY = 0x2000ull, // Clocks when any agent is driving bus
		BUS_TRAN_IFETCH = 0x68, // Number of completed instruction fetch transactions
		BUS_TRAN_IFETCH__MASK__P6_BUS_DRDY_CLOCKS__SELF = 0x0ull, // Clocks when processor is driving bus
		BUS_TRAN_IFETCH__MASK__P6_BUS_DRDY_CLOCKS__ANY = 0x2000ull, // Clocks when any agent is driving bus
		BUS_TRAN_INVAL = 0x69, // Number of completed invalidate transactions
		BUS_TRAN_INVAL__MASK__P6_BUS_DRDY_CLOCKS__SELF = 0x0ull, // Clocks when processor is driving bus
		BUS_TRAN_INVAL__MASK__P6_BUS_DRDY_CLOCKS__ANY = 0x2000ull, // Clocks when any agent is driving bus
		BUS_TRAN_PWR = 0x6a, // Number of completed partial write transactions
		BUS_TRAN_PWR__MASK__P6_BUS_DRDY_CLOCKS__SELF = 0x0ull, // Clocks when processor is driving bus
		BUS_TRAN_PWR__MASK__P6_BUS_DRDY_CLOCKS__ANY = 0x2000ull, // Clocks when any agent is driving bus
		BUS_TRANS_P = 0x6b, // Number of completed partial transactions
		BUS_TRANS_P__MASK__P6_BUS_DRDY_CLOCKS__SELF = 0x0ull, // Clocks when processor is driving bus
		BUS_TRANS_P__MASK__P6_BUS_DRDY_CLOCKS__ANY = 0x2000ull, // Clocks when any agent is driving bus
		BUS_TRANS_IO = 0x6c, // Number of completed I/O transactions
		BUS_TRANS_IO__MASK__P6_BUS_DRDY_CLOCKS__SELF = 0x0ull, // Clocks when processor is driving bus
		BUS_TRANS_IO__MASK__P6_BUS_DRDY_CLOCKS__ANY = 0x2000ull, // Clocks when any agent is driving bus
		BUS_TRAN_DEF = 0x6d, // Number of completed deferred transactions
		BUS_TRAN_DEF__MASK__P6_BUS_DRDY_CLOCKS__SELF = 0x0ull, // Clocks when processor is driving bus
		BUS_TRAN_DEF__MASK__P6_BUS_DRDY_CLOCKS__ANY = 0x2000ull, // Clocks when any agent is driving bus
		BUS_TRAN_BURST = 0x6e, // Number of completed burst transactions
		BUS_TRAN_BURST__MASK__P6_BUS_DRDY_CLOCKS__SELF = 0x0ull, // Clocks when processor is driving bus
		BUS_TRAN_BURST__MASK__P6_BUS_DRDY_CLOCKS__ANY = 0x2000ull, // Clocks when any agent is driving bus
		...
		BUS_TRAN_ANY__MASK__P6_BUS_DRDY_CLOCKS__SELF = 0x0ull, // Clocks when processor is driving bus
		BUS_TRAN_ANY__MASK__P6_BUS_DRDY_CLOCKS__ANY = 0x2000ull, // Clocks when any agent is driving bus
		BUS_TRAN_MEM = 0x6f, // Number of completed memory transactions
		BUS_TRAN_MEM__MASK__P6_BUS_DRDY_CLOCKS__SELF = 0x0ull, // Clocks when processor is driving bus
		BUS_TRAN_MEM__MASK__P6_BUS_DRDY_CLOCKS__ANY = 0x2000ull, // Clocks when any agent is driving bus
		...
		MMX_INSTR_TYPE_EXEC__MASK__P6_MMX_INSTR_TYPE_EXEC__MUL = 0x100ull, // MMX packed multiply instructions executed
		MMX_INSTR_TYPE_EXEC__MASK__P6_MMX_INSTR_TYPE_EXEC__SHIFT = 0x200ull, // MMX packed shift instructions executed
		MMX_INSTR_TYPE_EXEC__MASK__P6_MMX_INSTR_TYPE_EXEC__PACK = 0x400ull, // MMX pack operation instructions executed
		MMX_INSTR_TYPE_EXEC__MASK__P6_MMX_INSTR_TYPE_EXEC__UNPACK = 0x800ull, // MMX unpack operation instructions executed
		MMX_INSTR_TYPE_EXEC__MASK__P6_MMX_INSTR_TYPE_EXEC__LOGICAL = 0x1000ull, // MMX packed logical instructions executed
		MMX_INSTR_TYPE_EXEC__MASK__P6_MMX_INSTR_TYPE_EXEC__ARITH = 0x2000ull, // MMX packed arithmetic instructions executed
		FP_MMX_TRANS = 0xcc, // Number of MMX transitions
		FP_MMX_TRANS__MASK__P6_FP_MMX_TRANS__TO_FP = 0x0ull, // From MMX instructions to floating-point instructions
		FP_MMX_TRANS__MASK__P6_FP_MMX_TRANS__TO_MMX = 0x100ull, // From floating-point instructions to MMX instructions
		MMX_ASSIST = 0xcd, // Number of MMX micro-ops executed
		SEG_RENAME_STALLS = 0xd4, // Number of Segment Register Renaming Stalls
		SEG_RENAME_STALLS__MASK__P6_SEG_RENAME_STALLS__ES = 0x100ull, // Segment register ES
		SEG_RENAME_STALLS__MASK__P6_SEG_RENAME_STALLS__DS = 0x200ull, // Segment register DS
		SEG_RENAME_STALLS__MASK__P6_SEG_RENAME_STALLS__FS = 0x400ull, // Segment register FS
		SEG_RENAME_STALLS__MASK__P6_SEG_RENAME_STALLS__GS = 0x800ull, // Segment register GS
		SEG_REG_RENAMES = 0xd5, // Number of Segment Register Renames
		SEG_REG_RENAMES__MASK__P6_SEG_RENAME_STALLS__ES = 0x100ull, // Segment register ES
		SEG_REG_RENAMES__MASK__P6_SEG_RENAME_STALLS__DS = 0x200ull, // Segment register DS
		SEG_REG_RENAMES__MASK__P6_SEG_RENAME_STALLS__FS = 0x400ull, // Segment register FS
		SEG_REG_RENAMES__MASK__P6_SEG_RENAME_STALLS__GS = 0x800ull, // Segment register GS
		...
		EMON_KNI_PREF_DISPATCHED__MASK__P6_EMON_KNI_PREF_DISPATCHED__NTA = 0x0ull, // Prefetch NTA
		EMON_KNI_PREF_DISPATCHED__MASK__P6_EMON_KNI_PREF_DISPATCHED__T1 = 0x100ull, // Prefetch T1
		EMON_KNI_PREF_DISPATCHED__MASK__P6_EMON_KNI_PREF_DISPATCHED__T2 = 0x200ull, // Prefetch T2
		EMON_KNI_PREF_DISPATCHED__MASK__P6_EMON_KNI_PREF_DISPATCHED__WEAK = 0x300ull, // Weakly ordered stores
		EMON_KNI_PREF_MISS = 0x4b, // Number of prefetch/weakly-ordered instructions that miss all caches. Pentium III and later
		EMON_KNI_PREF_MISS__MASK__P6_EMON_KNI_PREF_DISPATCHED__NTA = 0x0ull, // Prefetch NTA
		EMON_KNI_PREF_MISS__MASK__P6_EMON_KNI_PREF_DISPATCHED__T1 = 0x100ull, // Prefetch T1
		EMON_KNI_PREF_MISS__MASK__P6_EMON_KNI_PREF_DISPATCHED__T2 = 0x200ull, // Prefetch T2
		EMON_KNI_PREF_MISS__MASK__P6_EMON_KNI_PREF_DISPATCHED__WEAK = 0x300ull, // Weakly ordered stores
		L2_LD = 0x29, // Number of L2 data loads. This event indicates that a normal
		L2_LD__MASK__P6_L2_IFETCH__I = 0x100ull, // Invalid state
		L2_LD__MASK__P6_L2_IFETCH__S = 0x200ull, // Shared state
		L2_LD__MASK__P6_L2_IFETCH__E = 0x400ull, // Exclusive state
		L2_LD__MASK__P6_L2_IFETCH__M = 0x800ull, // Modified state
		...
		EMON_KNI_INST_RETIRED__MASK__P6_EMON_KNI_INST_RETIRED__PACKED_SCALAR = 0x0ull, // Packed and scalar instructions
		EMON_KNI_INST_RETIRED__MASK__P6_EMON_KNI_INST_RETIRED__SCALAR = 0x100ull, // Scalar only
		EMON_KNI_COMP_INST_RET = 0xd9, // Number of SSE computation instructions retired. Pentium III and later
		EMON_KNI_COMP_INST_RET__MASK__P6_EMON_KNI_INST_RETIRED__PACKED_SCALAR = 0x0ull, // Packed and scalar instructions
		EMON_KNI_COMP_INST_RET__MASK__P6_EMON_KNI_INST_RETIRED__SCALAR = 0x100ull, // Scalar only
