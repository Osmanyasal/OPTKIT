...
namespace optkit::energy::hwmon
{
    ...
    private:
        virtual void on_sample_stored(const std::pair<double, std::unordered_map<int32_t, std::unordered_map<HwmonDomain, double>>> &sample) override;
        ...
        std::unordered_map<std::string, std::unordered_map<int32_t, std::unordered_map<HwmonDomain, double>>> compacted_event_counts;
