...
namespace optkit::core::pmu::cpu::perf
{
    ...
    std::ostream &operator<<(std::ostream &out, const pfm_event_info_t &event_info)
    {
        ...
        out << "| " << std::setw(16) << "pmu:" << std::setw(_10_plus_event_info_desc_size - 6) << optkit::core::pmu::cpu::perf::pmu_names[(std::size_t)event_info.pmu] << std::setw(6) << "(" + std::to_string(event_info.pmu) + ")"
            << " |\n";
        out << "| " << std::setw(16) << "dtype:" << std::setw(_10_plus_event_info_desc_size - 6) << optkit::core::pmu::cpu::perf::pmu_types[(std::size_t)event_info.dtype] << std::setw(6) << "(" + std::to_string(event_info.pmu) + ")"
            << " |\n";
    ...
    std::ostream &operator<<(std::ostream &out, const pfm_pmu_info_t &pmu_info)
    {
        ...
        // Print the rest of the members with appropriate setw values
        out << "| " << std::setw(16) << "pmu:" << std::setw(24) << optkit::core::pmu::cpu::perf::pmu_names[(std::size_t)pmu_info.pmu] << std::setw(6) << "(" + std::to_string(pmu_info.pmu) + ")"
            << " |\n";
        out << "| " << std::setw(16) << "type:" << std::setw(24) << optkit::core::pmu::cpu::perf::pmu_types[(std::size_t)pmu_info.type] << std::setw(6) << "(" + std::to_string(pmu_info.pmu) + ")"
            << " |\n";
