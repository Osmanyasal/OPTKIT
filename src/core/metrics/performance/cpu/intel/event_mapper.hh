...
namespace optkit::metrics::performance::intel
{
    ...
    public:
        ...
        static std::vector<uint64_t> get(performance::intel::NativeEvents event)
        {
    ...
    private:
        ...
        static const std::unordered_map<performance::intel::NativeEvents, std::vector<uint64_t>> native_event_map; // coreEvent - even nums to monitor.
    };
};
