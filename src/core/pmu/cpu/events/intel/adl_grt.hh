...
namespace optkit::intel::adl_grt{
	enum adl_grt : uint64_t {
		...
		BACLEARS__MASK__ADL_GRT_BACLEARS__ANY = 0x100ull, // Counts the total number of BACLEARS due to all branch types including conditional and unconditional jumps
		BR_INST_RETIRED = 0x00c4, // Counts the total number of branch instructions retired for all branch types.
		BR_INST_RETIRED__MASK__ADL_GRT_BR_INST_RETIRED__ALL_BRANCHES = 0x0ull, // Counts the total number of branch instructions retired for all branch types.
		...
		BR_MISP_RETIRED__MASK__ADL_GRT_BR_MISP_RETIRED__ALL_BRANCHES = 0x0ull, // Counts the total number of mispredicted branch instructions retired for all branch types.
		...
		CPU_CLK_UNHALTED__MASK__ADL_GRT_CPU_CLK_UNHALTED__CORE = 0x200ull, // Counts the number of unhalted core clock cycles. (Fixed event)
		CPU_CLK_UNHALTED__MASK__ADL_GRT_CPU_CLK_UNHALTED__CORE_P = 0x0ull, // Counts the number of unhalted core clock cycles.
		CPU_CLK_UNHALTED__MASK__ADL_GRT_CPU_CLK_UNHALTED__REF_TSC = 0x300ull, // Counts the number of unhalted reference clock cycles at TSC frequency. (Fixed event)
		CPU_CLK_UNHALTED__MASK__ADL_GRT_CPU_CLK_UNHALTED__REF_TSC_P = 0x100ull, // Counts the number of unhalted reference clock cycles at TSC frequency.
		CPU_CLK_UNHALTED__MASK__ADL_GRT_CPU_CLK_UNHALTED__THREAD = 0x200ull, // Counts the number of unhalted core clock cycles. (Fixed event)
		CPU_CLK_UNHALTED__MASK__ADL_GRT_CPU_CLK_UNHALTED__THREAD_P = 0x0ull, // Counts the number of unhalted core clock cycles.
		DTLB_LOAD_MISSES = 0x0008, // Counts the number of page walks completed due to load DTLB misses to any page size.
		DTLB_LOAD_MISSES__MASK__ADL_GRT_DTLB_LOAD_MISSES__WALK_COMPLETED = 0xe00ull, // Counts the number of page walks completed due to load DTLB misses to any page size.
		DTLB_STORE_MISSES = 0x0049, // Counts the number of page walks completed due to store DTLB misses to any page size.
		DTLB_STORE_MISSES__MASK__ADL_GRT_DTLB_STORE_MISSES__WALK_COMPLETED = 0xe00ull, // Counts the number of page walks completed due to store DTLB misses to any page size.
		ICACHE = 0x0080, // Counts the number of instruction cache misses.
		ICACHE__MASK__ADL_GRT_ICACHE__ACCESSES = 0x300ull, // Counts the number of requests to the instruction cache for one or more bytes of a cache line.
		ICACHE__MASK__ADL_GRT_ICACHE__MISSES = 0x200ull, // Counts the number of instruction cache misses.
		INST_RETIRED = 0x00c0, // Counts the total number of instructions retired. (Fixed event)
		INST_RETIRED__MASK__ADL_GRT_INST_RETIRED__ANY = 0x100ull, // Counts the total number of instructions retired. (Fixed event)
		INST_RETIRED__MASK__ADL_GRT_INST_RETIRED__ANY_P = 0x0ull, // Counts the total number of instructions retired.
		...
		ITLB_MISSES__MASK__ADL_GRT_ITLB_MISSES__MISS_CAUSED_WALK = 0x100ull, // Counts the number of page walks initiated by a instruction fetch that missed the first and second level TLBs.
		...
		ITLB_MISSES__MASK__ADL_GRT_ITLB_MISSES__WALK_COMPLETED = 0xe00ull, // Counts the number of page walks completed due to instruction fetch misses to any page size.
		LBR_INSERTS = 0x00e4, // This event is deprecated. [This event is alias to MISC_RETIRED.LBR_INSERTS]
		LBR_INSERTS__MASK__ADL_GRT_LBR_INSERTS__ANY = 0x100ull, // This event is deprecated. [This event is alias to MISC_RETIRED.LBR_INSERTS]
		...
		LD_BLOCKS__MASK__ADL_GRT_LD_BLOCKS__4K_ALIAS = 0x400ull, // This event is deprecated. Refer to new event LD_BLOCKS.ADDRESS_ALIAS
		LD_BLOCKS__MASK__ADL_GRT_LD_BLOCKS__ADDRESS_ALIAS = 0x400ull, // Counts the number of retired loads that are blocked because it initially appears to be store forward blocked
		LD_BLOCKS__MASK__ADL_GRT_LD_BLOCKS__DATA_UNKNOWN = 0x100ull, // Counts the number of retired loads that are blocked because its address exactly matches an older store whose data is not ready.
		...
		MACHINE_CLEARS__MASK__ADL_GRT_MACHINE_CLEARS__DISAMBIGUATION = 0x800ull, // Counts the number of machine clears due to memory ordering in which an internal load passes an older store within the same CPU.
		MACHINE_CLEARS__MASK__ADL_GRT_MACHINE_CLEARS__FP_ASSIST = 0x400ull, // Counts the number of floating point operations retired that required microcode assist.
		MACHINE_CLEARS__MASK__ADL_GRT_MACHINE_CLEARS__MEMORY_ORDERING = 0x200ull, // Counts the number of machine clears due to memory ordering caused by a snoop from an external agent. Does not count internally generated machine clears such as those due to memory disambiguation.
		...
		MACHINE_CLEARS__MASK__ADL_GRT_MACHINE_CLEARS__SMC = 0x100ull, // Counts the number of machine clears due to program modifying data (self modifying code) within 1K of a recently fetched code page.
		...
		MEM_BOUND_STALLS__MASK__ADL_GRT_MEM_BOUND_STALLS__IFETCH_L2_HIT = 0x800ull, // Counts the number of cycles the core is stalled due to an instruction cache or TLB miss which hit in the L2 cache.
		...
		MEM_BOUND_STALLS__MASK__ADL_GRT_MEM_BOUND_STALLS__LOAD = 0x700ull, // Counts the number of cycles the core is stalled due to a demand load miss which hit in the L2
		MEM_BOUND_STALLS__MASK__ADL_GRT_MEM_BOUND_STALLS__LOAD_DRAM_HIT = 0x400ull, // Counts the number of cycles the core is stalled due to a demand load miss which hit in DRAM or MMIO (Non-DRAM).
		MEM_BOUND_STALLS__MASK__ADL_GRT_MEM_BOUND_STALLS__LOAD_L2_HIT = 0x100ull, // Counts the number of cycles the core is stalled due to a demand load which hit in the L2 cache.
		MEM_BOUND_STALLS__MASK__ADL_GRT_MEM_BOUND_STALLS__LOAD_LLC_HIT = 0x200ull, // Counts the number of cycles the core is stalled due to a demand load which hit in the LLC or other core with HITE/F/M.
		...
		MEM_LOAD_UOPS_RETIRED__MASK__ADL_GRT_MEM_LOAD_UOPS_RETIRED__L2_HIT = 0x200ull, // Counts the number of load uops retired that hit in the L2 cache.
		MEM_LOAD_UOPS_RETIRED__MASK__ADL_GRT_MEM_LOAD_UOPS_RETIRED__L3_HIT = 0x400ull, // Counts the number of load uops retired that hit in the L3 cache.
		MEM_SCHEDULER_BLOCK = 0x0004, // Counts the number of cycles that uops are blocked due to a store buffer full condition.
		MEM_SCHEDULER_BLOCK__MASK__ADL_GRT_MEM_SCHEDULER_BLOCK__ALL = 0x700ull, // load buffer
		MEM_SCHEDULER_BLOCK__MASK__ADL_GRT_MEM_SCHEDULER_BLOCK__LD_BUF = 0x200ull, // Counts the number of cycles that uops are blocked due to a load buffer full condition.
		MEM_SCHEDULER_BLOCK__MASK__ADL_GRT_MEM_SCHEDULER_BLOCK__RSV = 0x400ull, // Counts the number of cycles that uops are blocked due to an RSV full condition.
		MEM_SCHEDULER_BLOCK__MASK__ADL_GRT_MEM_SCHEDULER_BLOCK__ST_BUF = 0x100ull, // Counts the number of cycles that uops are blocked due to a store buffer full condition.
		...
		MEM_UOPS_RETIRED__MASK__ADL_GRT_MEM_UOPS_RETIRED__LOAD_LATENCY_GT_4 = 0x400ull, // Counts the number of tagged loads with an instruction latency that exceeds or equals the threshold of 4 cycles as defined in MEC_CR_PEBS_LD_LAT_THRESHOLD (3F6H). Only counts with PEBS enabled.
		...
		MEM_UOPS_RETIRED__MASK__ADL_GRT_MEM_UOPS_RETIRED__LOAD_LATENCY_GT_8 = 0x800ull, // Counts the number of tagged loads with an instruction latency that exceeds or equals the threshold of 8 cycles as defined in MEC_CR_PEBS_LD_LAT_THRESHOLD (3F6H). Only counts with PEBS enabled.
		MEM_UOPS_RETIRED__MASK__ADL_GRT_MEM_UOPS_RETIRED__SPLIT_LOADS = 0x4100ull, // Counts the number of retired split load uops.
		MEM_UOPS_RETIRED__MASK__ADL_GRT_MEM_UOPS_RETIRED__STORE_LATENCY = 0x600ull, // Counts the number of stores uops retired. Counts with or without PEBS enabled.
		...
		MISC_RETIRED__MASK__ADL_GRT_MISC_RETIRED__LBR_INSERTS = 0x100ull, // Counts the number of LBR entries recorded. Requires LBRs to be enabled in IA32_LBR_CTL. [This event is alias to LBR_INSERTS.ANY]
		...
		SERIALIZATION__MASK__ADL_GRT_SERIALIZATION__NON_C01_MS_SCB = 0x200ull, // Counts the number of issue slots not consumed by the backend due to a micro-sequencer (MS) scoreboard
		...
		TOPDOWN_BAD_SPECULATION__MASK__ADL_GRT_TOPDOWN_BAD_SPECULATION__ALL = 0x0ull, // Counts the total number of issue slots that were not consumed by the backend because allocation is stalled due to a mispredicted jump or a machine clear.
		TOPDOWN_BAD_SPECULATION__MASK__ADL_GRT_TOPDOWN_BAD_SPECULATION__FASTNUKE = 0x200ull, // Counts the number of issue slots every cycle that were not consumed by the backend due to fast nukes such as memory ordering and memory disambiguation machine clears.
		TOPDOWN_BAD_SPECULATION__MASK__ADL_GRT_TOPDOWN_BAD_SPECULATION__MACHINE_CLEARS = 0x300ull, // Counts the total number of issue slots that were not consumed by the backend because allocation is stalled due to a machine clear (nuke) of any kind including memory ordering and memory disambiguation.
		TOPDOWN_BAD_SPECULATION__MASK__ADL_GRT_TOPDOWN_BAD_SPECULATION__MISPREDICT = 0x400ull, // Counts the number of issue slots every cycle that were not consumed by the backend due to branch mispredicts.
		TOPDOWN_BAD_SPECULATION__MASK__ADL_GRT_TOPDOWN_BAD_SPECULATION__NUKE = 0x100ull, // Counts the number of issue slots every cycle that were not consumed by the backend due to a machine clear (nuke).
		...
		TOPDOWN_BE_BOUND__MASK__ADL_GRT_TOPDOWN_BE_BOUND__ALL = 0x0ull, // Counts the total number of issue slots every cycle that were not consumed by the backend due to backend stalls.
		TOPDOWN_BE_BOUND__MASK__ADL_GRT_TOPDOWN_BE_BOUND__ALLOC_RESTRICTIONS = 0x100ull, // Counts the number of issue slots every cycle that were not consumed by the backend due to certain allocation restrictions.
		TOPDOWN_BE_BOUND__MASK__ADL_GRT_TOPDOWN_BE_BOUND__MEM_SCHEDULER = 0x200ull, // Counts the number of issue slots every cycle that were not consumed by the backend due to memory reservation stalls in which a scheduler is not able to accept uops.
		TOPDOWN_BE_BOUND__MASK__ADL_GRT_TOPDOWN_BE_BOUND__NON_MEM_SCHEDULER = 0x800ull, // Counts the number of issue slots every cycle that were not consumed by the backend due to IEC or FPC RAT stalls
		...
		TOPDOWN_FE_BOUND__MASK__ADL_GRT_TOPDOWN_FE_BOUND__ALL = 0x0ull, // Counts the total number of issue slots every cycle that were not consumed by the backend due to frontend stalls.
		TOPDOWN_FE_BOUND__MASK__ADL_GRT_TOPDOWN_FE_BOUND__BRANCH_DETECT = 0x200ull, // Counts the number of issue slots every cycle that were not delivered by the frontend due to BACLEARS.
		...
		TOPDOWN_FE_BOUND__MASK__ADL_GRT_TOPDOWN_FE_BOUND__CISC = 0x100ull, // Counts the number of issue slots every cycle that were not delivered by the frontend due to the microcode sequencer (MS).
		TOPDOWN_FE_BOUND__MASK__ADL_GRT_TOPDOWN_FE_BOUND__DECODE = 0x800ull, // Counts the number of issue slots every cycle that were not delivered by the frontend due to decode stalls.
		...
		TOPDOWN_FE_BOUND__MASK__ADL_GRT_TOPDOWN_FE_BOUND__PREDECODE = 0x400ull, // Counts the number of issue slots every cycle that were not delivered by the frontend due to wrong predecodes.
		TOPDOWN_RETIRING = 0x00c2, // Counts the total number of consumed retirement slots.
		TOPDOWN_RETIRING__MASK__ADL_GRT_TOPDOWN_RETIRING__ALL = 0x0ull, // Counts the total number of consumed retirement slots.
		UOPS_RETIRED = 0x00c2, // Counts the total number of uops retired.
		UOPS_RETIRED__MASK__ADL_GRT_UOPS_RETIRED__ALL = 0x0ull, // Counts the total number of uops retired.
		UOPS_RETIRED__MASK__ADL_GRT_UOPS_RETIRED__FPDIV = 0x800ull, // Counts the number of floating point divide uops retired (x87 and SSE
		UOPS_RETIRED__MASK__ADL_GRT_UOPS_RETIRED__IDIV = 0x1000ull, // Counts the number of integer divide uops retired.
		UOPS_RETIRED__MASK__ADL_GRT_UOPS_RETIRED__MS = 0x100ull, // Counts the number of uops that are from complex flows issued by the micro-sequencer (MS).
		UOPS_RETIRED__MASK__ADL_GRT_UOPS_RETIRED__X87 = 0x200ull, // Counts the number of x87 uops retired
