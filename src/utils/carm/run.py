...
#Run Roofline tests
def run_roofline(name, freq, l1_size, l2_size, l3_size, inst, isa_set, precision_set, num_ld, num_st, threads_set, interleaved, num_ops, l3_bytes, dram_bytes, dram_auto, test_type, verbose, set_freq, no_freq_measure, VLEN, tl1, tl2, LMUL, out_path, num_runs):
...
def run_memory(name, freq, set_freq, l1_size, l2_size, l3_size, isa_set, precision_set, num_ld, num_st, threads_set, interleaved, verbose, no_freq_measure, VLEN, tl1, LMUL, num_runs):
    if interleaved:
        inter = "Yes"
    else:
        inter = "No"
...
def main():
    ...
    if args.test in ["mixedL1", "mixedL2", "mixedL3", "mixedDRAM"]:
        ...
        run_memory(name, freq, args.set_freq, l1_size, l2_size, l3_size, isa_set, precision_set, num_ld, num_st, args.threads, args.interleaved, verbose, args.no_freq_measure, vlen, args.threads_per_l1, args.vector_lmul, args.num_runs)
    else:
        run_roofline(name, freq, l1_size, l2_size, l3_size, args.inst, isa_set, precision_set, num_ld, num_st, args.threads, args.interleaved, args.num_ops, args.l3_kbytes, args.dram_kbytes, args.dram_auto, args.test, verbose, args.set_freq, args.no_freq_measure, vlen, args.threads_per_l1,  args.threads_per_l2, args.vector_lmul, args.output, args.num_runs)
