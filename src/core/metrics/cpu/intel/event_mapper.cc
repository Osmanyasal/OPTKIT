...
namespace optkit::core::metrics::cpu::intel
{
    ...
    const std::unordered_map<metrics::cpu::CoreEvents, std::vector<uint64_t>> EventMapper::core_event_map = {
        ...
        {cpu::CoreEvents::RESOURCE_STALLS, {0x01a2}}, // focus on stall_1-> since it is directly related to resource like FP unit etc. (backend side of the cpu)
        ...
        // Branch Prediction
        {cpu::CoreEvents::BRANCH_INST_RETIRED, {0x00c4}},
        {cpu::CoreEvents::BRANCH_MISP_RETIRED, {0x00c5}},
