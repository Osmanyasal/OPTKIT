...
namespace optkit::intel::icx_unc_ubox{
	enum icx_unc_ubox : uint64_t {
		...
		UNC_U_EVENT_MSG__MASK__ICX_UNC_U_EVENT_MSG__DOORBELL_RCVD = 0x800ull, // Doorbell (experimental)
		UNC_U_EVENT_MSG__MASK__ICX_UNC_U_EVENT_MSG__INT_PRIO = 0x1000ull, // Interrupt (experimental)
		UNC_U_EVENT_MSG__MASK__ICX_UNC_U_EVENT_MSG__IPI_RCVD = 0x400ull, // IPI (experimental)
		UNC_U_EVENT_MSG__MASK__ICX_UNC_U_EVENT_MSG__MSI_RCVD = 0x200ull, // MSI (experimental)
		UNC_U_EVENT_MSG__MASK__ICX_UNC_U_EVENT_MSG__VLW_RCVD = 0x100ull, // VLW (experimental)
		UNC_U_LOCK_CYCLES = 0x0044, // IDI Lock/SplitLock Cycles (experimental)
		UNC_U_M2U_MISC1 = 0x004d, // TBD
		UNC_U_M2U_MISC1__MASK__ICX_UNC_U_M2U_MISC1__RxC_CYCLES_NE_CBO_NCB = 0x100ull, // TBD (experimental)
		UNC_U_M2U_MISC1__MASK__ICX_UNC_U_M2U_MISC1__RxC_CYCLES_NE_CBO_NCS = 0x200ull, // TBD (experimental)
		UNC_U_M2U_MISC1__MASK__ICX_UNC_U_M2U_MISC1__RxC_CYCLES_NE_UPI_NCB = 0x400ull, // TBD (experimental)
		UNC_U_M2U_MISC1__MASK__ICX_UNC_U_M2U_MISC1__RxC_CYCLES_NE_UPI_NCS = 0x800ull, // TBD (experimental)
		...
		UNC_U_M2U_MISC2__MASK__ICX_UNC_U_M2U_MISC2__RxC_CYCLES_EMPTY_BL = 0x200ull, // TBD (experimental)
		UNC_U_M2U_MISC2__MASK__ICX_UNC_U_M2U_MISC2__RxC_CYCLES_FULL_BL = 0x100ull, // TBD (experimental)
		UNC_U_M2U_MISC2__MASK__ICX_UNC_U_M2U_MISC2__TxC_CYCLES_CRD_OVF_VN0_NCB = 0x400ull, // TBD (experimental)
		UNC_U_M2U_MISC2__MASK__ICX_UNC_U_M2U_MISC2__TxC_CYCLES_CRD_OVF_VN0_NCS = 0x800ull, // TBD (experimental)
		...
		UNC_U_M2U_MISC3__MASK__ICX_UNC_U_M2U_MISC3__TxC_CYCLES_FULL_AK = 0x100ull, // TBD (experimental)
		UNC_U_M2U_MISC3__MASK__ICX_UNC_U_M2U_MISC3__TxC_CYCLES_FULL_AKC = 0x200ull, // TBD (experimental)
		UNC_U_PHOLD_CYCLES = 0x0045, // Cycles PHOLD Assert to Ack
		UNC_U_PHOLD_CYCLES__MASK__ICX_UNC_U_PHOLD_CYCLES__ASSERT_TO_ACK = 0x100ull, // Assert to ACK (experimental)
		UNC_U_RACU_DRNG = 0x004c, // TBD
		UNC_U_RACU_DRNG__MASK__ICX_UNC_U_RACU_DRNG__PFTCH_BUF_EMPTY = 0x400ull, // TBD (experimental)
		UNC_U_RACU_DRNG__MASK__ICX_UNC_U_RACU_DRNG__RDRAND = 0x100ull, // TBD (experimental)
		UNC_U_RACU_DRNG__MASK__ICX_UNC_U_RACU_DRNG__RDSEED = 0x200ull, // TBD (experimental)
