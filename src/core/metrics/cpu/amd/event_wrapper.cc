...
namespace optkit::core::metrics::cpu::amd
{
    ...
    const std::unordered_map<metrics::cpu::CoreEvents, uint64_t> AMDEventWrapper::core_event_map = {
    ...
    const std::unordered_map<cpu::amd::CoreEvents, uint64_t> AMDEventWrapper::amd_event_map = {

        {amd::CoreEvents::RETIRED_SSE_AVX_FLOPS_ANY, 0x1f},
    };
}