...
namespace optkit::pmu::cpu::msr
{
    ...
    struct MSRProfilerConfig
    {
        ...
        MSRProfilerConfig(bool dump_results_to_file = true, bool is_reset_after_read = true, bool is_grouped = false, int32_t pid = 0, int32_t cpu = -1);
