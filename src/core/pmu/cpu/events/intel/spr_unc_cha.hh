...
namespace optkit::intel::spr_unc_cha{
	enum spr_unc_cha : uint64_t {
		...
		UNC_CHA_BYPASS_CHA_IMC__MASK__SPR_UNC_CHA_BYPASS_CHA_IMC__INTERMEDIATE = 0x200ull, // Intermediate bypass Taken (experimental)
		UNC_CHA_BYPASS_CHA_IMC__MASK__SPR_UNC_CHA_BYPASS_CHA_IMC__NOT_TAKEN = 0x400ull, // Not Taken (experimental)
		UNC_CHA_BYPASS_CHA_IMC__MASK__SPR_UNC_CHA_BYPASS_CHA_IMC__TAKEN = 0x100ull, // Taken (experimental)
		...
		UNC_CHA_DIRECT_GO__MASK__SPR_UNC_CHA_DIRECT_GO__HA_SUPPRESS_DRD = 0x400ull, // Direct GO (experimental)
		UNC_CHA_DIRECT_GO__MASK__SPR_UNC_CHA_DIRECT_GO__HA_SUPPRESS_NO_D2C = 0x200ull, // Direct GO (experimental)
		UNC_CHA_DIRECT_GO__MASK__SPR_UNC_CHA_DIRECT_GO__HA_TOR_DEALLOC = 0x100ull, // Direct GO (experimental)
		UNC_CHA_DIRECT_GO_OPC = 0x006d, // Direct GO opcodes
		UNC_CHA_DIRECT_GO_OPC__MASK__SPR_UNC_CHA_DIRECT_GO_OPC__EXTCMP = 0x100ull, // Direct GO (experimental)
		...
		UNC_CHA_DIRECT_GO_OPC__MASK__SPR_UNC_CHA_DIRECT_GO_OPC__GO = 0x400ull, // Direct GO (experimental)
		UNC_CHA_DIRECT_GO_OPC__MASK__SPR_UNC_CHA_DIRECT_GO_OPC__GO_PULL = 0x800ull, // Direct GO (experimental)
		...
		UNC_CHA_DIRECT_GO_OPC__MASK__SPR_UNC_CHA_DIRECT_GO_OPC__PULL = 0x200ull, // Direct GO (experimental)
		UNC_CHA_DIR_LOOKUP = 0x0053, // Multi-socket cacheline Directory state lookups
		UNC_CHA_DIR_LOOKUP__MASK__SPR_UNC_CHA_DIR_LOOKUP__NO_SNP = 0x200ull, // Snoop Not Needed (experimental)
		UNC_CHA_DIR_LOOKUP__MASK__SPR_UNC_CHA_DIR_LOOKUP__SNP = 0x100ull, // Snoop Needed (experimental)
		UNC_CHA_DIR_UPDATE = 0x0054, // Multi-socket cacheline Directory state updates
		UNC_CHA_DIR_UPDATE__MASK__SPR_UNC_CHA_DIR_UPDATE__HA = 0x100ull, // Directory Updated memory write from the HA pipe
		UNC_CHA_DIR_UPDATE__MASK__SPR_UNC_CHA_DIR_UPDATE__TOR = 0x200ull, // Directory Updated memory write from TOR pipe
		UNC_CHA_EGRESS_ORDERING = 0x00ba, // Egress Blocking due to Ordering requirements
		UNC_CHA_EGRESS_ORDERING__MASK__SPR_UNC_CHA_EGRESS_ORDERING__IV_SNOOPGO_DN = 0x400ull, // Down (experimental)
		UNC_CHA_EGRESS_ORDERING__MASK__SPR_UNC_CHA_EGRESS_ORDERING__IV_SNOOPGO_UP = 0x100ull, // Up (experimental)
		UNC_CHA_HITME_HIT = 0x005f, // HitMe Cache hits
		UNC_CHA_HITME_HIT__MASK__SPR_UNC_CHA_HITME_HIT__EX_RDS = 0x100ull, // Read request from a remote socket which hit in the HitMe Cache to a line In the E state (experimental)
		UNC_CHA_HITME_HIT__MASK__SPR_UNC_CHA_HITME_HIT__SHARED_OWNREQ = 0x400ull, // Shared hit and op is RdInvOwn
		UNC_CHA_HITME_HIT__MASK__SPR_UNC_CHA_HITME_HIT__WBMTOE = 0x800ull, // Op is WbMtoE (experimental)
		...
		UNC_CHA_HITME_LOOKUP__MASK__SPR_UNC_CHA_HITME_LOOKUP__READ = 0x100ull, // Op is RdCode
		UNC_CHA_HITME_LOOKUP__MASK__SPR_UNC_CHA_HITME_LOOKUP__WRITE = 0x200ull, // Op is WbMtoE
		...
		UNC_CHA_HITME_UPDATE__MASK__SPR_UNC_CHA_HITME_UPDATE__DEALLOCATE_RSPFWDI_LOC = 0x100ull, // op is RspIFwd or RspIFwdWb for a local request (experimental)
		UNC_CHA_HITME_UPDATE__MASK__SPR_UNC_CHA_HITME_UPDATE__RDINVOWN = 0x800ull, // Update HitMe Cache on RdInvOwn even if not RspFwdI* (experimental)
		UNC_CHA_HITME_UPDATE__MASK__SPR_UNC_CHA_HITME_UPDATE__RSPFWDI_REM = 0x200ull, // op is RspIFwd or RspIFwdWb for a remote request (experimental)
		UNC_CHA_HITME_UPDATE__MASK__SPR_UNC_CHA_HITME_UPDATE__SHARED = 0x400ull, // Update HitMe Cache to SHARed (experimental)
		UNC_CHA_IMC_READS_COUNT = 0x0059, // Memory controller reads from CHA
		UNC_CHA_IMC_READS_COUNT__MASK__SPR_UNC_CHA_IMC_READS_COUNT__NORMAL = 0x100ull, // Normal priority reads issued to the memory controller from the CHA
		UNC_CHA_IMC_READS_COUNT__MASK__SPR_UNC_CHA_IMC_READS_COUNT__PRIORITY = 0x200ull, // ISOCH (experimental)
		UNC_CHA_IMC_WRITES_COUNT = 0x005b, // Memory controller writes from CHA
		UNC_CHA_IMC_WRITES_COUNT__MASK__SPR_UNC_CHA_IMC_WRITES_COUNT__FULL = 0x100ull, // CHA to iMC Full Line Writes Issued; Full Line Non-ISOCH
		UNC_CHA_IMC_WRITES_COUNT__MASK__SPR_UNC_CHA_IMC_WRITES_COUNT__FULL_PRIORITY = 0x400ull, // ISOCH Full Line (experimental)
		UNC_CHA_IMC_WRITES_COUNT__MASK__SPR_UNC_CHA_IMC_WRITES_COUNT__PARTIAL = 0x200ull, // Partial Non-ISOCH (experimental)
		UNC_CHA_IMC_WRITES_COUNT__MASK__SPR_UNC_CHA_IMC_WRITES_COUNT__PARTIAL_PRIORITY = 0x800ull, // ISOCH Partial (experimental)
		...
		UNC_CHA_LLC_LOOKUP__MASK__SPR_UNC_CHA_LLC_LOOKUP__I_STATE = 0x100ull, // I State (experimental)
		...
		UNC_CHA_LLC_LOOKUP__MASK__SPR_UNC_CHA_LLC_LOOKUP__SF_E = 0x400ull, // SnoopFilter - E State (experimental)
		UNC_CHA_LLC_LOOKUP__MASK__SPR_UNC_CHA_LLC_LOOKUP__SF_H = 0x800ull, // SnoopFilter - H State (experimental)
		UNC_CHA_LLC_LOOKUP__MASK__SPR_UNC_CHA_LLC_LOOKUP__SF_S = 0x200ull, // SnoopFilter - S State (experimental)
		...
		UNC_CHA_LLC_VICTIMS__MASK__SPR_UNC_CHA_LLC_VICTIMS__E_STATE = 0x200ull, // Lines in E state (experimental)
		...
		UNC_CHA_LLC_VICTIMS__MASK__SPR_UNC_CHA_LLC_VICTIMS__M_STATE = 0x100ull, // Lines in M state (experimental)
		...
		UNC_CHA_LLC_VICTIMS__MASK__SPR_UNC_CHA_LLC_VICTIMS__S_STATE = 0x400ull, // Lines in S State (experimental)
		UNC_CHA_LLC_VICTIMS__MASK__SPR_UNC_CHA_LLC_VICTIMS__TOTAL_E = 0x200ull, // All LLC lines in E state that are victimized on a fill (experimental)
		UNC_CHA_LLC_VICTIMS__MASK__SPR_UNC_CHA_LLC_VICTIMS__TOTAL_M = 0x100ull, // All LLC lines in M state that are victimized on a fill (experimental)
		UNC_CHA_LLC_VICTIMS__MASK__SPR_UNC_CHA_LLC_VICTIMS__TOTAL_S = 0x400ull, // All LLC lines in S state that are victimized on a fill (experimental)
		...
		UNC_CHA_MISC__MASK__SPR_UNC_CHA_MISC__RFO_HIT_S = 0x800ull, // Number of times that an RFO hit in S state. (experimental)
		UNC_CHA_MISC__MASK__SPR_UNC_CHA_MISC__RSPI_WAS_FSE = 0x100ull, // Silent Snoop Eviction (experimental)
		UNC_CHA_MISC__MASK__SPR_UNC_CHA_MISC__WC_ALIASING = 0x200ull, // Write Combining Aliasing (experimental)
		UNC_CHA_OSB = 0x0055, // OSB
		UNC_CHA_OSB__MASK__SPR_UNC_CHA_OSB__LOCAL_INVITOE = 0x100ull, // Local InvItoE (experimental)
		UNC_CHA_OSB__MASK__SPR_UNC_CHA_OSB__LOCAL_READ = 0x200ull, // Local Rd (experimental)
		UNC_CHA_OSB__MASK__SPR_UNC_CHA_OSB__OFF_PWRHEURISTIC = 0x2000ull, // Off (experimental)
		UNC_CHA_OSB__MASK__SPR_UNC_CHA_OSB__REMOTE_READ = 0x400ull, // Remote Rd (experimental)
		UNC_CHA_OSB__MASK__SPR_UNC_CHA_OSB__REMOTE_READINVITOE = 0x800ull, // Remote Rd InvItoE (experimental)
		...
		UNC_CHA_PMM_MEMMODE_NM_INVITOX__MASK__SPR_UNC_CHA_PMM_MEMMODE_NM_INVITOX__LOCAL = 0x100ull, // TBD (experimental)
		UNC_CHA_PMM_MEMMODE_NM_INVITOX__MASK__SPR_UNC_CHA_PMM_MEMMODE_NM_INVITOX__REMOTE = 0x200ull, // TBD (experimental)
		UNC_CHA_PMM_MEMMODE_NM_INVITOX__MASK__SPR_UNC_CHA_PMM_MEMMODE_NM_INVITOX__SETCONFLICT = 0x400ull, // TBD (experimental)
		UNC_CHA_PMM_MEMMODE_NM_SETCONFLICTS = 0x0064, // Memory Modes
		UNC_CHA_PMM_MEMMODE_NM_SETCONFLICTS__MASK__SPR_UNC_CHA_PMM_MEMMODE_NM_SETCONFLICTS__LLC = 0x200ull, // Memory Mode related events; Counts the number of times CHA saw a Near Memory set conflict in SF/LLC (experimental)
		UNC_CHA_PMM_MEMMODE_NM_SETCONFLICTS__MASK__SPR_UNC_CHA_PMM_MEMMODE_NM_SETCONFLICTS__SF = 0x100ull, // Memory Mode related events; Counts the number of times CHA saw a Near memory set conflict in SF/LLC (experimental)
		UNC_CHA_PMM_MEMMODE_NM_SETCONFLICTS__MASK__SPR_UNC_CHA_PMM_MEMMODE_NM_SETCONFLICTS__TOR = 0x400ull, // Memory Mode related events; Counts the number of times CHA saw a Near Memory set conflict in TOR (experimental)
		UNC_CHA_PMM_MEMMODE_NM_SETCONFLICTS2 = 0x0070, // TBD
		UNC_CHA_PMM_MEMMODE_NM_SETCONFLICTS2__MASK__SPR_UNC_CHA_PMM_MEMMODE_NM_SETCONFLICTS2__IODC = 0x100ull, // TBD (experimental)
		UNC_CHA_PMM_MEMMODE_NM_SETCONFLICTS2__MASK__SPR_UNC_CHA_PMM_MEMMODE_NM_SETCONFLICTS2__MEMWR = 0x200ull, // TBD (experimental)
		UNC_CHA_PMM_MEMMODE_NM_SETCONFLICTS2__MASK__SPR_UNC_CHA_PMM_MEMMODE_NM_SETCONFLICTS2__MEMWRNI = 0x400ull, // TBD (experimental)
		UNC_CHA_PMM_QOS = 0x0066, // TBD
		UNC_CHA_PMM_QOS__MASK__SPR_UNC_CHA_PMM_QOS__DDR4_FAST_INSERT = 0x200ull, // TBD (experimental)
		UNC_CHA_PMM_QOS__MASK__SPR_UNC_CHA_PMM_QOS__REJ_IRQ = 0x800ull, // TBD (experimental)
		UNC_CHA_PMM_QOS__MASK__SPR_UNC_CHA_PMM_QOS__SLOWTORQ_SKIP = 0x4000ull, // TBD (experimental)
		UNC_CHA_PMM_QOS__MASK__SPR_UNC_CHA_PMM_QOS__SLOW_INSERT = 0x100ull, // TBD (experimental)
		UNC_CHA_PMM_QOS__MASK__SPR_UNC_CHA_PMM_QOS__THROTTLE = 0x400ull, // TBD (experimental)
		...
		UNC_CHA_PMM_QOS_OCCUPANCY__MASK__SPR_UNC_CHA_PMM_QOS_OCCUPANCY__DDR_FAST_FIFO = 0x200ull, // TBD (experimental)
		UNC_CHA_PMM_QOS_OCCUPANCY__MASK__SPR_UNC_CHA_PMM_QOS_OCCUPANCY__DDR_SLOW_FIFO = 0x100ull, // Number of SLOW TOR Request inserted to ha_pmm_tor_req_fifo (experimental)
		UNC_CHA_READ_NO_CREDITS = 0x0058, // CHA iMC CHNx READ Credits Empty
		UNC_CHA_READ_NO_CREDITS__MASK__SPR_UNC_CHA_WRITE_NO_CREDITS__MC0 = 0x100ull, // TBD (experimental)
		UNC_CHA_READ_NO_CREDITS__MASK__SPR_UNC_CHA_WRITE_NO_CREDITS__MC1 = 0x200ull, // TBD (experimental)
		UNC_CHA_READ_NO_CREDITS__MASK__SPR_UNC_CHA_WRITE_NO_CREDITS__MC2 = 0x400ull, // TBD (experimental)
		UNC_CHA_READ_NO_CREDITS__MASK__SPR_UNC_CHA_WRITE_NO_CREDITS__MC3 = 0x800ull, // TBD (experimental)
		...
		UNC_CHA_REQUESTS__MASK__SPR_UNC_CHA_REQUESTS__READS = 0x300ull, // Read requests made into the CHA
		UNC_CHA_REQUESTS__MASK__SPR_UNC_CHA_REQUESTS__READS_LOCAL = 0x100ull, // Read requests from a unit on this socket
		UNC_CHA_REQUESTS__MASK__SPR_UNC_CHA_REQUESTS__READS_REMOTE = 0x200ull, // Read requests from a remote socket
		UNC_CHA_REQUESTS__MASK__SPR_UNC_CHA_REQUESTS__WRITES = 0xc00ull, // Write requests made into the CHA
		UNC_CHA_REQUESTS__MASK__SPR_UNC_CHA_REQUESTS__WRITES_LOCAL = 0x400ull, // Write Requests from a unit on this socket
		UNC_CHA_REQUESTS__MASK__SPR_UNC_CHA_REQUESTS__WRITES_REMOTE = 0x800ull, // Read and Write Requests; Writes Remote
		UNC_CHA_RxC_INSERTS = 0x0013, // Ingress (from CMS) Allocations
		UNC_CHA_RxC_INSERTS__MASK__SPR_UNC_CHA_RXC_INSERTS__IPQ = 0x400ull, // TBD (experimental)
		UNC_CHA_RxC_INSERTS__MASK__SPR_UNC_CHA_RXC_INSERTS__IRQ = 0x100ull, // TBD (experimental)
		UNC_CHA_RxC_INSERTS__MASK__SPR_UNC_CHA_RXC_INSERTS__IRQ_REJ = 0x200ull, // IRQ Rejected (experimental)
		...
		UNC_CHA_RxC_IPQ0_REJECT__MASK__SPR_UNC_CHA_RXC_IRQ0_REJECT__AD_REQ_VN0 = 0x100ull, // AD REQ on VN0 (experimental)
		UNC_CHA_RxC_IPQ0_REJECT__MASK__SPR_UNC_CHA_RXC_IRQ0_REJECT__AD_RSP_VN0 = 0x200ull, // AD RSP on VN0 (experimental)
		...
		UNC_CHA_RxC_IPQ0_REJECT__MASK__SPR_UNC_CHA_RXC_IRQ0_REJECT__BL_RSP_VN0 = 0x400ull, // BL RSP on VN0 (experimental)
		UNC_CHA_RxC_IPQ0_REJECT__MASK__SPR_UNC_CHA_RXC_IRQ0_REJECT__BL_WB_VN0 = 0x800ull, // BL WB on VN0 (experimental)
		...
		UNC_CHA_RxC_IPQ1_REJECT__MASK__SPR_UNC_CHA_RXC_OTHER1_RETRY__ANY0 = 0x100ull, // TBD (experimental)
		UNC_CHA_RxC_IPQ1_REJECT__MASK__SPR_UNC_CHA_RXC_OTHER1_RETRY__HA = 0x200ull, // TBD (experimental)
		UNC_CHA_RxC_IPQ1_REJECT__MASK__SPR_UNC_CHA_RXC_OTHER1_RETRY__LLC_OR_SF_WAY = 0x2000ull, // TBD (experimental)
		UNC_CHA_RxC_IPQ1_REJECT__MASK__SPR_UNC_CHA_RXC_OTHER1_RETRY__LLC_VICTIM = 0x400ull, // TBD (experimental)
		UNC_CHA_RxC_IPQ1_REJECT__MASK__SPR_UNC_CHA_RXC_OTHER1_RETRY__SF_VICTIM = 0x800ull, // TBD (experimental)
		...
		UNC_CHA_RxC_IRQ0_REJECT__MASK__SPR_UNC_CHA_RXC_IRQ0_REJECT__AD_REQ_VN0 = 0x100ull, // AD REQ on VN0 (experimental)
		UNC_CHA_RxC_IRQ0_REJECT__MASK__SPR_UNC_CHA_RXC_IRQ0_REJECT__AD_RSP_VN0 = 0x200ull, // AD RSP on VN0 (experimental)
		...
		UNC_CHA_RxC_IRQ0_REJECT__MASK__SPR_UNC_CHA_RXC_IRQ0_REJECT__BL_RSP_VN0 = 0x400ull, // BL RSP on VN0 (experimental)
		UNC_CHA_RxC_IRQ0_REJECT__MASK__SPR_UNC_CHA_RXC_IRQ0_REJECT__BL_WB_VN0 = 0x800ull, // BL WB on VN0 (experimental)
		...
		UNC_CHA_RxC_IRQ1_REJECT__MASK__SPR_UNC_CHA_RXC_IRQ1_REJECT__ANY0 = 0x100ull, // ANY0 (experimental)
		UNC_CHA_RxC_IRQ1_REJECT__MASK__SPR_UNC_CHA_RXC_IRQ1_REJECT__HA = 0x200ull, // HA (experimental)
		UNC_CHA_RxC_IRQ1_REJECT__MASK__SPR_UNC_CHA_RXC_IRQ1_REJECT__LLC_OR_SF_WAY = 0x2000ull, // LLC or SF Way (experimental)
		UNC_CHA_RxC_IRQ1_REJECT__MASK__SPR_UNC_CHA_RXC_IRQ1_REJECT__LLC_VICTIM = 0x400ull, // LLC Victim (experimental)
		...
		UNC_CHA_RxC_IRQ1_REJECT__MASK__SPR_UNC_CHA_RXC_IRQ1_REJECT__SF_VICTIM = 0x800ull, // SF Victim (experimental)
		...
		UNC_CHA_RxC_ISMQ0_REJECT__MASK__SPR_UNC_CHA_RXC_ISMQ0_RETRY__AD_REQ_VN0 = 0x100ull, // AD REQ on VN0 (experimental)
		UNC_CHA_RxC_ISMQ0_REJECT__MASK__SPR_UNC_CHA_RXC_ISMQ0_RETRY__AD_RSP_VN0 = 0x200ull, // AD RSP on VN0 (experimental)
		...
		UNC_CHA_RxC_ISMQ0_REJECT__MASK__SPR_UNC_CHA_RXC_ISMQ0_RETRY__BL_RSP_VN0 = 0x400ull, // BL RSP on VN0 (experimental)
		UNC_CHA_RxC_ISMQ0_REJECT__MASK__SPR_UNC_CHA_RXC_ISMQ0_RETRY__BL_WB_VN0 = 0x800ull, // BL WB on VN0 (experimental)
		...
		UNC_CHA_RxC_ISMQ0_RETRY__MASK__SPR_UNC_CHA_RXC_ISMQ0_RETRY__AD_REQ_VN0 = 0x100ull, // AD REQ on VN0 (experimental)
		UNC_CHA_RxC_ISMQ0_RETRY__MASK__SPR_UNC_CHA_RXC_ISMQ0_RETRY__AD_RSP_VN0 = 0x200ull, // AD RSP on VN0 (experimental)
		...
		UNC_CHA_RxC_ISMQ0_RETRY__MASK__SPR_UNC_CHA_RXC_ISMQ0_RETRY__BL_RSP_VN0 = 0x400ull, // BL RSP on VN0 (experimental)
		UNC_CHA_RxC_ISMQ0_RETRY__MASK__SPR_UNC_CHA_RXC_ISMQ0_RETRY__BL_WB_VN0 = 0x800ull, // BL WB on VN0 (experimental)
		...
		UNC_CHA_RxC_ISMQ1_REJECT__MASK__SPR_UNC_CHA_RXC_ISMQ1_RETRY__ANY0 = 0x100ull, // TBD (experimental)
		UNC_CHA_RxC_ISMQ1_REJECT__MASK__SPR_UNC_CHA_RXC_ISMQ1_RETRY__HA = 0x200ull, // TBD (experimental)
		UNC_CHA_RxC_ISMQ1_RETRY = 0x002d, // ISMQ Retries - Set 1
		UNC_CHA_RxC_ISMQ1_RETRY__MASK__SPR_UNC_CHA_RXC_ISMQ1_RETRY__ANY0 = 0x100ull, // TBD (experimental)
		UNC_CHA_RxC_ISMQ1_RETRY__MASK__SPR_UNC_CHA_RXC_ISMQ1_RETRY__HA = 0x200ull, // TBD (experimental)
		UNC_CHA_RxC_OCCUPANCY = 0x0011, // Ingress (from CMS) Occupancy
		UNC_CHA_RxC_OCCUPANCY__MASK__SPR_UNC_CHA_RXC_OCCUPANCY__IPQ = 0x400ull, // TBD (experimental)
		...
		UNC_CHA_RxC_OTHER0_RETRY__MASK__SPR_UNC_CHA_RXC_PRQ0_REJECT__AD_REQ_VN0 = 0x100ull, // AD REQ on VN0 (experimental)
		UNC_CHA_RxC_OTHER0_RETRY__MASK__SPR_UNC_CHA_RXC_PRQ0_REJECT__AD_RSP_VN0 = 0x200ull, // AD RSP on VN0 (experimental)
		...
		UNC_CHA_RxC_OTHER0_RETRY__MASK__SPR_UNC_CHA_RXC_PRQ0_REJECT__BL_RSP_VN0 = 0x400ull, // BL RSP on VN0 (experimental)
		UNC_CHA_RxC_OTHER0_RETRY__MASK__SPR_UNC_CHA_RXC_PRQ0_REJECT__BL_WB_VN0 = 0x800ull, // BL WB on VN0 (experimental)
		...
		UNC_CHA_RxC_OTHER1_RETRY__MASK__SPR_UNC_CHA_RXC_OTHER1_RETRY__ANY0 = 0x100ull, // TBD (experimental)
		UNC_CHA_RxC_OTHER1_RETRY__MASK__SPR_UNC_CHA_RXC_OTHER1_RETRY__HA = 0x200ull, // TBD (experimental)
		UNC_CHA_RxC_OTHER1_RETRY__MASK__SPR_UNC_CHA_RXC_OTHER1_RETRY__LLC_OR_SF_WAY = 0x2000ull, // TBD (experimental)
		UNC_CHA_RxC_OTHER1_RETRY__MASK__SPR_UNC_CHA_RXC_OTHER1_RETRY__LLC_VICTIM = 0x400ull, // TBD (experimental)
		UNC_CHA_RxC_OTHER1_RETRY__MASK__SPR_UNC_CHA_RXC_OTHER1_RETRY__SF_VICTIM = 0x800ull, // TBD (experimental)
		...
		UNC_CHA_RxC_PRQ0_REJECT__MASK__SPR_UNC_CHA_RXC_PRQ0_REJECT__AD_REQ_VN0 = 0x100ull, // AD REQ on VN0 (experimental)
		UNC_CHA_RxC_PRQ0_REJECT__MASK__SPR_UNC_CHA_RXC_PRQ0_REJECT__AD_RSP_VN0 = 0x200ull, // AD RSP on VN0 (experimental)
		...
		UNC_CHA_RxC_PRQ0_REJECT__MASK__SPR_UNC_CHA_RXC_PRQ0_REJECT__BL_RSP_VN0 = 0x400ull, // BL RSP on VN0 (experimental)
		UNC_CHA_RxC_PRQ0_REJECT__MASK__SPR_UNC_CHA_RXC_PRQ0_REJECT__BL_WB_VN0 = 0x800ull, // BL WB on VN0 (experimental)
		...
		UNC_CHA_RxC_PRQ1_REJECT__MASK__SPR_UNC_CHA_RXC_REQ_Q1_RETRY__ANY0 = 0x100ull, // ANY0 (experimental)
		UNC_CHA_RxC_PRQ1_REJECT__MASK__SPR_UNC_CHA_RXC_REQ_Q1_RETRY__HA = 0x200ull, // HA (experimental)
		UNC_CHA_RxC_PRQ1_REJECT__MASK__SPR_UNC_CHA_RXC_REQ_Q1_RETRY__LLC_OR_SF_WAY = 0x2000ull, // LLC OR SF Way (experimental)
		UNC_CHA_RxC_PRQ1_REJECT__MASK__SPR_UNC_CHA_RXC_REQ_Q1_RETRY__LLC_VICTIM = 0x400ull, // LLC Victim (experimental)
		UNC_CHA_RxC_PRQ1_REJECT__MASK__SPR_UNC_CHA_RXC_REQ_Q1_RETRY__SF_VICTIM = 0x800ull, // SF Victim (experimental)
		...
		UNC_CHA_RxC_REQ_Q0_RETRY__MASK__SPR_UNC_CHA_RXC_RRQ0_REJECT__AD_REQ_VN0 = 0x100ull, // AD REQ on VN0 (experimental)
		UNC_CHA_RxC_REQ_Q0_RETRY__MASK__SPR_UNC_CHA_RXC_RRQ0_REJECT__AD_RSP_VN0 = 0x200ull, // AD RSP on VN0 (experimental)
		...
		UNC_CHA_RxC_REQ_Q0_RETRY__MASK__SPR_UNC_CHA_RXC_RRQ0_REJECT__BL_RSP_VN0 = 0x400ull, // BL RSP on VN0 (experimental)
		UNC_CHA_RxC_REQ_Q0_RETRY__MASK__SPR_UNC_CHA_RXC_RRQ0_REJECT__BL_WB_VN0 = 0x800ull, // BL WB on VN0 (experimental)
		...
		UNC_CHA_RxC_REQ_Q1_RETRY__MASK__SPR_UNC_CHA_RXC_REQ_Q1_RETRY__ANY0 = 0x100ull, // ANY0 (experimental)
		UNC_CHA_RxC_REQ_Q1_RETRY__MASK__SPR_UNC_CHA_RXC_REQ_Q1_RETRY__HA = 0x200ull, // HA (experimental)
		UNC_CHA_RxC_REQ_Q1_RETRY__MASK__SPR_UNC_CHA_RXC_REQ_Q1_RETRY__LLC_OR_SF_WAY = 0x2000ull, // LLC OR SF Way (experimental)
		UNC_CHA_RxC_REQ_Q1_RETRY__MASK__SPR_UNC_CHA_RXC_REQ_Q1_RETRY__LLC_VICTIM = 0x400ull, // LLC Victim (experimental)
		UNC_CHA_RxC_REQ_Q1_RETRY__MASK__SPR_UNC_CHA_RXC_REQ_Q1_RETRY__SF_VICTIM = 0x800ull, // SF Victim (experimental)
		...
		UNC_CHA_RxC_RRQ0_REJECT__MASK__SPR_UNC_CHA_RXC_RRQ0_REJECT__AD_REQ_VN0 = 0x100ull, // AD REQ on VN0 (experimental)
		UNC_CHA_RxC_RRQ0_REJECT__MASK__SPR_UNC_CHA_RXC_RRQ0_REJECT__AD_RSP_VN0 = 0x200ull, // AD RSP on VN0 (experimental)
		...
		UNC_CHA_RxC_RRQ0_REJECT__MASK__SPR_UNC_CHA_RXC_RRQ0_REJECT__BL_RSP_VN0 = 0x400ull, // BL RSP on VN0 (experimental)
		UNC_CHA_RxC_RRQ0_REJECT__MASK__SPR_UNC_CHA_RXC_RRQ0_REJECT__BL_WB_VN0 = 0x800ull, // BL WB on VN0 (experimental)
		...
		UNC_CHA_RxC_RRQ1_REJECT__MASK__SPR_UNC_CHA_RXC_WBQ1_REJECT__ANY0 = 0x100ull, // TBD (experimental)
		UNC_CHA_RxC_RRQ1_REJECT__MASK__SPR_UNC_CHA_RXC_WBQ1_REJECT__HA = 0x200ull, // TBD (experimental)
		UNC_CHA_RxC_RRQ1_REJECT__MASK__SPR_UNC_CHA_RXC_WBQ1_REJECT__LLC_OR_SF_WAY = 0x2000ull, // TBD (experimental)
		UNC_CHA_RxC_RRQ1_REJECT__MASK__SPR_UNC_CHA_RXC_WBQ1_REJECT__LLC_VICTIM = 0x400ull, // TBD (experimental)
		UNC_CHA_RxC_RRQ1_REJECT__MASK__SPR_UNC_CHA_RXC_WBQ1_REJECT__SF_VICTIM = 0x800ull, // TBD (experimental)
		...
		UNC_CHA_RxC_WBQ0_REJECT__MASK__SPR_UNC_CHA_RXC_WBQ0_REJECT__AD_REQ_VN0 = 0x100ull, // AD REQ on VN0 (experimental)
		UNC_CHA_RxC_WBQ0_REJECT__MASK__SPR_UNC_CHA_RXC_WBQ0_REJECT__AD_RSP_VN0 = 0x200ull, // AD RSP on VN0 (experimental)
		...
		UNC_CHA_RxC_WBQ0_REJECT__MASK__SPR_UNC_CHA_RXC_WBQ0_REJECT__BL_RSP_VN0 = 0x400ull, // BL RSP on VN0 (experimental)
		UNC_CHA_RxC_WBQ0_REJECT__MASK__SPR_UNC_CHA_RXC_WBQ0_REJECT__BL_WB_VN0 = 0x800ull, // BL WB on VN0 (experimental)
		...
		UNC_CHA_RxC_WBQ1_REJECT__MASK__SPR_UNC_CHA_RXC_WBQ1_REJECT__ANY0 = 0x100ull, // TBD (experimental)
		UNC_CHA_RxC_WBQ1_REJECT__MASK__SPR_UNC_CHA_RXC_WBQ1_REJECT__HA = 0x200ull, // TBD (experimental)
		UNC_CHA_RxC_WBQ1_REJECT__MASK__SPR_UNC_CHA_RXC_WBQ1_REJECT__LLC_OR_SF_WAY = 0x2000ull, // TBD (experimental)
		UNC_CHA_RxC_WBQ1_REJECT__MASK__SPR_UNC_CHA_RXC_WBQ1_REJECT__LLC_VICTIM = 0x400ull, // TBD (experimental)
		UNC_CHA_RxC_WBQ1_REJECT__MASK__SPR_UNC_CHA_RXC_WBQ1_REJECT__SF_VICTIM = 0x800ull, // TBD (experimental)
		...
		UNC_CHA_SNOOPS_SENT__MASK__SPR_UNC_CHA_SNOOPS_SENT__ALL = 0x100ull, // All (experimental)
		...
		UNC_CHA_SNOOPS_SENT__MASK__SPR_UNC_CHA_SNOOPS_SENT__LOCAL = 0x400ull, // Broadcast or directed Snoops sent for Local Requests (experimental)
		UNC_CHA_SNOOPS_SENT__MASK__SPR_UNC_CHA_SNOOPS_SENT__REMOTE = 0x800ull, // Broadcast or directed Snoops sent for Remote Requests (experimental)
		...
		UNC_CHA_SNOOP_RESP__MASK__SPR_UNC_CHA_SNOOP_RESP__RSPI = 0x100ull, // RspI Snoop Responses Received (experimental)
		UNC_CHA_SNOOP_RESP__MASK__SPR_UNC_CHA_SNOOP_RESP__RSPIFWD = 0x400ull, // RspIFwd Snoop Responses Received (experimental)
		UNC_CHA_SNOOP_RESP__MASK__SPR_UNC_CHA_SNOOP_RESP__RSPS = 0x200ull, // RspS Snoop Responses Received (experimental)
		UNC_CHA_SNOOP_RESP__MASK__SPR_UNC_CHA_SNOOP_RESP__RSPSFWD = 0x800ull, // RspSFwd Snoop Responses Received (experimental)
		...
		UNC_CHA_SNOOP_RESP_LOCAL__MASK__SPR_UNC_CHA_SNOOP_RESP_LOCAL__RSPI = 0x100ull, // TBD (experimental)
		UNC_CHA_SNOOP_RESP_LOCAL__MASK__SPR_UNC_CHA_SNOOP_RESP_LOCAL__RSPIFWD = 0x400ull, // TBD (experimental)
		UNC_CHA_SNOOP_RESP_LOCAL__MASK__SPR_UNC_CHA_SNOOP_RESP_LOCAL__RSPS = 0x200ull, // TBD (experimental)
		UNC_CHA_SNOOP_RESP_LOCAL__MASK__SPR_UNC_CHA_SNOOP_RESP_LOCAL__RSPSFWD = 0x800ull, // TBD (experimental)
		...
		UNC_CHA_SNOOP_RSP_MISC__MASK__SPR_UNC_CHA_SNOOP_RSP_MISC__MTOI_RSPDATAM = 0x200ull, // TBD (experimental)
		UNC_CHA_SNOOP_RSP_MISC__MASK__SPR_UNC_CHA_SNOOP_RSP_MISC__MTOI_RSPIFWDM = 0x100ull, // TBD (experimental)
		...
		UNC_CHA_SNOOP_RSP_MISC__MASK__SPR_UNC_CHA_SNOOP_RSP_MISC__RSPIFWDMPTL_HITLLC = 0x800ull, // TBD (experimental)
		UNC_CHA_SNOOP_RSP_MISC__MASK__SPR_UNC_CHA_SNOOP_RSP_MISC__RSPIFWDMPTL_HITSF = 0x400ull, // TBD (experimental)
		...
		UNC_CHA_TOR_INSERTS__MASK__SPR_UNC_CHA_TOR_INSERTS__EVICT = 0x200ull, // SF/LLC Evictions (experimental)
		...
		UNC_CHA_TOR_INSERTS__MASK__SPR_UNC_CHA_TOR_INSERTS__IPQ = 0x800ull, // TBD (experimental)
		UNC_CHA_TOR_INSERTS__MASK__SPR_UNC_CHA_TOR_INSERTS__IRQ_IA = 0x100ull, // IRQ - iA (experimental)
		...
		UNC_CHA_TOR_INSERTS__MASK__SPR_UNC_CHA_TOR_INSERTS__PRQ_IOSF = 0x400ull, // PRQ - IOSF (experimental)
		...
		UNC_CHA_TOR_OCCUPANCY__MASK__SPR_UNC_CHA_TOR_INSERTS__EVICT = 0x200ull, // SF/LLC Evictions (experimental)
		...
		UNC_CHA_TOR_OCCUPANCY__MASK__SPR_UNC_CHA_TOR_INSERTS__IPQ = 0x800ull, // TBD (experimental)
		UNC_CHA_TOR_OCCUPANCY__MASK__SPR_UNC_CHA_TOR_INSERTS__IRQ_IA = 0x100ull, // IRQ - iA (experimental)
		...
		UNC_CHA_TOR_OCCUPANCY__MASK__SPR_UNC_CHA_TOR_INSERTS__PRQ_IOSF = 0x400ull, // PRQ - IOSF (experimental)
		...
		UNC_CHA_WB_PUSH_MTOI__MASK__SPR_UNC_CHA_WB_PUSH_MTOI__LLC = 0x100ull, // Pushed to LLC (experimental)
		UNC_CHA_WB_PUSH_MTOI__MASK__SPR_UNC_CHA_WB_PUSH_MTOI__MEM = 0x200ull, // Pushed to Memory (experimental)
		UNC_CHA_WRITE_NO_CREDITS = 0x005a, // CHA iMC CHNx WRITE Credits Empty
		UNC_CHA_WRITE_NO_CREDITS__MASK__SPR_UNC_CHA_WRITE_NO_CREDITS__MC0 = 0x100ull, // TBD (experimental)
		UNC_CHA_WRITE_NO_CREDITS__MASK__SPR_UNC_CHA_WRITE_NO_CREDITS__MC1 = 0x200ull, // TBD (experimental)
		UNC_CHA_WRITE_NO_CREDITS__MASK__SPR_UNC_CHA_WRITE_NO_CREDITS__MC2 = 0x400ull, // TBD (experimental)
		UNC_CHA_WRITE_NO_CREDITS__MASK__SPR_UNC_CHA_WRITE_NO_CREDITS__MC3 = 0x800ull, // TBD (experimental)
		...
		UNC_CHA_XPT_PREF__MASK__SPR_UNC_CHA_XPT_PREF__DROP0_CONFLICT = 0x800ull, // Dropped (on 0?) - Conflict (experimental)
		UNC_CHA_XPT_PREF__MASK__SPR_UNC_CHA_XPT_PREF__DROP0_NOCRD = 0x400ull, // Dropped (on 0?) - No Credits (experimental)
		...
		UNC_CHA_XPT_PREF__MASK__SPR_UNC_CHA_XPT_PREF__SENT0 = 0x100ull, // Sent (on 0?) (experimental)
