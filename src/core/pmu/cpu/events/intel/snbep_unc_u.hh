...
namespace optkit::intel::snbep_unc_u{
	enum snbep_unc_u : uint64_t {
		...
		UNC_U_EVENT_MSG__MASK__SNBEP_UNC_U_EVENT_MSG__DOORBELL_RCVD = 0x800ull, // TBD
		UNC_U_EVENT_MSG__MASK__SNBEP_UNC_U_EVENT_MSG__INT_PRIO = 0x1000ull, // TBD
		UNC_U_EVENT_MSG__MASK__SNBEP_UNC_U_EVENT_MSG__IPI_RCVD = 0x400ull, // TBD
		UNC_U_EVENT_MSG__MASK__SNBEP_UNC_U_EVENT_MSG__MSI_RCVD = 0x200ull, // TBD
		UNC_U_EVENT_MSG__MASK__SNBEP_UNC_U_EVENT_MSG__VLW_RCVD = 0x100ull, // TBD
