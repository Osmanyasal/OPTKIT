...
namespace optkit::intel::adl_glc{
	enum adl_glc : uint64_t {
		...
		ASSISTS__MASK__ADL_GLC_ASSISTS__FP = 0x200ull, // Counts all microcode FP assists.
		ASSISTS__MASK__ADL_GLC_ASSISTS__HARDWARE = 0x400ull, // TBD
		ASSISTS__MASK__ADL_GLC_ASSISTS__PAGE_FAULT = 0x800ull, // TBD
		ASSISTS__MASK__ADL_GLC_ASSISTS__SSE_AVX_MIX = 0x1000ull, // TBD
		BACLEARS = 0x0060, // Clears due to Unknown Branches.
		BACLEARS__MASK__ADL_GLC_BACLEARS__ANY = 0x100ull, // Clears due to Unknown Branches.
		BR_INST_RETIRED = 0x00c4, // All branch instructions retired.
		BR_INST_RETIRED__MASK__ADL_GLC_BR_INST_RETIRED__ALL_BRANCHES = 0x0ull, // All branch instructions retired.
		...
		BR_INST_RETIRED__MASK__ADL_GLC_BR_INST_RETIRED__COND_TAKEN = 0x100ull, // Taken conditional branch instructions retired.
		...
		BR_INST_RETIRED__MASK__ADL_GLC_BR_INST_RETIRED__NEAR_CALL = 0x200ull, // Direct and indirect near call instructions retired.
		BR_INST_RETIRED__MASK__ADL_GLC_BR_INST_RETIRED__NEAR_RETURN = 0x800ull, // Return instructions retired.
		...
		BR_MISP_RETIRED__MASK__ADL_GLC_BR_MISP_RETIRED__ALL_BRANCHES = 0x0ull, // All mispredicted branch instructions retired.
		...
		BR_MISP_RETIRED__MASK__ADL_GLC_BR_MISP_RETIRED__COND_TAKEN = 0x100ull, // number of branch instructions retired that were mispredicted and taken.
		...
		BR_MISP_RETIRED__MASK__ADL_GLC_BR_MISP_RETIRED__INDIRECT_CALL = 0x200ull, // Mispredicted indirect CALL retired.
		...
		BR_MISP_RETIRED__MASK__ADL_GLC_BR_MISP_RETIRED__RET = 0x800ull, // This event counts the number of mispredicted ret instructions retired. Non PEBS
		CORE_POWER = 0x0028, // TBD
		CORE_POWER__MASK__ADL_GLC_CORE_POWER__LICENSE_1 = 0x200ull, // TBD
		CORE_POWER__MASK__ADL_GLC_CORE_POWER__LICENSE_2 = 0x400ull, // TBD
		CORE_POWER__MASK__ADL_GLC_CORE_POWER__LICENSE_3 = 0x800ull, // TBD
		...
		CPU_CLK_UNHALTED__MASK__ADL_GLC_CPU_CLK_UNHALTED__DISTRIBUTED = 0x200ull, // Cycle counts are evenly distributed between active threads in the Core.
		CPU_CLK_UNHALTED__MASK__ADL_GLC_CPU_CLK_UNHALTED__ONE_THREAD_ACTIVE = 0x200ull, // Core crystal clock cycles when this thread is unhalted and the other thread is halted.
		...
		CPU_CLK_UNHALTED__MASK__ADL_GLC_CPU_CLK_UNHALTED__REF_DISTRIBUTED = 0x800ull, // Core crystal clock cycles. Cycle counts are evenly distributed between active threads in the Core.
		CPU_CLK_UNHALTED__MASK__ADL_GLC_CPU_CLK_UNHALTED__REF_TSC = 0x300ull, // Reference cycles when the core is not in halt state.
		CPU_CLK_UNHALTED__MASK__ADL_GLC_CPU_CLK_UNHALTED__REF_TSC_P = 0x100ull, // Reference cycles when the core is not in halt state.
		CPU_CLK_UNHALTED__MASK__ADL_GLC_CPU_CLK_UNHALTED__THREAD = 0x200ull, // Core cycles when the thread is not in halt state
		CPU_CLK_UNHALTED__MASK__ADL_GLC_CPU_CLK_UNHALTED__THREAD_P = 0x0ull, // Thread cycles when thread is not in halt state
		...
		DECODE__MASK__ADL_GLC_DECODE__LCP = 0x100ull, // Stalls caused by changing prefix length of the instruction.
		DECODE__MASK__ADL_GLC_DECODE__MS_BUSY = 0x200ull, // Cycles the Microcode Sequencer is busy.
		DSB2MITE_SWITCHES = 0x0061, // DSB-to-MITE switch true penalty cycles.
		DSB2MITE_SWITCHES__MASK__ADL_GLC_DSB2MITE_SWITCHES__PENALTY_CYCLES = 0x200ull, // DSB-to-MITE switch true penalty cycles.
		...
		DTLB_LOAD_MISSES__MASK__ADL_GLC_DTLB_LOAD_MISSES__WALK_COMPLETED = 0xe00ull, // Load miss in all TLB levels causes a page walk that completes. (All page sizes)
		DTLB_LOAD_MISSES__MASK__ADL_GLC_DTLB_LOAD_MISSES__WALK_COMPLETED_1G = 0x800ull, // Page walks completed due to a demand data load to a 1G page.
		DTLB_LOAD_MISSES__MASK__ADL_GLC_DTLB_LOAD_MISSES__WALK_COMPLETED_2M_4M = 0x400ull, // Page walks completed due to a demand data load to a 2M/4M page.
		DTLB_LOAD_MISSES__MASK__ADL_GLC_DTLB_LOAD_MISSES__WALK_COMPLETED_4K = 0x200ull, // Page walks completed due to a demand data load to a 4K page.
		...
		DTLB_STORE_MISSES__MASK__ADL_GLC_DTLB_STORE_MISSES__WALK_COMPLETED = 0xe00ull, // Store misses in all TLB levels causes a page walk that completes. (All page sizes)
		DTLB_STORE_MISSES__MASK__ADL_GLC_DTLB_STORE_MISSES__WALK_COMPLETED_1G = 0x800ull, // Page walks completed due to a demand data store to a 1G page.
		DTLB_STORE_MISSES__MASK__ADL_GLC_DTLB_STORE_MISSES__WALK_COMPLETED_2M_4M = 0x400ull, // Page walks completed due to a demand data store to a 2M/4M page.
		DTLB_STORE_MISSES__MASK__ADL_GLC_DTLB_STORE_MISSES__WALK_COMPLETED_4K = 0x200ull, // Page walks completed due to a demand data store to a 4K page.
		...
		EXE_ACTIVITY__MASK__ADL_GLC_EXE_ACTIVITY__1_PORTS_UTIL = 0x200ull, // Cycles total of 1 uop is executed on all ports and Reservation Station was not empty.
		EXE_ACTIVITY__MASK__ADL_GLC_EXE_ACTIVITY__2_PORTS_UTIL = 0x400ull, // Cycles total of 2 uops are executed on all ports and Reservation Station was not empty.
		EXE_ACTIVITY__MASK__ADL_GLC_EXE_ACTIVITY__3_PORTS_UTIL = 0x800ull, // Cycles total of 3 uops are executed on all ports and Reservation Station was not empty.
		...
		FP_ARITH_DISPATCHED__MASK__ADL_GLC_FP_ARITH_DISPATCHED__PORT_0 = 0x100ull, // TBD
		FP_ARITH_DISPATCHED__MASK__ADL_GLC_FP_ARITH_DISPATCHED__PORT_1 = 0x200ull, // TBD
		FP_ARITH_DISPATCHED__MASK__ADL_GLC_FP_ARITH_DISPATCHED__PORT_5 = 0x400ull, // TBD
		FP_ARITH_DISPATCHED__MASK__ADL_GLC_FP_ARITH_DISPATCHED__V0 = 0x100ull, // TBD
		FP_ARITH_DISPATCHED__MASK__ADL_GLC_FP_ARITH_DISPATCHED__V1 = 0x200ull, // TBD
		FP_ARITH_DISPATCHED__MASK__ADL_GLC_FP_ARITH_DISPATCHED__V5 = 0x400ull, // TBD
		...
		FP_ARITH_INST_RETIRED__MASK__ADL_GLC_FP_ARITH_INST_RETIRED__128B_PACKED_DOUBLE = 0x400ull, // Counts number of SSE/AVX computational 128-bit packed double precision floating-point instructions retired; some instructions will count twice as noted below.  Each count represents 2 computation operations
		FP_ARITH_INST_RETIRED__MASK__ADL_GLC_FP_ARITH_INST_RETIRED__128B_PACKED_SINGLE = 0x800ull, // Counts number of SSE/AVX computational 128-bit packed single precision floating-point instructions retired; some instructions will count twice as noted below.  Each count represents 4 computation operations
		...
		FP_ARITH_INST_RETIRED__MASK__ADL_GLC_FP_ARITH_INST_RETIRED__SCALAR = 0x300ull, // Counts number of SSE/AVX computational scalar floating-point instructions retired; some instructions will count twice as noted below.  Applies to SSE* and AVX* scalar
		FP_ARITH_INST_RETIRED__MASK__ADL_GLC_FP_ARITH_INST_RETIRED__SCALAR_DOUBLE = 0x100ull, // Counts number of SSE/AVX computational scalar double precision floating-point instructions retired; some instructions will count twice as noted below.  Each count represents 1 computational operation. Applies to SSE* and AVX* scalar double precision floating-point instructions: ADD SUB MUL DIV MIN MAX SQRT FM(N)ADD/SUB. FM(N)ADD/SUB instructions count twice as they perform 2 calculations per element.
		FP_ARITH_INST_RETIRED__MASK__ADL_GLC_FP_ARITH_INST_RETIRED__SCALAR_SINGLE = 0x200ull, // Counts number of SSE/AVX computational scalar single precision floating-point instructions retired; some instructions will count twice as noted below.  Each count represents 1 computational operation. Applies to SSE* and AVX* scalar single precision floating-point instructions: ADD SUB MUL DIV MIN MAX SQRT RSQRT RCP FM(N)ADD/SUB. FM(N)ADD/SUB instructions count twice as they perform 2 calculations per element.
		...
		FRONTEND_RETIRED__MASK__ADL_GLC_FRONTEND_RETIRED__ANY_DSB_MISS = 0x100ull, // Retired Instructions who experienced DSB miss.
		...
		FRONTEND_RETIRED__MASK__ADL_GLC_FRONTEND_RETIRED__MS_FLOWS = 0x800ull, // TBD
		...
		ICACHE_DATA__MASK__ADL_GLC_ICACHE_DATA__STALLS = 0x400ull, // Cycles where a code fetch is stalled due to L1 instruction cache miss.
		ICACHE_TAG = 0x0083, // Cycles where a code fetch is stalled due to L1 instruction cache tag miss.
		ICACHE_TAG__MASK__ADL_GLC_ICACHE_TAG__STALLS = 0x400ull, // Cycles where a code fetch is stalled due to L1 instruction cache tag miss.
		...
		IDQ__MASK__ADL_GLC_IDQ__DSB_UOPS = 0x800ull, // Uops delivered to Instruction Decode Queue (IDQ) from the Decode Stream Buffer (DSB) path
		...
		IDQ__MASK__ADL_GLC_IDQ__MITE_UOPS = 0x400ull, // Uops delivered to Instruction Decode Queue (IDQ) from MITE path
		...
		IDQ_BUBBLES__MASK__ADL_GLC_IDQ_UOPS_NOT_DELIVERED__CORE = 0x100ull, // Uops not delivered by IDQ when backend of the machine is not stalled [This event is alias to IDQ_BUBBLES.CORE]
		...
		IDQ_UOPS_NOT_DELIVERED__MASK__ADL_GLC_IDQ_UOPS_NOT_DELIVERED__CORE = 0x100ull, // Uops not delivered by IDQ when backend of the machine is not stalled [This event is alias to IDQ_BUBBLES.CORE]
		...
		INST_DECODED__MASK__ADL_GLC_INST_DECODED__DECODERS = 0x100ull, // Instruction decoders utilized in a cycle
		INST_RETIRED = 0x00c0, // Number of instructions retired
		INST_RETIRED__MASK__ADL_GLC_INST_RETIRED__ANY = 0x100ull, // Number of instructions retired. Fixed Counter - architectural event
		INST_RETIRED__MASK__ADL_GLC_INST_RETIRED__ANY_P = 0x0ull, // Number of instructions retired. General Counter - architectural event
		INST_RETIRED__MASK__ADL_GLC_INST_RETIRED__MACRO_FUSED = 0x1000ull, // TBD
		INST_RETIRED__MASK__ADL_GLC_INST_RETIRED__NOP = 0x200ull, // Retired NOP instructions.
		INST_RETIRED__MASK__ADL_GLC_INST_RETIRED__PREC_DIST = 0x100ull, // Precise instruction retired with PEBS precise-distribution
		INST_RETIRED__MASK__ADL_GLC_INST_RETIRED__REP_ITERATION = 0x800ull, // Iterations of Repeat string retired instructions.
		...
		INT_MISC__MASK__ADL_GLC_INT_MISC__RECOVERY_CYCLES = 0x100ull, // Core cycles the allocator was stalled due to recovery from earlier clear event for this thread
		INT_MISC__MASK__ADL_GLC_INT_MISC__UNKNOWN_BRANCH_CYCLES = 0x700ull, // Bubble cycles of BAClear (Unknown Branch).
		...
		INT_VEC_RETIRED__MASK__ADL_GLC_INT_VEC_RETIRED__ADD_128 = 0x300ull, // integer ADD
		INT_VEC_RETIRED__MASK__ADL_GLC_INT_VEC_RETIRED__ADD_256 = 0xc00ull, // integer ADD
		...
		ITLB_MISSES__MASK__ADL_GLC_ITLB_MISSES__WALK_COMPLETED = 0xe00ull, // Code miss in all TLB levels causes a page walk that completes. (All page sizes)
		ITLB_MISSES__MASK__ADL_GLC_ITLB_MISSES__WALK_COMPLETED_2M_4M = 0x400ull, // Code miss in all TLB levels causes a page walk that completes. (2M/4M)
		ITLB_MISSES__MASK__ADL_GLC_ITLB_MISSES__WALK_COMPLETED_4K = 0x200ull, // Code miss in all TLB levels causes a page walk that completes. (4K)
		...
		L1D__MASK__ADL_GLC_L1D__REPLACEMENT = 0x100ull, // Counts the number of cache lines replaced in L1 data cache.
		L1D_PEND_MISS = 0x0048, // Number of L1D misses that are outstanding
		L1D_PEND_MISS__MASK__ADL_GLC_L1D_PEND_MISS__FB_FULL = 0x200ull, // Number of cycles a demand request has waited due to L1D Fill Buffer (FB) unavailability.
		...
		L1D_PEND_MISS__MASK__ADL_GLC_L1D_PEND_MISS__L2_STALL = 0x400ull, // This event is deprecated. Refer to new event L1D_PEND_MISS.L2_STALLS
		L1D_PEND_MISS__MASK__ADL_GLC_L1D_PEND_MISS__L2_STALLS = 0x400ull, // Number of cycles a demand request has waited due to L1D due to lack of L2 resources.
		L1D_PEND_MISS__MASK__ADL_GLC_L1D_PEND_MISS__PENDING = 0x100ull, // Number of L1D misses that are outstanding
		...
		L2_LINES_OUT__MASK__ADL_GLC_L2_LINES_OUT__USELESS_HWPF = 0x400ull, // Cache lines that have been L2 hardware prefetched but not used by demand accesses
		...
		LD_BLOCKS__MASK__ADL_GLC_LD_BLOCKS__ADDRESS_ALIAS = 0x400ull, // False dependencies in MOB due to partial compare on address.
		...
		LOAD_HIT_PREFETCH__MASK__ADL_GLC_LOAD_HIT_PREFETCH__SWPF = 0x100ull, // Counts the number of demand load dispatches that hit L1D fill buffer (FB) allocated for software prefetch.
		...
		LSD__MASK__ADL_GLC_LSD__UOPS = 0x100ull, // Number of Uops delivered by the LSD.
		...
		MACHINE_CLEARS__MASK__ADL_GLC_MACHINE_CLEARS__MEMORY_ORDERING = 0x200ull, // Number of machine clears due to memory ordering conflicts.
		MACHINE_CLEARS__MASK__ADL_GLC_MACHINE_CLEARS__SMC = 0x400ull, // Self-modifying code (SMC) detected.
		...
		MEM_LOAD_L3_HIT_RETIRED__MASK__ADL_GLC_MEM_LOAD_L3_HIT_RETIRED__XSNP_FWD = 0x400ull, // Retired load instructions whose data sources were HitM responses from shared L3
		MEM_LOAD_L3_HIT_RETIRED__MASK__ADL_GLC_MEM_LOAD_L3_HIT_RETIRED__XSNP_HIT = 0x200ull, // Retired load instructions whose data sources were L3 and cross-core snoop hits in on-pkg core cache
		MEM_LOAD_L3_HIT_RETIRED__MASK__ADL_GLC_MEM_LOAD_L3_HIT_RETIRED__XSNP_HITM = 0x400ull, // Retired load instructions whose data sources were HitM responses from shared L3
		MEM_LOAD_L3_HIT_RETIRED__MASK__ADL_GLC_MEM_LOAD_L3_HIT_RETIRED__XSNP_MISS = 0x100ull, // Retired load instructions whose data sources were L3 hit and cross-core snoop missed in on-pkg core cache.
		MEM_LOAD_L3_HIT_RETIRED__MASK__ADL_GLC_MEM_LOAD_L3_HIT_RETIRED__XSNP_NONE = 0x800ull, // Retired load instructions whose data sources were hits in L3 without snoops required
		MEM_LOAD_L3_HIT_RETIRED__MASK__ADL_GLC_MEM_LOAD_L3_HIT_RETIRED__XSNP_NO_FWD = 0x200ull, // Retired load instructions whose data sources were L3 and cross-core snoop hits in on-pkg core cache
		MEM_LOAD_L3_MISS_RETIRED = 0x00d3, // Retired load instructions which data sources missed L3 but serviced from local dram
		MEM_LOAD_L3_MISS_RETIRED__MASK__ADL_GLC_MEM_LOAD_L3_MISS_RETIRED__LOCAL_DRAM = 0x100ull, // Retired load instructions which data sources missed L3 but serviced from local dram
		MEM_LOAD_MISC_RETIRED = 0x00d4, // Retired instructions with at least 1 uncacheable load or lock.
		MEM_LOAD_MISC_RETIRED__MASK__ADL_GLC_MEM_LOAD_MISC_RETIRED__UC = 0x400ull, // Retired instructions with at least 1 uncacheable load or lock.
		...
		MEM_LOAD_RETIRED__MASK__ADL_GLC_MEM_LOAD_RETIRED__L1_HIT = 0x100ull, // Retired load instructions with L1 cache hits as data sources
		MEM_LOAD_RETIRED__MASK__ADL_GLC_MEM_LOAD_RETIRED__L1_MISS = 0x800ull, // Retired load instructions missed L1 cache as data sources
		MEM_LOAD_RETIRED__MASK__ADL_GLC_MEM_LOAD_RETIRED__L2_HIT = 0x200ull, // Retired load instructions with L2 cache hits as data sources
		...
		MEM_LOAD_RETIRED__MASK__ADL_GLC_MEM_LOAD_RETIRED__L3_HIT = 0x400ull, // Retired load instructions with L3 cache hits as data sources
		...
		MEM_STORE_RETIRED__MASK__ADL_GLC_MEM_STORE_RETIRED__L2_HIT = 0x100ull, // TBD
		MEM_TRANS_RETIRED = 0x01cd, // 
		MEM_TRANS_RETIRED__MASK__ADL_GLC_MEM_TRANS_RETIRED__LOAD_LATENCY = 0x100ull, // Memory load instructions retired above programmed clocks
		...
		MEM_TRANS_RETIRED__MASK__ADL_GLC_MEM_TRANS_RETIRED__LOAD_LATENCY_GT_4 = 0x400ull, // Counts randomly selected loads when the latency from first dispatch to completion is greater than 4 cycles.
		...
		MEM_TRANS_RETIRED__MASK__ADL_GLC_MEM_TRANS_RETIRED__LOAD_LATENCY_GT_8 = 0x800ull, // Counts randomly selected loads when the latency from first dispatch to completion is greater than 8 cycles.
		MEM_TRANS_RETIRED__MASK__ADL_GLC_MEM_TRANS_RETIRED__STORE_SAMPLE = 0x200ull, // Retired memory store access operations. A PDist event for PEBS Store Latency Facility.
		MEM_UOP_RETIRED = 0x00e5, // Retired memory uops for any access
		MEM_UOP_RETIRED__MASK__ADL_GLC_MEM_UOP_RETIRED__ANY = 0x300ull, // Retired memory uops for any access
		...
		OFFCORE_REQUESTS__MASK__ADL_GLC_OFFCORE_REQUESTS__DATA_RD = 0x800ull, // Demand and prefetch data reads
		OFFCORE_REQUESTS__MASK__ADL_GLC_OFFCORE_REQUESTS__DEMAND_DATA_RD = 0x100ull, // Demand Data Read requests sent to uncore
		...
		OFFCORE_REQUESTS_OUTSTANDING__MASK__ADL_GLC_OFFCORE_REQUESTS_OUTSTANDING__ALL_DATA_RD = 0x800ull, // This event is deprecated. Refer to new event OFFCORE_REQUESTS_OUTSTANDING.DATA_RD
		...
		OFFCORE_REQUESTS_OUTSTANDING__MASK__ADL_GLC_OFFCORE_REQUESTS_OUTSTANDING__DATA_RD = 0x800ull, // TBD
		OFFCORE_REQUESTS_OUTSTANDING__MASK__ADL_GLC_OFFCORE_REQUESTS_OUTSTANDING__DEMAND_DATA_RD = 0x100ull, // For every cycle
		...
		RESOURCE_STALLS__MASK__ADL_GLC_RESOURCE_STALLS__SB = 0x800ull, // Cycles stalled due to no store buffers available. (not including draining form sync).
		RESOURCE_STALLS__MASK__ADL_GLC_RESOURCE_STALLS__SCOREBOARD = 0x200ull, // Counts cycles where the pipeline is stalled due to serializing operations.
		RS = 0x00a5, // Cycles when Reservation Station (RS) is empty for the thread.
		RS__MASK__ADL_GLC_RS__EMPTY = 0x700ull, // Cycles when Reservation Station (RS) is empty for the thread.
		...
		SW_PREFETCH_ACCESS__MASK__ADL_GLC_SW_PREFETCH_ACCESS__NTA = 0x100ull, // Number of PREFETCHNTA instructions executed.
		SW_PREFETCH_ACCESS__MASK__ADL_GLC_SW_PREFETCH_ACCESS__PREFETCHW = 0x800ull, // Number of PREFETCHW instructions executed.
		SW_PREFETCH_ACCESS__MASK__ADL_GLC_SW_PREFETCH_ACCESS__T0 = 0x200ull, // Number of PREFETCHT0 instructions executed.
		SW_PREFETCH_ACCESS__MASK__ADL_GLC_SW_PREFETCH_ACCESS__T1_T2 = 0x400ull, // Number of PREFETCHT1 or PREFETCHT2 instructions executed.
		...
		TOPDOWN__MASK__ADL_GLC_TOPDOWN__SLOTS = 0x400ull, // TMA slots available for an unhalted logical processor. Fixed counter - architectural event
		TOPDOWN__MASK__ADL_GLC_TOPDOWN__SLOTS_P = 0x1a400ull, // TMA slots available for an unhalted logical processor. General counter - architectural event
		...
		UOPS_DECODED__MASK__ADL_GLC_UOPS_DECODED__DEC0_UOPS = 0x100ull, // TBD
		UOPS_DISPATCHED = 0x00b2, // Uops executed on port 0
		UOPS_DISPATCHED__MASK__ADL_GLC_UOPS_DISPATCHED__PORT_0 = 0x100ull, // Uops executed on port 0
		UOPS_DISPATCHED__MASK__ADL_GLC_UOPS_DISPATCHED__PORT_1 = 0x200ull, // Uops executed on port 1
		UOPS_DISPATCHED__MASK__ADL_GLC_UOPS_DISPATCHED__PORT_2_3_10 = 0x400ull, // Uops executed on ports 2
		...
		UOPS_EXECUTED__MASK__ADL_GLC_UOPS_EXECUTED__THREAD = 0x100ull, // Counts the number of uops to be executed per-thread each cycle.
		...
		UOPS_ISSUED__MASK__ADL_GLC_UOPS_ISSUED__ANY = 0x100ull, // Uops that RAT issues to RS
		...
		UOPS_RETIRED__MASK__ADL_GLC_UOPS_RETIRED__HEAVY = 0x100ull, // Retired uops except the last uop of each instruction.
		UOPS_RETIRED__MASK__ADL_GLC_UOPS_RETIRED__MS = 0x800ull, // TBD
		UOPS_RETIRED__MASK__ADL_GLC_UOPS_RETIRED__SLOTS = 0x200ull, // Retirement slots used.
