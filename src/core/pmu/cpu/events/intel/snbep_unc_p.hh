...
namespace optkit::intel::snbep_unc_p{
	enum snbep_unc_p : uint64_t {
		...
		UNC_P_FREQ_MIN_IO_P_CYCLES__MASK__SNBEP_UNC_P_OCCUPANCY_COUNTERS__C0 = 0x100ull, // Counts number of cores in C0
		UNC_P_FREQ_MIN_IO_P_CYCLES__MASK__SNBEP_UNC_P_OCCUPANCY_COUNTERS__C3 = 0x200ull, // Counts number of cores in C3
		UNC_P_FREQ_MIN_IO_P_CYCLES__MASK__SNBEP_UNC_P_OCCUPANCY_COUNTERS__C6 = 0x300ull, // Counts number of cores in C6
		UNC_P_FREQ_MIN_PERF_P_CYCLES = 0x2 | (1ULL << 21), // Perf P Limit Strongest Lower Limit Cycles
		UNC_P_FREQ_MIN_PERF_P_CYCLES__MASK__SNBEP_UNC_P_OCCUPANCY_COUNTERS__C0 = 0x100ull, // Counts number of cores in C0
		UNC_P_FREQ_MIN_PERF_P_CYCLES__MASK__SNBEP_UNC_P_OCCUPANCY_COUNTERS__C3 = 0x200ull, // Counts number of cores in C3
		UNC_P_FREQ_MIN_PERF_P_CYCLES__MASK__SNBEP_UNC_P_OCCUPANCY_COUNTERS__C6 = 0x300ull, // Counts number of cores in C6
		UNC_P_FREQ_TRANS_CYCLES = 0x0 | (1ULL << 21), // Cycles spent changing Frequency
		UNC_P_FREQ_TRANS_CYCLES__MASK__SNBEP_UNC_P_OCCUPANCY_COUNTERS__C0 = 0x100ull, // Counts number of cores in C0
		UNC_P_FREQ_TRANS_CYCLES__MASK__SNBEP_UNC_P_OCCUPANCY_COUNTERS__C3 = 0x200ull, // Counts number of cores in C3
		UNC_P_FREQ_TRANS_CYCLES__MASK__SNBEP_UNC_P_OCCUPANCY_COUNTERS__C6 = 0x300ull, // Counts number of cores in C6
		...
		UNC_P_POWER_STATE_OCCUPANCY__MASK__SNBEP_UNC_P_POWER_STATE_OCCUPANCY__CORES_C0 = 0x4000ull, // Counts number of cores in C0
		UNC_P_POWER_STATE_OCCUPANCY__MASK__SNBEP_UNC_P_POWER_STATE_OCCUPANCY__CORES_C3 = 0x8000ull, // Counts number of cores in C3
		UNC_P_POWER_STATE_OCCUPANCY__MASK__SNBEP_UNC_P_POWER_STATE_OCCUPANCY__CORES_C6 = 0xc000ull, // Counts number of cores in C6
