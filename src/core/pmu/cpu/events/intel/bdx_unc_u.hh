...
namespace optkit::intel::bdx_unc_u{
	enum bdx_unc_u : uint64_t {
		...
		UNC_U_EVENT_MSG__MASK__BDX_UNC_U_EVENT_MSG__DOORBELL_RCVD = 0x800ull, // VLW Received
		UNC_U_PHOLD_CYCLES = 0x45, // PHOLD cycles.  Filter from source CoreID.
		UNC_U_PHOLD_CYCLES__MASK__BDX_UNC_U_PHOLD_CYCLES__ASSERT_TO_ACK = 0x100ull, // Cycles PHOLD Assert to Ack. Assert to ACK
